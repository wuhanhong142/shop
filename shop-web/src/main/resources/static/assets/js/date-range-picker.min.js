!function (t, e) {
    ...
    function u(t) {
        t = t || {};
        var n, a, e = r((t = g({
            lang: s, mode: "dp-modal", hilightedDate: o(), format: function (t) {
    ...
    var b = {
        day: {
            onKeyDown: function (t, e) {
                ...
                var i = r.opts, t = i.lang, e = r.state, n = t.days, a = i.dayOffset || 0, s = e.selectedDate,
                    u = e.hilightedDate, d = u.getMonth(), c = o().getTime();
                return '<div class="dp-cal"><header class="dp-cal-header"><button tabindex="-1" type="button" class="dp-prev">Prev</button><button tabindex="-1" type="button" class="dp-cal-month">' + t.months[d] + '</button><button tabindex="-1" type="button" class="dp-cal-year">' + u.getFullYear() + '</button><button tabindex="-1" type="button" class="dp-next">Next</button></header><div class="dp-days">' + n.map(function (t, e) {
                    ...
                    var e = t.getMonth() !== d, n = !i.inRange(t), a = t.getTime() === c, o = "dp-day";
            ...
            render: function (t) {
                ...
                var n = t.keyCode, a = e.opts,
                    o = n === m.left || n === m.up ? 1 : n === m.right || n === m.down ? -1 : 0;
                if (n === m.esc) e.setState({view: "day"}); else if (o) {
                    t.preventDefault();
    ...
    function d(o, r, a) {
        var t, i, e, n, s, u, d = !1, c = {
            el: void 0, opts: a, shouldFocusOnBlur: !0, shouldFocusOnRender: !0, state: {
                get selectedDate() {
                    return i
                }, set selectedDate(t) {
                    t && !a.inRange(t) || (t ? (i = new Date(t), c.state.hilightedDate = i) : i = t, c.updateInput(i), r("select"), c.close())
                }, view: "day"
            }, adjustPosition: p, containerHTML: '<div class="dp"></div>', attachToDom: function () {
    ...
    function F(t, e) {
        var n = x(), a = S(t, function (t) {
            ...
            get state() {
                return a.state
            }, on: n.on, off: n.off, setState: a.setState, open: a.open, close: a.close, destroy: a.destroy
        };
        return o
    }
    ...
    t.TinyDatePicker = e, t.DateRangePicker = function (t, e) {
        e = e || {};
        var o, n = x(),
            ...
            s = F(a.querySelector(".dr-cal-end"), g({}, e.endOpts, {
                ...
                statechange: function (t, e) {
                    ...
                    !r.start || r.end ? l({start: n, end: void 0}) : l({
