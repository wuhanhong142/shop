...
!function (e) {
    ...
    var a = function (a, n) {
        var r, i, o, s, d, l, p, c, u, f = {}, h = !0, m = !1, y = !1, g = 0,
            b = [{clsName: "days", navFnc: "M", navStep: 1}, {
                clsName: "months",
                navFnc: "y",
                navStep: 1
            }, {clsName: "years", navFnc: "y", navStep: 10}, {clsName: "decades", navFnc: "y", navStep: 100}],
            w = ["days", "months", "years", "decades"], v = ["top", "bottom", "auto"], k = ["left", "right", "auto"],
            D = ["default", "top", "bottom"], C = {
                ...
                y && (e && (p = Math.max(g, Math.min(3, p + e))), y.find(".datepicker > div").hide().filter(".datepicker-" + b[p].clsName).show())
            }, B = function (t, a) {
                ...
                var a, o, s, d = y.find(".datepicker-days"), l = d.find("th"), p = [], c = [];
                if (P()) {
                    ...
                    d.find("tbody").empty().append(p), u = y.find(".datepicker-months"), f = u.find("th"), m = u.find("tbody").find("span"), f.eq(0).find("span").attr("title", n.tooltips.prevYear), f.eq(1).attr("title", n.tooltips.selectYear), f.eq(2).find("span").attr("title", n.tooltips.nextYear), u.find(".disabled").removeClass("disabled"), B(i.clone().subtract(1, "y"), "y") || f.eq(0).addClass("disabled"), f.eq(1).text(i.year()), B(i.clone().add(1, "y"), "y") || f.eq(2).addClass("disabled"), m.removeClass("active"), r.isSame(i, "y") && !h && m.eq(r.month()).addClass("active"), m.each((function (t) {
                        ...
                        var e = y.find(".datepicker-years"), t = e.find("th"), a = i.clone().subtract(5, "y"),
                            o = i.clone().add(6, "y"), s = "";
                        ...
                        var e, a = y.find(".datepicker-decades"), o = a.find("th"),
                ...
                })), t || (m && m.hasClass("btn") && m.toggleClass("active"), y.hide(), e(window).off("resize", H), y.off("click", "[data-action]"), y.off("mousedown", !1), y.remove(), y = !1, I({
                    type: "dp.hide",
                    date: r.clone()
                ...
                next: function () {
                    var e = b[p].navFnc;
                    i.add(b[p].navStep, e), j(), Y(e)
                }, previous: function () {
                    var e = b[p].navFnc;
                    i.subtract(b[p].navStep, e), j(), Y(e)
                    ...
                    var a, r = e(t.target), i = r.closest("ul"), o = i.find(".in"), s = i.find(".collapse:not(.in)");
                    if (o && o.length) {
                        if ((a = o.data("collapse")) && a.transitioning) return;
                        o.collapse ? (o.collapse("hide"), s.collapse("show")) : (o.removeClass("in"), s.addClass("in")), r.is("span") ? r.toggleClass(n.icons.time + " " + n.icons.date) : r.find("span").toggleClass(n.icons.time + " " + n.icons.date)
                    }
                }, showPicker: function () {
                ...
                var t;
                return o.prop("disabled") || !n.ignoreReadonly && o.prop("readonly") || y || (void 0 !== o.val() && 0 !== o.val().trim().length ? L(N(o.val().trim())) : h && n.useCurrent && (n.inline || o.is("input") && 0 === o.val().trim().length) && (t = M(), "string" == typeof n.useCurrent && (t = {
                    year: function (e) {
        ...
        if (f.destroy = function () {
            ...
            return n.collapse === e || (n.collapse = e, y && (W(), R())), f
        }, f.icons = function (t) {
            ...
            return n.viewMode = e, p = Math.max(w.indexOf(e), g), q(), f
