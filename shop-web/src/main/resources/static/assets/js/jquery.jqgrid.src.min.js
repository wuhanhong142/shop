...
!function (t, r) {
    ...
    $.extend(!0, jgrid, {
        ...
        icons: {
            ...
            fontAwesome5: {
                ...
                sort: {common: "fa-lg", asc: "fa-sort-up", desc: "fa-sort-down"},
                gridMinimize: {visible: "fa-chevron-circle-up", hidden: "fa-chevron-circle-down"},
                nav: {
                    common: "fa-lg fa-fw",
                    edit: "fa-pencil-alt",
                ...
                search: {search: "fa-search", reset: "fa-undo", query: "fa-comments"},
                subgrid: {
                    common: "fa-fw",
                    plus: "fa-plus",
                    minus: "fa-minus",
                ...
                grouping: {common: "fa-fw", plus: "fa-plus-square", minus: "fa-minus-square"},
                treeGrid: {
                    common: "fa-fw",
            ...
            fontAwesomeBrands: {baseIconSet: "fontAwesome5", common: "fab"},
            fontAwesomeLight: {baseIconSet: "fontAwesome5", common: "fal"},
            fontAwesomeRegular: {baseIconSet: "fontAwesome5", common: "far"},
            fontAwesomeSolid: {baseIconSet: "fontAwesome5", common: "fas"},
            fontAwesomeSVG: {baseIconSet: "fontAwesome5", common: "fas"},
            glyph: {
                common: "glyphicon",
                pager: {
                    common: "",
        ...
        guiStyles: {
            ...
            bootstrap: {
                ...
                filterToolbar: {dataField: "form-control"},
                subgrid: {
                    thSubgrid: "",
                    rowSubTable: "",
                    row: "",
            ...
            bootstrapPrimary: {
                ...
                dialog: {closeButton: "btn btn-xs close", fmButton: "btn btn-primary"},
                searchDialog: {
        ...
        template: function (e) {
            var a, o = $.makeArray(arguments).slice(1), l = o.length;
            return null == e && (e = ""), e.replace(/\{([\w\-]+)(?:\:([\w\.]*)(?:\((\.*?)?\))?)?\}/g, function (e, t) {
                var r, i;
                if (!isNaN(parseInt(t, 10))) return o[parseInt(t, 10)];
                for (a = 0; a < l; a++) if ($.isArray(o[a])) for (i = (r = o[a]).length; i--;) if (t === r[i].nm) return r[i].v
            })
        },
        ...
        getRelativeRect: function (e) {
            var t, r, i = e instanceof $ && 0 < e.length ? e[0] : e, a = $(i).outerHeight(),
        ...
        parseDate: function (e, t, r, i) {
            var a, o, l, n = 0, s = 0,
                ...
                c = function (e, t) {
                    ...
                    return e
                }, u = {m: 1, d: 1, y: 1970, h: 0, i: 0, s: 0, u: 0}, p = function (e, t) {
            ...
            } else n = new Date(parseFloat(t)); else n = new Date(1e3 * parseFloat(t)); else n = new Date(u.y, u.m, u.d, u.h, u.i, u.s, u.u);
            ...
            var h = n.getHours(), g = n.getMinutes(), m = n.getDate(), v = n.getMonth() + 1, b = n.getTimezoneOffset(),
                w = n.getSeconds(), y = n.getMilliseconds(), x = n.getDay(), j = n.getFullYear(), C = (x + 6) % 7 + 1,
        ...
        getGridComponent: function (e, t) {
            var r;
            if (t instanceof $ || 0 < t.length) r = t[0]; else {
        ...
        fixScrollOffsetAndhBoxPadding: function () {
            var e = this.grid;
            if (e) {
                var r = this.p, i = e.bDiv, t = function (e) {
        ...
        getAccessor: function (e, t) {
            ...
            try {
                if ("string" == typeof t && (o = t.split(".")), a = o.length) for (r = e; null != r && a--;) i = o.shift(), r = r.hasOwnProperty(i) ? r[i] : void 0
            } catch (e) {
            }
            return r
        },
        ...
        fullBoolFeedback: function (e, t) {
            var r = $.makeArray(arguments).slice(2), i = $(this).triggerHandler(t, r);
        ...
        builderSortIcons: function (a) {
            var o = this, l = o.p, n = $(o), s = n.jqGrid("getGuiStyles", "states.disabled"), e = function (e) {
                var t = l.colModel[a], r = null != t && $.isFunction(t.sortIconName) ? t.sortIconName : l.sortIconName,
                    i = $.isFunction(r) ? r.call(o, {order: e, iCol: a, cm: t}) : n.jqGrid("getIconRes", "sort." + e);
                return jgrid.mergeCssClasses("ui-grid-ico-sort", "ui-icon-" + e, "horizontal" === l.viewsortcols[1] ? "ui-i-" + e : "", s, i, "ui-sort-" + l.direction)
            };
            return "<span class='s-ico" + (l.sortIconsBeforeText ? " jqgrid-icons-first" : "") + "' style='display:none'><span class='" + e("asc") + "'></span><span class='" + e("desc") + "'></span></span>"
        },
        ...
        parseDataToHtml: function (e, t, r, i, a, o, l) {
            var n, s, d, c, u, p, f, h, g, m, v, b, w, y, x, j, C, D, S, q, F, R, _, I, G, O, k, N, E = this, A = E.p,
                T = $(E), M = !1, B = [], P = [],
                z = !0 !== A.altRows || T.jqGrid("isBootstrapGuiStyle") ? "" : A.altclass, L = A.groupingView, V = !1,
                H = parseInt(A.rowNum, 10), W = $.fn.jqGrid,
            ...
            for (U <= 1 && (A.rowIndexes = {}), ("local" === A.datatype && !A.deselectAfterSort || A.multiPageSelection) && (M = !0), o && (H *= o + 1), n = 0; n < Math.min(e, H); n++) {
                for (u = t[n], p = r[n], f = null != i ? i[n] : p, d = ((1 === a ? 0 : a) + n) % 2 == 1 ? z : "", M ? A.multiselect ? (c = -1 !== $.inArray(u, A.selarrrow)) && null === A.selrow && (A.selrow = u) : c = u === A.selrow : c = !1, h = B.length, B.push(""), s = 0; s < A.colModel.length; s++) switch (g = A.colModel[s].name) {
                    case"rn":
                        B.push((I = s, G = n, O = A.page, k = A.rowNum, void 0, N = (parseInt(O, 10) - 1) * parseInt(k, 10) + 1 + G, "<td role='gridcell' class='" + W.getGuiStyles.call(T, "rowNum", "jqgrid-rownum") + "' " + Y(I, G, N, null, G, !0) + ">" + N + "</td>"));
                        break;
                    case"cb":
                        B.push((F = void 0, F = "&nbsp;", R = !(R = void 0), _ = {
                            ...
                            data: p,
                            checked: q = c
                        }, $.isFunction(A.hasMultiselectCheckBox) && (R = A.hasMultiselectCheckBox.call(E, _)), R && (F = $.isFunction(A.checkboxHtml) ? A.checkboxHtml.call(E, _) : "<input type='checkbox' id='jqg_" + A.id + "_" + C + "' class='cbox' name='jqg_" + A.id + "_" + C + "'" + (q ? " checked='checked' aria-checked='true'" : " aria-checked='false'") + "/>"), "<td role='gridcell' " + Y(D, S, "", null, C, !0) + ">" + F + "</td>"));
                        break;
                    case"subgrid":
                        B.push(W.addSubGridCell.call(T, s, n + a, u, p));
                        break;
                    default:
                        B.push((m = u, v = p[g], b = s, w = n + a, y = f, x = p, void 0, j = E.formatter(m, v, b, y, "add", x), "<td role='gridcell' " + Y(b, w, j, y, m, x) + ">" + j + "</td>"))
                }
                A.grouping && (W.groupingPrepare && !L._locgr && W.groupingPrepare.call(T, p, n), V = $.isFunction(L.groupCollapse) ? L.groupCollapse.call(E, {
                    ...
                    rowid: u,
                    data: p
                }) : L.groupCollapse), B[h] = E.constructTr(u, V, d, p, f, c), B.push("</tr>"), A.rowIndexes[u] = U, U++, A.grouping && (P.push(B), B = []), B.length > A.maxItemsToJoin && (B = [B.join("")])
            }
        ...
        fillSelectOptions: function (e, t, r, i, a, o) {
            ...
            if (t) {
                if ("function" == typeof t && (t = t()), "string" == typeof t) for (n = t.split(i), l = 0; l < n.length; l++) 2 < (s = n[l].split(r)).length && (s[1] = $.map(s, m).join(r)), h.push({
                    value: s[0],
                    innerHtml: s[1],
                ...
                if ("string" == typeof o) {
                    ...
                    if (!u) for (l = 0; l < h.length; l++) c = h[l], a || c.selectText !== o || (c.selected = !0), a && -1 < $.inArray(c.selectText, f) && (c.selected = !0)
                }
    ...
    $.fn.jqGrid = function (Xe) {
        ...
        return this.each(function () {
            if (!this.grid) {
                var e, t, D = this, h = $(D), Z = $.isFunction, K = $.isArray, S = $.extend, b = $.inArray, r = $.trim,
                    q = $.each, g = Qe.setSelection, i = Qe.getGridRes,
                    ...
                    n = Xe.guiStyle || defaults.guiStyle || "jQueryUI", R = function (e) {
                        return Qe.getIconRes.call(D, e)
                    }, _ = function (e, t) {
                        return h.jqGrid("getGuiStyles", e, t)
                    };
                null == Xe && (Xe = {datatype: "local"}), void 0 !== Xe.datastr && K(Xe.datastr) && (t = Xe.datastr, Xe.datastr = []), void 0 !== Xe.data && (e = Xe.data, Xe.data = []), null != jgrid.formatter && null != jgrid.formatter.unused || F("CRITICAL ERROR!!!\n\n\nOne uses probably\n\n\t$.extend($.jgrid.defaults, {...});\n\nto set default settings of jqGrid instead of the usage the DEEP version of jQuery.extend (with true as the first parameter):\n\n\t$.extend(true, $.jgrid.defaults, {...});\n\nOne other possible reason:\n\nyou included some OLD version of language file (grid.locale-en.js for example) AFTER jquery.jqGrid.min.js. For example all language files of jqGrid 4.7.0 uses non-deep call of jQuery.extend.\n\n\nSome options of jqGrid could still work, but another one will be broken."), void 0 === Xe.datatype && void 0 !== Xe.dataType && (Xe.datatype = Xe.dataType, delete Xe.dataType), void 0 === Xe.mtype && void 0 !== Xe.type && (Xe.mtype = Xe.type, delete Xe.type), D.p = {iconSet: l};
                var ee = S(!0, {
                    height: "auto",
                    page: 1,
                    rowNum: 20,
                    ...
                    loadError: function (e, t, r) {
                        if ("abort" !== t && "abort" !== r) {
                            var i = e.getResponseHeader("Content-Type"), a = e.responseText || "", o = function (e) {
                                try {
                            ...
                            "text/html" === i ? a = function (e) {
                                ...
                                return e
                            }(a) : "application/json" === i ? a = o(a) : "text/plain" === i && (a = o(a)), 500 !== e.status && 0 !== e.status && (a = (t || r) + (r && r !== t ? ": " + r : "") + " " + e.status + " " + e.statusText + ("" !== a ? "<hr />" : "") + a), h.jqGrid("displayErrorMessage", a || t || r)
                        }
                    },
                    loadBeforeSend: null,
                    afterInsertRow: null,
                ...
                if (ee.recordpos = ee.recordpos || ("rtl" === ee.direction ? "left" : "right"), ee.autoResizing.widthOfVisiblePartOfSortIcon = void 0 !== ee.autoResizing.widthOfVisiblePartOfSortIcon ? ee.autoResizing.widthOfVisiblePartOfSortIcon : "fontAwesome" === ee.iconSet ? 13 : 12, ee.datatype = void 0 !== ee.datatype ? ee.datatype : void 0 !== e || null == ee.url ? "local" : null != ee.jsonReader && "object" == typeof ee.jsonReader ? "json" : "xml", ee.jsonReader = ee.jsonReader || {}, ee.url = ee.url || "", ee.cellsubmit = void 0 !== ee.cellsubmit ? ee.cellsubmit : void 0 === ee.cellurl ? "clientArray" : "remote", ee.gridview = void 0 !== ee.gridview ? ee.gridview : null == ee.afterInsertRow, void 0 !== e && (ee.data = e, Xe.data = e), void 0 !== t && (ee.datastr = t, Xe.datastr = t), "TABLE" === D.tagName.toUpperCase()) if ("" === D.id && h.attr("id", randId()), void 0 !== document.documentMode && document.documentMode <= 5) F("Grid can not be used in this ('quirks') mode!"); else {
                    ...
                    var O = jgrid.fixScrollOffsetAndhBoxPadding, s = function (e) {
                        var t, r = {}, i = e.length;
                        for (t = 0; t < i; t++) r[e[t].name] = t;
                        return r
                    }, d = function () {
                        var e, t, r = {}, i = ee.colModel, a = i.length;
                        ...
                        headers: [], cols: [], footers: [], dragStart: function (e, t, r, i) {
                            var a = this, o = $(a.bDiv), l = o.closest(ee.gBox).offset(),
                            ...
                            if (r) {
                                ...
                                r.moved = !0, d < s && (null == t.curGbox && (t.curGbox = $(ee.rs)), t.curGbox.css({left: r.sOL + o}), !0 === ee.forceFit ? (i = l[r.idx + ee.nv], (a = "ltr" === ee.direction ? i.width - o : i.width + o) > ee.autoResizing.minColWidth && (n.newWidth = s, i.newWidth = a)) : (t.newWidth = "ltr" === ee.direction ? ee.tblwidth + o : ee.tblwidth - o, n.newWidth = s))
                            }
                        }, resizeColumn: function (e, t, r) {
                            var i, a = this, o = a.headers, l = a.footers, n = o[e], s = n.newWidth || n.width,
                            ...
                            var t = $(this), r = ee.selrow, i = ee.selarrrow ? $.makeArray(ee.selarrrow) : null,
                                a = this.grid.bDiv, o = a.scrollLeft, l = function () {
                                    var e;
                                    if (ee.selrow = null, !ee.multiPageSelection) {
                                        if (clearArray(ee.selarrrow), ee.multiselect && i && 0 < i.length) for (e = 0; e < i.length; e++) i[e] !== r && g.call(t, i[e], !1, null);
                                        r && g.call(t, r, !1, null)
                                    }
                    ...
                    var k,
                        p = $("<div class='" + _("gView", "ui-jqgrid-view") + "' role='grid' aria-multiselectable='" + !!ee.multiselect + "'></div>"),
                        f = jgrid.msie;
                    ...
                    var m = $("<div class='" + _("gBox", "ui-jqgrid") + "'></div>");
                    $(m).attr({
                        id: ee.gBoxId,
                        dir: k
                    }).insertBefore(p), $(p).attr("id", ee.gViewId).appendTo(m), $("<div class='" + _("overlay", "jqgrid-overlay") + "' id='lui_" + ee.id + "'></div>").insertBefore(p), $("<div class='" + _("loading", "loading") + "' id='load_" + ee.id + "'>" + G("loadtext") + "</div>").insertBefore(p), h.attr({
                        role: "presentation",
                        "aria-labelledby": "gbox_" + D.id
                    });
                    var v, w = function (e, t, r, i, a, o) {
                        var l, n, s, d, c, u = ee.colModel[e],
                            p = u.autoResizable ? "<span class='" + ee.autoResizing.wrapperClassName + "'>" : "",
                            f = u.autoResizable ? r.substring(p.length, r.length - "</span>".length) : r,
                            h = ee.useUnformattedDataForCellAttr && null != o ? o[u.name] : u.autoResizable ? f : r,
                            g = u.classes, m = u.align ? "text-align:" + u.align + ";" : "", v = function (e) {
                                return "string" == typeof e ? e.replace(/'/g, "&#39;") : e
                            }, b = " aria-describedby='" + ee.id + "_" + u.name + "'";
                        if (!0 === u.hidden && (m += "display:none;"), 0 === t) m += "width: " + ie.headers[e].width + "px;"; else if ((Z(u.cellattr) || "string" == typeof u.cellattr && null != jgrid.cellattr && Z(jgrid.cellattr[u.cellattr])) && "string" == typeof (n = (Z(u.cellattr) ? u.cellattr : jgrid.cellattr[u.cellattr]).call(D, a, h, i, u, o, f))) for (n = n.replace(/\n/g, "&#xA;"); ;) {
                        ...
                        var t = ee.treeReader, r = t.loaded, i = t.leaf_field, a = t.expanded_field, o = function (e) {
                        ...
                        var e, t, r, i, a, o, l, n, s, d, c, u, p = ee.data, f = p.length, h = ee.localReader,
                            g = ee.additionalProperties, m = h.cell, v = ee.arrayReaderInfos;
                        if ("local" === ee.datatype && !0 === h.repeatitems) for (i = !1 === ee.keyName ? Z(h.id) ? h.id.call(D, p) : h.id : ee.keyName, isNaN(i) ? Z(i) || null != ee.arrayReaderInfos[i] && (a = ee.arrayReaderInfos[i].order) : a = Number(i), e = 0; e < f; e++) {
                        ...
                        } else if (ee.treeGrid) for (e = 0; e < f; e++) ae(p[e])
                    }, j = function () {
                        ...
                        var r, i, a, o = ee.colModel, l = o.length, n = function (e) {
                        ...
                        var a = this, o = $(a), l = new Date, n = ee.datatype,
                            s = "local" !== n && ee.loadonce || "xmlstring" === n || "jsonstring" === n,
                            d = ("xmlstring" === n || "xml" === n) && $.isXMLDoc(e), c = "_id_", u = ee.localReader,
                            p = getAccessor;
                        if (e && ("xml" !== n || d)) {
                            ...
                            var f, h, g, m, v, b, w, y, x, j, C, D, S, q = {}, F = ee.colModel, R = F.length,
                                _ = ee.arrayReaderInfos, I = {}, G = function (r) {
                                    return function (e) {
                            ...
                            var k, N, E, A, T = {}, M = ee.additionalProperties, B = function (e, t) {
                            ...
                            if (v = !1 === ee.keyName ? Z(u.id) ? u.id.call(a, e) : u.id : ee.keyName, isNaN(v) ? Z(v) || (_[v] && (b = _[v].order), d && !1 === ee.keyName && ("string" == typeof v && /^\[\w+\]$/.test(v) ? v = G(v.substring(1, v.length - 1)) : "string" == typeof v && /^\w+$/.test(v) && (v = O(v)))) : b = Number(v), m = p(e, u.root, !0), u.row) if (1 === m.length && "string" == typeof u.row && /^\w+$/.test(u.row)) {
                            ...
                            var L, V, H = [], W = [];
                            for (A = [], f = 0; f < g; f++) {
                                if (V = m[f], h = u.repeatitems && u.cell && p(V, u.cell, !0) || V, k = u.repeatitems && (d || K(h)), q = {}, I = {}, d && !k && null != h) for (C = (j = h.childNodes).length, x = 0; x < C; x++) 1 === (D = j[x]).nodeType && (I[D.nodeName] = D);
                                ...
                                if (void 0 !== q[v] ? L = void 0 !== q[v] ? q[v] : randId() : (void 0 === (L = p(V, K(V) ? b : v)) && (L = p(h, K(h) ? b : v)), void 0 === L && (L = randId())), void 0 === q[v] && (q[v] = L), L = String(L), w = ee.idPrefix + L, ee.treeGrid && ae(q), f < z) W.push(w), H.push(h), A.push(q); else if (!s) break;
                            ...
                            le(!0);
                            var Y = -1 < ee.treeANode ? ee.treeANode : 0, X = $(a.tBodies[0]);
                            ...
                            if (!1 === ee.gridview || Z(ee.afterInsertRow)) for (f = 0; f < Math.min(g, z); f++) feedback.call(a, "afterInsertRow", W[f], A[f], H[f]);
                            if (ee.totaltime = new Date - l, 0 < f && 0 === ee.records && (ee.records = g), clearArray(U), !0 === ee.treeGrid) try {
                                Qe.setTreeNode.call(o, Y + 1, f + Y + 1)
                            } catch (e) {
                            }
                            ee.reccount = Math.min(g, z), ee.treeANode = -1, ee.userDataOnFooter && Qe.footerData.call(o, "set", ee.userData, !0), s && (ee.records = g, ee.lastpage = Math.ceil(g / z)), r || a.updatepager(!1, !0), function () {
                        ...
                        return r <= 0 && (t = $(this).closest(".ui-jqgrid>.ui-jqgrid-view").css("font-size") || "11px", $(document.body).append("<div id='testpg' class='" + _("gBox", "ui-jqgrid") + "' style='font-size:" + t + ";visibility:hidden;margin:0;padding:0;' ></div>"), $(e).clone().appendTo("#testpg"), r = $("#testpg>.ui-pg-table").width(), $("#testpg").remove()), 0 < r && e.parent().width(r), r
                    }, A = function () {
                        ...
                        this.grid.hDiv.loading = !1, Qe.progressBar.call($(this), {method: "hide", loadtype: ee.loadui})
                    }, M = function (i) {
                        var a = this, t = $(a), r = a.grid;
                        if (!r.hDiv.loading) {
                            var e, o, l = ee.scroll && !1 === i, n = {}, s = ee.prmNames;
                            ...
                            var d = Z(ee.loadComplete), c = d ? ee.loadComplete : null, u = 0;
                            if (1 < (i = i || 1) ? null !== s.npage ? (n[s.npage] = i, u = i - 1, i = 1) : c = function (e) {
                                ...
                                var p, f, h, g, m = ee.groupingView, v = "";
                            ...
                            S(ee.postData, n);
                            var b = ee.scroll ? a.rows.length - 1 : 1, w = function () {
                                ...
                                var e;
                                if (ee.autoresizeOnLoad) Qe.autoResizeAllColumns.call(t), clearArray(ee.columnsToReResizing), ee.autowidth && Qe.setGridWidth.call(t, t.closest(".ui-jqgrid").parent().width(), !0); else {
                                ...
                                var e = function () {
                                    var e = $(this), n = ee.multiSort ? [] : "", t = {}, s = !1, c = {}, d = [], u = [],
                                        p = I("formatter.date.srcformat"), f = I("formatter.date.newformat");
                                    if (!K(ee.data)) return {};
                                    ee.multiSort && z(n, t);
                                    var h, g, m = !!ee.grouping && ee.groupingView, r = function (e, t, r) {
                                        var i, a, o = e.index || e.name, l = e.sorttype || "text";
                                        if (c[e.name] = {
                                            ...
                                            isAddProp: !0 === r
                                        }, "date" !== l && "datetime" !== l || (e.formatter && "string" == typeof e.formatter && "date" === e.formatter ? (i = e.formatoptions && e.formatoptions.srcformat ? e.formatoptions.srcformat : p, a = e.formatoptions && e.formatoptions.newformat ? e.formatoptions.newformat : f) : i = a = e.datefmt || "Y-m-d", c[e.name].srcfmt = i, c[e.name].newfmt = a), ee.grouping) for (g = 0, h = m.groupField.length; g < h; g++) e.name === m.groupField[g] && (d[g] = c[o], u[g] = o);
                                    ...
                                    if (q(ee.colModel, function (e) {
                                        ...
                                        r("string" == typeof this ? {name: this} : this, e, !0)
                                    ...
                                    if (ee.ignoreCase && (b = b.ignoreCase()), !0 === ee.search) {
                                        ...
                                        if (i) "string" == typeof i && (i = $.parseJSON(i)), function e(t) {
                                    ...
                                    if (ee.grouping) for (g = 0; g < h && g < u.length && g < d.length; g++) b.orderBy(u[g], m.groupOrder[g], d[g].stype, d[g].srcfmt);
                                    ...
                                    var o = parseInt(ee.rowNum, 10), l = ee.lastSelectedData.length,
                                        w = parseInt(ee.page, 10), y = Math.ceil(l / o), x = {};
                                    if (ee.grouping && ee.groupingView._locgr) {
                                        ...
                                        for (j = 0; j < l; j++) {
                                            if (D) for (C in ee.userData) ee.userData.hasOwnProperty(C) && (ee.userData[C] += parseFloat(ee.lastSelectedData[j][C] || 0));
                        ...
                        var t, r, i, a, o, l, n, s, c, u = _("states.hover"), p = _("states.disabled"),
                            f = "<td class='ui-pg-button " + p + "'><span class='ui-separator'></span></td>", h = "",
                            g = "<table style='table-layout:auto;white-space: pre;" + ("left" === ee.pagerpos ? "margin-right:auto;" : "right" === ee.pagerpos ? "margin-left:auto;" : "margin-left:auto;margin-right:auto;") + "' class='ui-pg-table'><tbody><tr>",
                            m = "", v = function (e, t, r) {
                        ...
                        if (d += "_" + e, t = "pg_" + e, r = e + "_left", i = e + "_center", a = e + "_right", $("#" + jqID(e)).append("<div id='" + t + "' class='ui-pager-control' role='group'><table class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;'><tbody><tr><td id='" + r + "' class='ui-jqgrid-pg-left'" + (void 0 !== ee.pagerLeftWidth ? " style='width:" + ee.pagerLeftWidth + "px;'" : "") + "></td><td id='" + i + "' class='ui-jqgrid-pg-center'" + (void 0 !== ee.pagerCenterWidth ? " style='width:" + ee.pagerCenterWidth + "px;'" : "") + "></td><td id='" + a + "' class='ui-jqgrid-pg-right'" + (void 0 !== ee.pagerRightWidth ? " style='width:" + ee.pagerRightWidth + "px;'" : "") + "></td></tr></tbody></table></div>").attr("dir", "ltr"), t = "#" + jqID(t), 0 < ee.rowList.length) {
                            m = "<td dir='" + k + "'>";
                            var b, w = G("pgrecs");
                            for (m += "<select class='" + _("pager.pagerSelect", "ui-pg-selbox") + "' " + (w ? "title='" + w + "'" : "") + ">", l = 0; l < ee.rowList.length; l++) 1 === (b = ee.rowList[l].toString().split(":")).length && (b[1] = b[0]), m += "<option value='" + b[0] + "'" + (re(ee.rowNum, 0) === re(b[0], 0) ? " selected='selected'" : "") + ">" + b[1] + "</option>";
                            m += "</select></td>"
                        }
                        if ("rtl" === k && (g += m), !0 === ee.pginput && (h = "<td dir='" + k + "'>" + jgrid.format(G("pgtext") || "", "<input aria-label='Page No.' class='" + _("pager.pagerInput", "ui-pg-input") + "' type='text' size='2' maxlength='7' value='0'/>", "<span id='sp_1_" + e + "'>0</span>") + "</td>"), e = "#" + jqID(e), !0 === ee.pgbuttons) {
                            var y = ["first", "prev", "next", "last"], x = y.slice(),
                                j = _("pager.pagerButton", "ui-pg-button");
                            for ("rtl" === k && y.reverse(), l = 0; l < y.length; l++) g += (n = y[l], s = x[l], void 0, c = G("pg" + n), "<td role='button' tabindex='0' id='" + n + d + "' class='" + j + "' " + (c ? "title='" + c + "'" : "") + "><span class='" + R("pager." + s) + "'></span></td>"), 1 === l && (g += "" !== h ? f + h + f : "")
                        } else "" !== h && (g += h);
                        "ltr" === k && (g += m), g += "</tr></tbody></table>", !0 === ee.viewrecords && $("td" + e + "_" + ee.recordpos, t).append("<span dir='" + k + "' style='text-align:" + ee.recordpos + "' class='ui-paging-info'></span>");
                        ...
                        C.append(g), o = E.call(this, C.children(".ui-pg-table")), ee._nvtd = [], ee._nvtd[0] = o ? Math.floor((ee.width - o) / 2) : Math.floor(ee.width / 3), ee._nvtd[1] = 0, g = null, $(".ui-pg-selbox", t).on("change", function () {
                            var e = re(this.value, 10), t = Math.round(ee.rowNum * (ee.page - 1) / e - .5) + 1;
                            ...
                            var e = re(ee.page, 1), t = e, r = this.id, i = re(ee.lastpage, 1), a = !1, o = !0, l = !0,
                                n = !0, s = !0;
                            ...
                            var t = e.charCode || e.keyCode || 0, r = re($(this).val(), 1);
                        ...
                        var l = this, n = l.grid, s = ee.colModel[t], d = _("states.disabled");
                        if (null != s && s.sortable && !(0 < ee.savedRow.length && "prevent" === ee.sortingDuringEditing)) {
                            if (ee.lastsort === t && "" !== ee.sortname ? "asc" === ee.sortorder ? ee.sortorder = "desc" : "desc" === ee.sortorder ? ee.sortorder = "asc" : ee.sortorder = s.firstsortorder || "asc" : ee.sortorder = s.firstsortorder || "asc", s.lso ? "asc" === s.lso ? s.lso += "-desc" : "desc" === s.lso ? s.lso += "-asc" : "asc-desc" !== s.lso && "desc-asc" !== s.lso || !ee.threeStateSort && !ee.multiSort || (s.lso = "") : s.lso = s.firstsortorder || "asc", !r && ee.resetPageAfterSort && (ee.page = 1), ee.multiSort) !function (e, t) {
                                var r, i = "", a = ee.colModel[e], o = _("states.disabled"),
                                    l = ee.frozenColumns ? $(D.grid.headers[e].el).add($(t)) : $(D.grid.headers[e].el),
                                    n = l.find("span.s-ico"), s = n.children("span.ui-icon-asc"),
                                    d = n.children("span.ui-icon-desc"), c = s, u = d, p = [], f = {};
                                if (l.find("span.ui-grid-ico-sort").addClass(o), l.attr("aria-selected", "false"), a.lso ? (n.show(), "desc" === (r = (r = a.lso.split("-"))[r.length - 1]) && (c = d, u = s), c.removeClass(o).css("display", ""), ee.showOneSortIcon && u.hide(), l.attr("aria-selected", "true")) : ee.viewsortcols[0] || n.hide(), z(p, f, a), "string" == typeof ee.sortname && "" !== ee.sortname && ee.sortname.split(",").length < p.length) {
                                    var h = function (i) {
                                        q(ee.colModel, function () {
                                            var e, t = "#jqgh_" + jgrid.jqID(ee.id + "_" + this.name), r = $(t);
                                            if (this.lso && (this.index || this.name) === i) {
                                                if ("function" == typeof p.indexOf) e = p.indexOf(i); else {
                                    ...
                                    if ("lastClickedFirstSorted" === ee.multiSortOrder && 1 < p.length) for (p.unshift(p[p.length - 1]), p.pop(); p.length > ee.maxSortColumns;) h(p[p.length - 1]); else Z(ee.multiSortOrder) && (p = ee.multiSortOrder.call(D, {
                                        sortNames: p,
                                        cm: a,
                                        sortDirs: f,
                                        removeSorting: h
                                ...
                                q(p, function () {
                                    ...
                                    if (this.sortable) {
                                        var e = b(this.name, p), t = "#jqgh_" + jgrid.jqID(ee.id + "_" + this.name),
                                            r = $(t);
                                        ee.frozenColumns && (r = r.add($(ie.fhDiv).find(t))), r.children(".ui-jqgrid-sort-order").html(e < 0 ? "&nbsp;" : Z(ee.formatSortOrder) ? ee.formatSortOrder.call(D, {
                                            cm: this,
                                            sortIndex: e
                                        }) : e + 1)
                                    }
                                ...
                                var c = n.headers, u = n.fhDiv, p = c[ee.lastsort] ? $(c[ee.lastsort].el) : $(),
                                    f = ee.frozenColumns ? $(a) : $(c[t].el), h = f.find("span.s-ico"),
                    ...
                    if (0 === ee.colNames.length) for (H = 0; H < ee.colModel.length; H++) ee.colNames[H] = void 0 !== ee.colModel[H].label ? ee.colModel[H].label : ee.colModel[H].name;
                    if (ee.colNames.length === ee.colModel.length) {
                        ...
                        if (ee.multiselect && ("left" === ee.multiselectPosition || "right" === ee.multiselectPosition)) {
                            ...
                            ee.colNames[Y]("<input id='" + ee.cbId + "' class='cbox' type='checkbox' aria-checked='false'/>"), ee.colModel[Y]({
                                name: "cb",
                        ...
                        if (ee.rownumbers && (ee.colNames.unshift(""), ee.colModel.unshift({
                            ...
                            "local" !== ee.datatype && (ee.localReader = {id: "_id_"}), ee.iPropByName = c(ee.additionalProperties)
                        }
                        if (function () {
                            var e, t, r, i = ee.remapColumns, a = ee.colModel, o = a.length, l = [];
                            ...
                            var e, t, r, i, a, o = ee.colModel, l = ee.cmNamesInputOrder, n = ee.additionalProperties,
                                s = l.length;
                            for (ee.arrayReaderInfos = {}, t = ee.arrayReaderInfos, a = 0; a < s; a++) r = l[a], b(r, ee.reservedColumnNames) < 0 && !t.hasOwnProperty(r) && (void 0 !== (i = ee.iColByName[r]) ? t[r] = {
                                ...
                                order: a,
                                type: 1
                            } : r === (ee.prmNames.rowidName || "rowid") && (t[r] = {index: i, type: 2}));
                        ...
                        }(), ee.data.length && (x.call(D), j.call(D)), !0 === ee.shrinkToFit && !0 === ee.forceFit) for (H = ee.colModel.length - 1; 0 <= H; H--) if (!0 !== ee.colModel[H].hidden) {
                            ee.colModel[H].resizable = !1;
                            break
                        }
                        var X, Q, J, ne, se, de, ce, ue, pe, fe = [], he = [], ge = [],
                            me = "<thead><tr class='ui-jqgrid-labels' role='row'>",
                            ve = "<tbody><tr style='display:none;'>", be = _("states.hover"),
                            we = _("states.hoverTh") || be, $e = _("states.disabled");
                        if (ee.multiSort) for (fe = ee.sortname.split(","), pe = 0; pe < fe.length; pe++) ge = r(fe[pe]).split(" "), fe[pe] = r(ge[0]), he[pe] = ge[1] ? r(ge[1]) : ee.sortorder || "asc";
                        for (H = 0; H < ee.colNames.length; H++) {
                            switch (W = ee.colModel[H], se = ee.headertitles || W.headerTitle ? " title='" + stripHtml("string" == typeof W.headerTitle ? W.headerTitle : ee.colNames[H]) + "'" : "", me += "<th id='" + ee.id + "_" + W.name + "' class='" + _("colHeaders", "ui-th-column ui-th-" + k + " " + (W.labelClasses || "")) + "'" + se + ">", X = W.index || W.name, W.labelAlign) {
                                case"left":
                                    de = "text-align:left;";
                                    break;
                                case"right":
                            ...
                            me += "<div id='jqgh_" + ee.id + "_" + W.name + "'" + (f ? " class='ui-th-div-ie'" : "") + ("" === de ? "" : " style='" + de + "'") + " role='columnheader'>", ue = W.autoResizable && "actions" !== W.formatter || W.rotated ? "<span class='" + ee.autoResizing.wrapperClassName + "'>" + ee.colNames[H] + "</span>" : ee.colNames[H], ee.sortIconsBeforeText ? (me += (ee.builderSortIcons || jgrid.builderSortIcons).call(D, H), me += ue) : (me += ue, me += (ee.builderSortIcons || jgrid.builderSortIcons).call(D, H)), me += "</div></th>", ve += "<td></td>", W.width = W.width ? parseInt(W.width, 10) : 150, "boolean" != typeof W.title && (W.title = !0), W.lso = "", X === ee.sortname && (ee.lastsort = H, W.lso = ee.sortorder || W.firstsortorder || "asc"), ee.multiSort && -1 !== (ge = b(X, fe)) && (W.lso = he[ge])
                        }
                        me += "</tr></thead>", ve += "</tr></tbody>";
                        var ye, xe, je, Ce, De, Se, qe, Fe, Re, _e, Ie,
                            Ge = $("<table class='" + _("hTable", "ui-jqgrid-htable") + "' style='width:1px' role='presentation' aria-labelledby='gbox_" + ee.id + "'>" + me + ve + "</table>");
                        if ($(Ge[0].tHead).children("tr").children("th").hover(function () {
                            $(this).addClass(we)
                        }, function () {
                            $(this).removeClass(we)
                        }), ee.multiselect && $(ee.cb, Ge).on("click", function () {
                            var t, e, r, i = _("states.select"), a = [], o = ee.iColByName.cb, l = function (e, t) {
                                ...
                                }, n = ie.fbRows, s = $e + " ui-subgrid jqgroup jqfoot jqgfirstrow jqgskipselect",
                                d = ee._index;
                            if (clearArray(ee.selarrrow), this.checked) {
                                if (t = !0, ee.selrow = 1 < D.rows.length ? D.rows[D.rows.length - 1].id : null, ee.multiPageSelection && ("local" === ee.datatype || ee.treeGrid)) if ("filtered" === ee.selectAllMode && null != ee.lastSelectedData && 0 < ee.lastSelectedData.length) for (ee.selarrrow = [], r = 0; r < ee.lastSelectedData.length; r++) ee.lastSelectedData[r].hasOwnProperty(ee.localReader.id) && ee.selarrrow.push(ee.idPrefix + ee.lastSelectedData[r][ee.localReader.id]); else if (null != ee.data && 0 < ee.data.length && null != d) for (e in d) d.hasOwnProperty(e) && ee.selarrrow.push(ee.idPrefix + e)
                        ...
                        }), Ce = 0, Re ? ie.width - _e - (De + Se * qe) !== Fe && (Ce = ie.width - _e - (De + Se * qe) - Fe) : Re || 1 === Math.abs(ie.width - _e - (De + Se * qe)) || (Ce = ie.width - _e - (De + Se * qe)), ee.colModel[ye].width += Ce, ee.tblwidth = De + Ce + Se * qe + _e, ee.tblwidth > ee.width && (ee.colModel[ye].width -= ee.tblwidth - parseInt(ee.width, 10), ee.tblwidth = ee.width)), $(m).css("width", ie.width + "px").append("<div class='" + _("resizer", "ui-jqgrid-resize-mark") + "' id='" + ee.rsId + "'>&#160;</div>"), $(ee.rs).on("selectstart", function () {
                            return !1
                        }).click(u).dblclick(function (e) {
                            var t = $(this).data("idx"), r = $(this).data("pageX"), i = ee.colModel[t];
                            if (null == r || null == i) return !1;
                            var a = String(r).split(";"), o = parseFloat(a[0]), l = parseFloat(a[1]);
                        ...
                        var ke = "";
                        ee.footerrow && (ke += "<table role='presentation' style='width:1px' class='" + _("gridFooter", "ui-jqgrid-ftable") + "'><tbody><tr role='row' class='" + _("rowFooter", "footrow footrow-" + k) + "'>");
                        var Ne = "<tr class='" + _("gridRow", "jqgfirstrow ui-row-" + ee.direction) + "' role='row' style='height:auto'>";
                        if (ee.disableClick = !1, $("th", Ge[0].tHead.rows[0]).each(function (e) {
                            var t = ee.colModel[e], r = t.name, i = $(this), a = i.children("div"),
                                o = a.children("span.s-ico"), l = ee.showOneSortIcon;
                            Q = t.width, void 0 === t.resizable && (t.resizable = !0), t.resizable ? (J = document.createElement("span"), $(J).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + k).on("selectstart", function () {
                                return !1
                            }), i.addClass(ee.resizeclass)) : J = "", i.css("width", Q + "px").prepend(J);
                            var n = "";
                            if (!(J = null) === t.hidden && (i.css("display", "none"), n = "display:none;"), Ne += "<td role='gridcell' " + (t.classes ? "class='" + t.classes + "' " : "") + "style='height:0;width:" + Q + "px;" + n + "'></td>", ie.headers[e] = {
                                width: Q,
                                el: this
                            }, "boolean" != typeof (ne = t.sortable) && (t.sortable = !0, ne = !0), "cb" !== r && "subgrid" !== r && "rn" !== r && ne && ee.viewsortcols[2] && a.addClass("ui-jqgrid-sortable"), ne) if (ee.multiSort) {
                                var s = "desc" === t.lso ? "asc" : "desc";
                                ee.viewsortcols[0] ? (o.css("display", ""), t.lso && (o.children("span.ui-icon-" + t.lso).removeClass($e), l && o.children("span.ui-icon-" + s).hide())) : t.lso && (o.css("display", ""), o.children("span.ui-icon-" + t.lso).removeClass($e), l && o.children("span.ui-icon-" + s).hide()), ee.showSortOrder && (ge = b(r, fe), o["beforeSortIcons" === ee.sortOrderPosition ? "before" : "after"]("<span class='ui-jqgrid-sort-order'>" + (ge < 0 ? "&nbsp;" : Z(ee.formatSortOrder) ? ee.formatSortOrder.call(D, {
                                    cm: this,
                                    sortIndex: ge
                                }) : ge + 1) + "</span>"))
                            } else {
                            ...
                            ee.footerrow && (ke += "<td role='gridcell' " + w(e, 0, "", null, "", !1) + ">&#160;</td>")
                        }).mousedown(function (e) {
                            var t, r, i = $(this), a = i.closest(".ui-jqgrid-hdiv").hasClass("frozen-div");
                            if (1 === $(e.target).closest("th>span.ui-jqgrid-resize").length) return null != (t = V(this)) && (!0 === ee.forceFit && (ee.nv = function (e) {
                                var t, r = e, i = e;
                                for (t = e + 1; t < ee.colModel.length; t++) if (!0 !== ee.colModel[t].hidden) {
                                    i = t;
                                    break
                                }
                                return i - r
                            ...
                            ee.viewsortcols[2] ? i += ".ui-jqgrid-sortable" : i += ">span.s-ico>span.ui-grid-ico-sort";
                        ...
                        ee.footerrow && (ke += "</tr></tbody></table>"), Ne += "</tr>", h.html("<tbody>" + Ne + "</tbody>"), h.addClass(_("grid", "ui-jqgrid-btable" + (!0 === ee.altRows && h.jqGrid("isBootstrapGuiStyle") ? " table-striped" : "")));
                        var Ee, Ae, Te = !(!ee.caption || !0 !== ee.hiddengrid),
                            Me = $("<div class='ui-jqgrid-hbox" + ("rtl" === k ? "-rtl" : "") + "'></div>"),
                            Be = _("top"), Pe = _("bottom");
                        if (ie.hDiv = document.createElement("div"), $(ie.hDiv).css({width: ie.width + "px"}).addClass(_("hDiv", "ui-jqgrid-hdiv")).append(Me).scroll(function () {
                            var e = $(this).next(".ui-jqgrid-bdiv")[0];
                            return e && (e.scrollLeft = this.scrollLeft), !1
                        }), $(Me).append(Ge), Ge = null, Te && $(ie.hDiv).hide(), ee.rowNum = parseInt(ee.rowNum, 10), (isNaN(ee.rowNum) || ee.rowNum <= 0) && (ee.rowNum = ee.maxRowNum), ee.pager) "string" == typeof ee.pager && "#" !== ee.pager.substr(0, 1) ? (Ae = ee.pager, Ee = $("#" + jqID(ee.pager))) : !0 === ee.pager ? (Ae = randId(), (Ee = $("<div id='" + Ae + "'></div>")).appendTo("body"), ee.pager = "#" + jqID(Ae)) : Ae = (Ee = $(ee.pager)).attr("id"), 0 < Ee.length ? (Ee.css({width: ie.width + "px"}).addClass(_("pager.pager", "ui-jqgrid-pager " + Pe)).appendTo(m), Te && Ee.hide(), C.call(D, Ae, ""), ee.pager = "#" + jqID(Ae)) : ee.pager = "";
                        ...
                        var ze = function (e) {
                            ...
                            do {
                                if (0 < (t = $(e).closest("td")).length) {
                                    if (i = (r = t.parent()).parent().parent(), r.is(".jqgrow") && (i[0] === this || i.is("table.ui-jqgrid-btable") && (i[0].id || "").replace("_frozen", "") === this.id)) break;
                                    e = t.parent()
                                }
                            } while (0 < t.length);
                            return t
                        ...
                        h.before(ie.hDiv).click(function (e) {
                            var i = _("states.select"), t = e.target, r = ze.call(D, t), a = r.parent();
                            if (0 !== a.length && !hasOneFromClasses(a, $e)) {
                                var o = a[0].id, l = r[0].cellIndex,
                                    n = $(t).hasClass("cbox") && $(t).is(":enabled") && !hasOneFromClasses(t, $e),
                                    s = feedback.call(D, "beforeSelectRow", o, e), d = !1,
                                    c = jgrid.detectRowEditing.call(D, o), u = null != c && "cellEditing" !== c.mode;
                                if ("A" !== t.tagName && (!u || n)) {
                                    ...
                                    if (s) if (ee.multikey) e[ee.multikey] && !d ? g.call(h, o, !0, e) : ee.multiselect && n && (n = $("#jqg_" + jqID(ee.id) + "_" + o).is(":checked"), $("#jqg_" + jqID(ee.id) + "_" + o).prop("checked", !n)); else if (ee.multiselect && ee.multiboxonly) if (n && !d) g.call(h, o, !0, e); else {
                            ...
                            var r = this, i = r.grid, a = $(this), o = r.p;
                        ...
                        }), ie.bDiv = document.createElement("div"), f && "auto" === String(ee.height).toLowerCase() && (ee.height = "100%"), $(ie.bDiv).append($("<div style='position:relative;'></div>").append("<div></div>").append(D)).addClass("ui-jqgrid-bdiv").css({
                            height: ee.height + (isNaN(ee.height) ? "" : "px"),
                            width: ie.width + "px"
                        }).scroll(ie.scrollGrid), ee.maxHeight && $(ie.bDiv).css("max-height", ee.maxHeight + (isNaN(ee.maxHeight) ? "" : "px")), h.css({width: "1px"}), $.support.tbody || 2 === $(">tbody", D).length && $(">tbody:gt(0)", D).remove(), ee.multikey && $(ie.bDiv).on(jgrid.msie ? "selectstart" : "mousedown", function () {
                            return !1
                        }), Te && $(ie.bDiv).hide(), ie.cDiv = document.createElement("div");
                        var Le = R("gridMinimize.visible"), Ve = R("gridMinimize.hidden"), He = G("showhide"),
                            We = !0 === ee.hidegrid ? $("<a role='link' class='" + _("titleButton", "ui-jqgrid-titlebar-close") + "'" + (He ? " title='" + He + "'" : "") + "/>").hover(function () {
                                We.addClass(be)
                            }, function () {
                                We.removeClass(be)
                            }).append("<span class='" + Le + "'></span>") : "";
                        if ($(ie.cDiv).append("<span class='ui-jqgrid-title'>" + ee.caption + "</span>").append(We).addClass(_("gridTitle", "ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === k ? "-rtl " : " ") + Be)), $(ie.cDiv).insertBefore(ie.hDiv), ee.toolbar[0]) {
                        ...
                        if ("string" == typeof ee.datatype && (ee.datatype = ee.datatype.toLowerCase()), ee.toppager ? (ee.toppager = ee.id + "_toppager", ie.topDiv = $("<div id='" + ee.toppager + "'></div>")[0], $(ie.topDiv).addClass(_("pager.pager", "ui-jqgrid-toppager" + (ee.caption ? "" : " " + Be))).css({width: ie.width + "px"}).insertBefore(ie.hDiv), C.call(D, ee.toppager, "_t"), ee.toppager = "#" + jqID(ee.toppager)) : "" !== ee.pager || ee.scroll || (ee.rowNum = ee.maxRowNum), ee.footerrow && (ie.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], Me = $("<div class='ui-jqgrid-hbox" + ("rtl" === k ? "-rtl" : "") + "'></div>"), $(ie.sDiv).append(Me).width(ie.width).insertAfter(ie.hDiv), $(Me).append(ke), ie.footers = $(".ui-jqgrid-ftable", ie.sDiv)[0].rows[0].cells, ee.rownumbers && (ie.footers[0].className = _("rowNum", "jqgrid-rownum")), Te && $(ie.sDiv).hide()), Me = null, ee.caption) {
                            ...
                            }), Te && (ee.datatype = "local", $(".ui-jqgrid-titlebar-close", ie.cDiv).trigger("click")))
                        } else $(ie.cDiv).hide(), $(ie.cDiv).nextAll("div:visible").first().addClass("ui-corner-top");
                        $(ie.hDiv).after(ie.bDiv), ie.eDiv = $("<div class='" + _("gridError", "ui-jqgrid-errorbar ui-jqgrid-errorbar-" + k) + "' style='display:none;'><span class='" + _("gridErrorText", "ui-jqgrid-error") + "'></span></div>")[0], $(ie.hDiv).after(ie.eDiv), $(m).click(u).dblclick(function (e) {
                            var t = $(ee.rs), r = t.offset(), i = t.data("idx"), a = t.data("delta"),
                                o = ee.colModel[i], l = $(this).data("pageX") || t.data("pageX");
                            if (null == l || null == o) return !1;
                            var n = String(l).split(";"), s = parseFloat(n[0]), d = parseFloat(n[1]);
                        ...
                        }), ee.pager || $(ie.cDiv).nextAll("div:visible").filter(":last").addClass(Pe), $(".ui-jqgrid-labels", ie.hDiv).on("selectstart", function () {
                            return !1
                        }), D.formatCol = w, D.sortData = L, D.updatepager = function (e, t) {
                            var r, i, a, o, l, n, s, d, c = this, u = $(c), p = c.grid, f = ee.pager || "",
                                h = ee.pager ? "_" + ee.pager.substr(1) : "", g = p.bDiv,
                                m = $.fmatter ? $.fmatter.NumberFormat : null,
                                v = ee.toppager ? "_" + ee.toppager.substr(1) : "", b = _("states.hover"),
                                w = _("states.disabled");
                            if ((a = parseInt(ee.page, 10) - 1) < 0 && (a = 0), l = (a *= parseInt(ee.rowNum, 10)) + ee.reccount, ee.scroll) {
                                ...
                                if (x) {
                                    var j = a * x, C = jgrid.fixMaxHeightOfDiv.call(c, parseInt(ee.records, 10) * x);
                                    $(g).children("div").first().css({height: C + "px"}).children("div").first().css({
                                        height: j + "px",
                                        display: ""
                            ...
                            if (f += ee.toppager ? (f ? "," : "") + ee.toppager : "") {
                                if (s = I("formatter.integer") || {}, r = re(ee.page), i = re(ee.lastpage), $(".selbox", f).prop("disabled", !1), !0 === ee.pginput) {
                                    var D = $(".ui-pg-input", f), S = String(ee.page).length;
                            ...
                            if (null != a) {
                                for (t in a) if (a.hasOwnProperty(t)) for (i in r = a[t]) r.hasOwnProperty(i) && (delete ee.indexByColumnData[t][i][e], $.isEmptyObject(ee.indexByColumnData[t][i]) && delete ee.indexByColumnData[t][i]);
                            ...
                            return "<tr role='row' id='" + e + "' tabindex='" + n + "' class='" + c + "'" + ("" === d ? "" : " style='" + d + "'") + s + ">"
                            ...
                            if (l = s.autoResizable && "actions" !== s.formatter ? "<span class='" + ee.autoResizing.wrapperClassName + "'>" + l + "</span>" : l, ee.treeGrid && "edit" !== a && (null == ee.ExpandColumn && 0 === r || ee.ExpandColumn === s.name)) {
                                null == o && (o = ee.data[ee._index[e]]);
                                var c = parseInt(o[ee.treeReader.level_field] || 0, 10),
                                    u = 0 === parseInt(ee.tree_root_level, 10) ? c : c - 1,
                                    p = o[ee.treeReader.leaf_field], f = o[ee.treeReader.expanded_field],
                                ...
                                l = "<div class='tree-wrap' style='width:" + 18 * (u + 1) + "px;'><div class='" + mergeCssClasses(ee.treeIcons.commonIconClass, g, "treeclick") + "' style='" + (!0 === ee.ExpandColClick ? "cursor:pointer;" : "") + ("rtl" === ee.direction ? "margin-right:" : "margin-left:") + 18 * u + "px;'></div></div><span class='cell-wrapper" + (p ? "leaf" : "") + "'" + (ee.ExpandColClick ? " style='cursor:pointer;'" : "") + ">" + l + "</span>"
                            }
                            return l
                        }, S(ie, {
                            populate: M, emptyRows: function (e, t) {
                                var r = ie.bDiv,
                                    i = null != ie.fbDiv ? ie.fbDiv.children(".ui-jqgrid-btable")[0] : null,
                                    a = function (e) {
                                        if (e) {
                                            var t = e.rows, r = t[0];
                                            if (ee.deepempty) t && $(t).slice(1).remove(); else if (ee.quickEmpty) if ("quickest" === ee.quickEmpty) e.replaceChild(document.createElement("tbody"), e.tBodies[0]), e.firstChild.appendChild(r); else for (; 1 < t.length;) e.deleteRow(t.length - 1); else $(e.firstChild).empty().append(r)
                                        }
                                    };
                                $(this).off(".jqGridFormatter"), a(this), a(i), e && ee.scroll && ($(r.firstChild).css({height: "auto"}), $(r.firstChild.firstChild).css({
                                    height: 0,
                                    display: "none"
    ...
    jgrid.extend({
        getGridRes: function (e) {
            ...
            return 0 <= $.inArray("ui-jqgrid-bootstrap", $(this).jqGrid("getGuiStyles", "gBox").split(" "))
            ...
            var t = this instanceof $ && 0 < this.length ? this[0] : this;
            if (!t || !t.p) return "";
            var r = t.p, i = jgrid.icons[r.iconSet], a = function (e, t, r) {
                var i, a, o, l = t.split("."), n = l.length, s = [];
            ...
            return this.each(function () {
                ...
                if (null != this.p.rowIndexes && (t = r[this.p.rowIndexes[o]]) && t.id === o && (a = t), !a) try {
                    for (e = r.length; e--;) if (t = r[e], o === t.id) {
                        a = t;
                        break
                    }
                } catch (e) {
            ...
            var a = [];
            return this.each(function () {
                var e, t, r = this.rows, i = r.length;
                if (i && 0 < i) for (e = 0; e < i; e++) t = r[e], $(t).hasClass("jqgrow") && a.push(t.id)
            }), a
        }, setSelection: function (C, D, S) {
            return this.each(function () {
                var e, t, r, i, a, o, l, n, s, d, c, u, p, f, h = this, g = $(h), m = h.p, v = base.getGuiStyles,
                    b = base.getGridRowById, w = v.call(g, "states.select"), y = v.call(g, "states.disabled"),
                    x = h.grid.fbRows, j = function (e, t) {
                        var r = t ? "addClass" : "removeClass", i = m.iColByName.cb,
                            a = t ? {"aria-selected": "true", tabindex: "0"} : {"aria-selected": "false", tabindex: "-1"},
                            o = function (e) {
            ...
            return this.each(function () {
                var e, t = this, r = $(this), i = t.p, a = base.getGuiStyles, o = base.getGridRowById,
                    l = a.call(r, "states.select"), n = "edit-cell " + l,
                    s = "selected-row " + a.call(r, "states.hover"), d = i.iColByName.cb, c = void 0 !== d,
                    u = t.grid.fbRows, p = function (e) {
                        var t, r = "removeClass", i = {"aria-selected": "false", tabindex: "-1"};
                ...
                if (void 0 !== h) {
                    if (e = o.call(r, h), p(e), c) {
                        t.setHeadCheckBox(!1);
                        var f = $.inArray(h, i.selarrrow);
                        -1 !== f && i.selarrrow.splice(f, 1)
                    }
                } else i.multiselect ? ($(t.rows).each(function () {
                    var e = $.inArray(this.id, i.selarrrow);
                    -1 !== e && (p(this), i.selarrrow.splice(e, 1))
            ...
            return "object" == typeof p && (f = p, p = void 0), f = f || {}, this.each(function () {
                var e, t, r, i, a, o, l, n = this, s = n.p, d = !1, c = 1, u = n.rows;
                if (void 0 === p) d = !0, h = [], c = u.length; else if (!(e = base.getGridRowById.call($(n), p))) return g;
                for (t = 0; t < c; t++) if (d && (e = u[t]), $(e).hasClass("jqgrow")) {
                    for (jgrid.detectRowEditing.call(n, p), i = $(e).find("td[role=gridcell]"), r = 0; r < i.length; r++) if (o = (a = s.colModel[r]).name, $.inArray(o, s.reservedColumnNames) < 0 && "actions" !== a.formatter && (!f.skipHidden || !a.hidden)) if (l = i[r], base.isCellEditing.call($(n), p, r, e)) g[o] = jgrid.getEditedValue.call(n, jgrid.getDataFieldOfCell.call(n, e, r), a, {}, a.editable); else if (!0 === s.treeGrid && o === s.ExpandColumn) g[o] = htmlDecode($("span", l).first().html()); else try {
                        g[o] = $.unformat.call(n, l, {rowId: p, colModel: a}, r)
                    } catch (e) {
            ...
            var u = !1;
            return this.each(function () {
                var e, t, r, i = this, a = i.p, o = $.jgrid.detectRowEditing.call(i, c);
                ...
                if (e.rowIndex === a.iRow && (a.iRow = -1, a.iCol = -1), $(e).remove(), a.records--, a.reccount--, i.updatepager(!0, !1), u = !0, a.multiselect && -1 !== (t = $.inArray(c, a.selarrrow)) && a.selarrrow.splice(t, 1), a.multiselect && 0 < a.selarrrow.length ? a.selrow = a.selarrrow[a.selarrrow.length - 1] : a.selrow === c && (a.selrow = null), "local" === a.datatype) {
                    var l = stripPref(a.idPrefix, c), n = a._index[l];
                ...
                if (i.rebuildRowIndexes(), !0 === a.altRows && u && !$(i).jqGrid("isBootstrapGuiStyle")) {
                    var s = a.altclass, d = i.grid.fbRows;
            ...
            var o = !0;
            return this.each(function () {
                var l, n = this, s = n.p, e = typeof i, d = {};
                if (!n.grid) return !1;
                if (!(l = base.getGridRowById.call($(n), p))) return !1;
                if (f) try {
                    var t, a = stripPref(s.idPrefix, p), r = s._index[a], c = {}, u = null != r ? s.data[r] : void 0;
                    if ($(s.colModel).each(function (e) {
                        var t = this, r = t.name, i = getAccessor(f, r);
                        ...
                        var t, r = this.name, i = getAccessor(f, r), a = $(l.cells[e]);
                        if (void 0 !== i) {
                            "local" === s.datatype && null != u && (i = d[r]), t = this.title ? {title: i} : {}, i = n.formatter(p, i, e, f, "edit", c), "select" === this.formatter && (t = this.title ? {title: stripHtml(i)} : {});
                            var o = a;
                        ...
                        if (s.treeGrid) for (t in s.treeReader) s.treeReader.hasOwnProperty(t) && delete d[s.treeReader[t]];
            ...
            return p && ($.isArray(p) ? (y = !0, x = u) : y = !(p = [p]), this.each(function () {
                var e, t, r = this, i = r.p, a = p.length, o = $(r), l = r.rows, n = 0, s = base.getGridRowById,
                    d = i.colModel, c = i.additionalProperties;
            ...
            return null == c && (c = "get"), "boolean" != typeof p && (p = !0), c = c.toLowerCase(), this.each(function () {
                ...
                f = !0;
                var l = $(a.grid.sDiv).children(".ui-jqgrid-hbox" + ("rtl" === o.direction ? "-rtl" : "")).children(".ui-jqgrid-ftable")[0];
                if (null == l || null == l.rows) return !1;
                var n = l.rows[0].cells, s = o.colModel,
                    d = null == a.grid.fsDiv ? {} : a.grid.fsDiv.children(".ui-jqgrid-ftable")[0].rows[0].cells;
                if ("get" === c) for (i = 0; i < s.length; i++) r = s[i].name, $.inArray(r, o.reservedColumnNames) < 0 && (!1 !== u ? (e = $(n[i]).text(), $.trim(e) && (h[r] = e)) : h[r] = $(n[i]).html()); else if ("set" === c) for (r in u) i = o.iColByName[r], u.hasOwnProperty(r) && void 0 !== i && (e = p ? a.formatter("", u[r], i, u, "edit") : u[r], (t = $(n[i]).add(d[i])).html(e), s[i].title && t.attr({title: stripHtml(e)}))
            }), "get" === c ? h : f
        }, resetColumnResizerHeight: function () {
            return this.each(function () {
                if ($.jgrid.msie) {
                    var e, t, r, i, a = this.grid.headers;
                    for (r = 0; r < a.length; r++) (i = (e = $(a[r].el)).height()) && 0 < (t = e.children(".ui-jqgrid-resize")).length && .5 < Math.abs(i - t.height()) && e.children(".ui-jqgrid-resize").height(i)
                }
            })
        }, rotateColumnHeaders: function (w, y) {
            return this.each(function () {
                var e, t, r, i, a, o, l, n, s, d, c, u, p, f, h, g, m = $(this), v = this.p,
                    b = v.frozenColumns && $.isFunction(base.getNumberOfFrozenColumns) ? m.jqGrid("getNumberOfFrozenColumns") : 0;
                for ($.isArray(w) || (w = [w]), e = 0; e < w.length; e++) o = w[e], 0 <= (t = isNaN(o) ? v.iColByName[o] : parseInt(o, 10)) && (r = this.grid.headers[t].el, i = t < b ? $(r).add($(this.grid.fhDiv.find("#" + jqID(r.id)))) : $(r), l = i.children("div"), n = l.children("span.s-ico"), d = l.children("span.ui-jqgrid-sort-order"), (s = l.children("span." + v.autoResizing.wrapperClassName)).length < 1 && (n.detach(), d.detach(), l.wrapInner("<span class='" + v.autoResizing.wrapperClassName + "'></span>"), s = l.children("span." + v.autoResizing.wrapperClassName), l.each(function (e) {
                    ...
                    paddingLeft: h + "px",
                    paddingRight: g + "px"
                }), l.css("min-width", a - p - f + "px").addClass("ui-jqgrid-rotate").css({bottom: 0}), v.colModel[t].rotated = !0);
                m.jqGrid("resetColumnResizerHeight"), v.frozenColumns && setTimeout(function () {
                    m.triggerHandler("jqGridResetFrozenHeights", {
                        header: {
                            resizeDiv: !0,
                            resizedRows: {iRowStart: 0, iRowEnd: -1}
                        }, resizeFooter: !0, body: {resizeDiv: !0, resizedRows: {iRowStart: -1, iRowEnd: -1}}
                    })
                }, 0)
            })
        }, showHideCol: function (u, w, p) {
            return this.each(function () {
                var t, r = this, e = $(r), i = r.grid, a = !1, v = r.p, o = jgrid.cell_width ? 0 : v.cellLayout;
                if (i) {
                    "string" == typeof u && (u = [u]), p = p || {};
                    var b = "" === (w = "none" !== w && !1 !== w ? "" : "none"), l = v.groupHeader,
                    ...
                    if (n && !p.skipSetGroupHeaders && base.destroyGroupHeader.call(e, !1), $(v.colModel).each(function (m) {
                        var e = function (e) {
                            ...
                            for (t = 0, r = e.length; t < r; t++) a = (i = e[t]).cells[m], (!$(i).hasClass("jqgroup") || null != a && 1 === a.colSpan) && (o = $(a), 0 === t && $(i).hasClass("jqgfirstrow") ? (o.css("height", "1px"), o.css("display", w), o.css("height", "0")) : o.css("display", w), b && null != a && "TH" === a.tagName.toUpperCase() && o.hasClass("ui-th-column") && (l = o.children("div")).hasClass("ui-jqgrid-rotate") && (n = l.children("span.s-ico"), (s = l.children("span." + v.autoResizing.wrapperClassName)).outerHeight(), d = s.outerWidth(), n.outerHeight(), c = n.outerWidth(!0), 0 < s.length && (p = parseFloat(o.css("padding-top") || 0), f = parseFloat(o.css("padding-bottom") || 0), h = parseFloat(o.css("padding-left") || 0), g = parseFloat(o.css("padding-right") || 0), v.showSortOrder && (c += .5 * c), u = d + c + h + g, o.height(u), o.css({
                                paddingTop: g + "px",
                                paddingBottom: h + "px",
                                paddingLeft: p + "px",
                                paddingRight: f + "px"
                            }), l.css("min-width", u - h - g + "px").css({bottom: 0}))))
                        };
                    ...
                    if (n && !p.skipSetGroupHeaders) if (null != v.pivotOptions && null != v.pivotOptions.colHeaders && 1 < v.pivotOptions.colHeaders.length) {
            ...
            var r, i, o, l, n = this[0], s = n.p, d = n.grid, c = $.makeArray, u = !0 === s.frozenColumns,
            ...
            function h(e, t) {
                (t ? e.children(t) : e.children()).each(function () {
                    var i = this, a = c(i.cells);
                    $.each(l, function (e) {
                        var t = a[this], r = i.cells[e];
            ...
            return this.each(function () {
                var t, r, e, i, a = this, o = a.p, l = a.grid, n = 0, s = 0, d = !1, c = 0, u = jgrid.isCellClassHidden,
                    p = _;
                if (l && null != o) {
                    a.fixScrollOffsetAndhBoxPadding();
                    var f, h, g, m, v = o.colModel, b = o.scrollOffset, w = jgrid.cell_width ? 0 : o.cellLayout,
                        y = l.headers, x = l.footers, j = l.bDiv, C = l.hDiv, D = l.sDiv, S = l.cols,
                        q = $(C).find(">div>.ui-jqgrid-htable>thead>tr").first()[0].cells, F = function (e) {
                    ...
                    if ("boolean" != typeof I && (I = o.shrinkToFit), !isNaN(p)) {
                        ...
                        var R = {resizeDiv: !0, resizedRows: {iRowStart: I ? 0 : -1, iRowEnd: -1}};
                        $(a).triggerHandler("jqGridResetFrozenHeights", [{header: R, resizeFooter: !0, body: R}])
                    }
                }
            })
        }, setGridHeight: function (a) {
            return this.each(function () {
                var e = this, t = e.grid, r = e.p;
                if (t) {
                    var i = $(t.bDiv);
                    i.css({height: a + (isNaN(a) ? "" : "px")}), !0 === r.frozenColumns && $(r.idSel + "_frozen").parent().height(i.height() - 16), r.height = a, r.scroll && t.populateVisible.call(e), e.fixScrollOffsetAndhBoxPadding(), $(e).triggerHandler("jqGridResetFrozenHeights")
                }
            })
        }, setCaption: function (t) {
            return this.each(function () {
                var e = this.grid.cDiv;
                this.p.caption = t, $("span.ui-jqgrid-title, span.ui-jqgrid-title-rtl", e).html(t), $(e).show(), $(e).nextAll("div").removeClass(base.getGuiStyles.call(this, "top")), $(this).triggerHandler("jqGridResetFrozenHeights")
            })
            ...
            return this.each(function () {
                ...
                if (this.grid) {
                    ...
                    0 <= e && (t = $(this.grid.headers[e].el), i.frozenColumns && (t = t.add(this.grid.fhDiv.find("#" + jqID(t)))), a && (t.each(function () {
                        var e = $("[id^=jqgh_]", this), t = e.children("span.ui-jqgrid-cell-wrapper");
                        if (0 < t.length) t.html(a); else {
                            var r = $(".s-ico", this);
            ...
            return this.each(function () {
                var e, t, r, i, a, o, l, n, s, d, c, u = this, p = u.p, f = p.colModel, h = {};
                if (u.grid && 0 <= (e = isNaN(v) ? p.iColByName[v] : parseInt(v, 10)) && (o = base.getGridRowById.call($(u), m))) {
                    if (l = jgrid.getCell.call(u, o, e), "" !== b || !0 === x) {
                        if (i = f[e], "local" === p.datatype && (d = stripPref(p.idPrefix, m), void 0 !== (c = p._index[d]) && (a = p.data[c])), null == a) {
                            for (r = 0; r < o.cells.length; r++) if (r !== e && 0 < (n = jgrid.getDataFieldOfCell.call(u, o, r)).length) {
                                try {
                                    s = $.unformat.call(u, n, {rowId: m, colModel: f[r]}, r)
                                } catch (e) {
                        ...
                        var g = l;
                        !0 === p.treeGrid && i.name === p.ExpandColumn && (g = g.children("span.cell-wrapperleaf,span.cell-wrapper").first()), g.html(t), i.title && l.attr({title: b}), null != a && (t = convertOnSaveLocally.call(u, b, i, a[i.name], d, a, e), $.isFunction(i.saveLocally) ? i.saveLocally.call(u, {
                            newValue: t,
                            newItem: a,
                            oldItem: a,
                            id: d,
            ...
            return p = "boolean" == typeof p && p, void 0 === f && (f = !1), this.each(function () {
                var e, t, r = this, i = r.p;
                if (r.grid && 0 <= (e = isNaN(u) ? i.iColByName[u] : parseInt(u, 10))) {
                    var a, o, l = r.rows, n = l.length, s = 0, d = 0, c = i.colModel[e];
                    if (n && 0 < n) {
                        for (; s < n;) {
            ...
            return this.each(function () {
                var e = this, t = e.p, r = e.rows, i = e.grid;
                i && t && r && ("boolean" != typeof a && (a = !1), $(e).off(".jqGridFormatter"), i.emptyRows.call(e, !1, !0), t.footerrow && a && $(".ui-jqgrid-ftable td", i.sDiv).html("&#160;"), t.selrow = null, clearArray(t.selarrrow), clearArray(t.savedRow), t.editingInfo = {}, clearArray(t.data), clearArray(t.lastSelectedData), t._index = {}, t.rowIndexes = {}, t.dataIndexById = {}, t.indexByColumnData = {}, t.records = 0, t.page = 1, t.lastpage = 0, t.reccount = 0, e.updatepager(!0, !1))
            })
        }, getInd: function (e, t) {
            ...
            return i = $.extend({
                ...
                var e = "show" === i.method, t = jqID(this.p.id), r = $("#load_" + t);
            ...
            return this.each(function () {
                var e, t = $(this), r = this.grid, i = this.p;
                if ("string" == typeof a) {
            ...
            var r, i, a, o, l, n = (t = t[0]).rows, s = t.p, d = s.colModel[e], c = $(t.grid.headers[e].el),
                u = c.children("div"), p = parseFloat(c.css(d.rotated ? "padding-top" : "padding-left") || 0),
                f = parseFloat(c.css(d.rotated ? "padding-bottom" : "padding-right") || 0),
                h = u.children("span.s-ico"), g = u.children(".ui-jqgrid-sort-order"),
                m = u.children("." + s.autoResizing.wrapperClassName), v = d.rotated ? m.outerHeight() : m.outerWidth(),
                b = parseFloat(m.css(d.rotated ? "height" : "width") || 0), w = 0, y = 0,
            ...
            return this.each(function () {
                var e, t = $(this), r = this.p, i = r.colModel[n], a = $(this.grid.headers[n].el),
                    o = base.getAutoResizableWidth.call(t, n), l = (i.autoResizing || {}).resetWidthOrg;
            ...
            return this.each(function () {
                var e, t, r = $(this), i = this.p, a = i.colModel, o = a.length, l = i.shrinkToFit,
                    n = i.autoResizing.adjustGridWidth, s = i.autoResizing.fixWidthOnShrink,
                    d = parseInt(i.widthOrg, 10), c = this.grid, u = base.autoResizeColumn;
    ...
    jgrid.extend({
        editCell: function (D, S, q) {
            return this.each(function () {
                var e, t, r, i, a = this, o = $(a), l = a.p, n = a.rows;
                if (a.grid && !0 === l.cellEdit && null != n && null != n[D] && (D = parseInt(D, 10), S = parseInt(S, 10), !isNaN(D) && !isNaN(S))) {
                    var s, d = n[D], c = null != d ? d.id : null, u = $(d), p = parseInt(l.iCol, 10),
                        f = parseInt(l.iRow, 10), h = $(n[f]), g = l.savedRow;
                    if (null != c) {
                        ...
                        if ("subgrid" !== (e = (i = l.colModel[S]).name) && "cb" !== e && "rn" !== e) {
                            ...
                            if (!0 !== m || !0 !== q || r.hasClass("not-editable-cell")) l.noCellSelection || (0 <= p && 0 <= f && (getTdByColumnIndex.call(a, h[0], p).removeClass(v), h.removeClass(b)), r.addClass(v), u.addClass(b)), t = r.html().replace(/&#160;/gi, ""), feedback.call(a, "onSelectCell", c, e, t, D, S); else {
                                ...
                                try {
                                    t = $.unformat.call(a, r, {rowId: c, colModel: i}, S)
                                } catch (e) {
                                ...
                                var y = $.extend({}, i.editoptions || {}, {
                                    ...
                                    j = r, C = !0 === l.treeGrid && e === l.ExpandColumn;
            ...
            return this.each(function () {
                var i = this, a = $(i), o = i.p, r = i.grid, l = jgrid.info_dialog, e = jgrid.jqID;
                if (r && !0 === o.cellEdit) {
                    var t = a.jqGrid("getGridRes", "errors"), n = t.errcap, s = a.jqGrid("getGridRes", "edit").bClose,
                        d = o.savedRow, c = 1 <= d.length ? 0 : null;
                    if (null !== c) {
                        var u, p = i.rows[F], f = null != p ? p.id : null, h = null != p ? $(p) : $(),
                            g = o.colModel[R], m = g.name, v = getTdByColumnIndex.call(i, p, R), b = {},
                        ...
                        if (w !== d[c].v) {
                            ...
                            if (null == y || !0 === y || !0 === y[0]) {
                                ...
                                if ($.isFunction(o.beforeSubmitCell) && ((j = o.beforeSubmitCell.call(i, f, m, w, F, R)) || (j = {})), 0 < $("input.hasDatepicker", v).length && $("input.hasDatepicker", v).datepicker("hide"), "date" === g.formatter && !0 !== x.sendFormatted && (w = $.unformat.date.call(i, w, g)), "remote" === o.cellsubmit) if (o.cellurl) {
                                    var C = {};
                                    C[m] = w;
                                    var D = o.prmNames, S = D.id, q = D.oper;
                                    C[S] = jgrid.stripPref(o.idPrefix, f), C[q] = D.editoper, C = $.extend(j, C), o.autoEncodeOnEdit && $.each(C, function (e, t) {
                                        ...
                                        error: function (e, t, r) {
                                            a.triggerHandler("jqGridErrorCell", [e, t, r]), $.isFunction(o.errorCell) ? o.errorCell.call(i, e, t, r) : l.call(i, n, e.status + " : " + e.statusText + "<br/>" + t, s), a.jqGrid("restoreCell", F, R)
                                        }
                                ...
                                setTimeout(function () {
                                    ...
                                    l.call(i, n, w + " " + y[1], s, {
                                        top: e.top,
                                        left: e.left + $(i).closest(".ui-jqgrid").offset().left
                                    })
            ...
            return this.each(function () {
                var e, t, r, i = this, a = i.p, o = i.rows[d], l = o.id;
                if (i.grid && !0 === a.cellEdit) {
                    var n = a.savedRow, s = getTdByColumnIndex.call(i, o, c);
                    if (1 <= n.length) {
            ...
            return this.each(function () {
                var e, t, r, i = this, a = $(i), o = i.p, l = !1, n = i.rows;
                if (i.grid && !0 === o.cellEdit && null != n && null != n[s]) {
                    for (e = d + 1; e < o.colModel.length; e++) if (t = (r = o.colModel[e]).editable, $.isFunction(t) && (t = t.call(i, {
                        rowid: n[s].id,
                        iCol: e,
                        iRow: s,
                        cmName: r.name,
            ...
            return this.each(function () {
                var e, t, r, i = this, a = $(i), o = i.p, l = !1, n = i.rows;
                if (i.grid && !0 === o.cellEdit && null != n && null != n[s]) {
                    for (e = d - 1; 0 <= e; e--) if (t = (r = o.colModel[e]).editable, $.isFunction(t) && (t = t.call(i, {
                        rowid: n[s].id,
                        iCol: e,
                        iRow: s,
                        cmName: r.name,
            ...
            return this.each(function () {
                var i, a, f = this, o = $(f), l = f.p, e = f.grid;
                if (e && !0 === l.cellEdit) {
                    var h = e.bDiv;
                    l.knv = l.id + "_kn";
                    var t = $("<div style='position:fixed;top:0px;width:1px;height:1px;' tabindex='0'><div tabindex='-1' style='width:1px;height:1px;' id='" + l.knv + "'></div></div>");
                    $(t).insertBefore(e.cDiv), $("#" + l.knv).focus().keydown(function (e) {
                        var t = parseInt(l.iRow, 10), r = parseInt(l.iCol, 10);
                ...
                function n(e, t, r) {
                    var i = f.rows[e];
                    if ("v" === r.substr(0, 1)) {
                        var a = h.clientHeight, o = h.scrollTop, l = i.offsetTop + i.clientHeight, n = i.offsetTop;
                        "vd" === r && o + a <= l && (h.scrollTop = h.scrollTop + i.clientHeight), "vu" === r && n < o && (h.scrollTop = h.scrollTop - i.clientHeight)
                    }
                    if ("h" === r) {
                        var s = h.clientWidth, d = h.scrollLeft, c = i.cells[t], u = c.offsetLeft + c.clientWidth,
                            p = c.offsetLeft;
                ...
                function s(e, t) {
                    ...
                    if ("lft" === t) for (i = e + 1, r = e; 0 <= r; r--) if (!0 !== a[r].hidden) {
                        i = r;
                        break
                    }
            ...
            return u || (u = "all"), this.each(function () {
                var n = this, s = n.p, d = jgrid.htmlDecode, c = n.rows;
                n.grid && !0 === s.cellEdit && $(c).each(function (a) {
                    var o = {};
                    if ($(this).hasClass("edited")) {
                        var l = this;
                        $(this.cells).each(function (e) {
                            var t = s.colModel[e], r = t.name, i = getTdByColumnIndex.call(n, l, e);
                            if ("cb" !== r && "subgrid" !== r && "rn" !== r && ("dirty" !== u || i.hasClass("dirty-cell"))) try {
                                o[r] = $.unformat.call(n, i[0], {rowId: c[a].id, colModel: t}, e)
                            } catch (e) {
                                o[r] = d(i.html())
                            }
    ...
    jgrid.jqModal = jgrid.jqModal || {}, $.extend(!0, jgrid.jqModal, {toTop: !0}), $.extend(jgrid, {
        showModal: function (e) {
            ...
            if (0 < l.buttons.length) for (s = 0; s < l.buttons.length; s++) void 0 === l.buttons[s].id && (l.buttons[s].id = "info_button_" + s), d += jgrid.builderFmButon.call(a, l.buttons[s].id, l.buttons[s].text);
            ...
            var o = "", u = this, l = u.p, n = jgrid.info_dialog, s = function (e) {
                return getGridRes.call($(u), e)
            }, d = s("errors.errcap"), c = s("edit"), p = c.msg, f = c.bClose;
            ...
            switch (e) {
                case"textarea":
                    ...
                    }) : t.cols || (t.cols = 19), t.rows || (t.rows = 2), ("&nbsp;" === r || "&#160;" === r || 1 === r.length && 160 === r.charCodeAt(0)) && (r = ""), o.value = r, h(o, t), $(o).attr({role: "textbox"});
                    break;
                case"checkbox":
                    ...
                    h(o, t, ["value"]), $(o).attr({role: "checkbox", "aria-checked": o.checked ? "true" : "false"});
                    break;
                case"select":
                    ...
                    if (l && l.idPrefix && (w = jgrid.stripPref(l.idPrefix, w)), void 0 === t.dataUrl && t.generateValue && null != l.indexByColumnData[t.cm.name] && (t.value = u.generateValueFromColumnIndex(t.cm.name, t.separator, t.delimiter)), void 0 !== t.dataUrl) {
                        var y = t.postData || a.postData,
                            x = {elem: o, options: t, cm: t.cm, mode: t.mode, rowid: w, iCol: t.iCol, ovm: b};
                        h(o, t, y ? ["postData"] : void 0), $.ajax($.extend({
                            ...
                            success: function (e, t, r) {
                                var i = this.ovm, a = this.elem, o = this.cm, l = this.iCol,
                                    n = $.extend({}, this.options), s = this.rowid, d = this.mode,
                ...
                case"custom":
                    ...
                    try {
                        ...
                        C = $(C).addClass("customelement").attr({id: t.id, name: t.name}), $(o).empty().append(C)
                    } catch (e) {
        ...
        getColProp: function (e) {
            ...
            return this.each(function () {
                var e, t, r, i = this.grid, a = this.p, o = a.colModel, l = o.length, n = !1;
                if (i) for (s || (s = a.sortname), "boolean" != typeof d && (d = !1), t = 0; t < l; t++) if ((e = o[t]).index === s || e.name === s) {
            ...
            return this.each(function () {
                var e = $(this), t = this.p, r = $.fn.jqGrid;
            ...
            return this.each(function () {
                ...
                if (!this.ftoolbar) {
                    var k, N = $.extend(!0, {
                        ...
                        }, jgrid.search, G.searching || {}, e || {}), w = G.colModel, E = function (e) {
                            return getGridRes.call(I, e)
                        }, A = E("errors.errcap"), T = E("edit.bClose"), M = E("edit.msg"),
                        B = getGuiStyles.call(_, "states.hover"), y = getGuiStyles.call(_, "states.select"),
                        P = getGuiStyles.call(_, "filterToolbar.dataField"), z = {}, L = function (e) {
                            var t = "gs_";
                            switch (N.idMode) {
                                case"compatibility":
                                    t += G.idPrefix;
                            ...
                            var t, r, i, a, o, l, n = G.postData[N.sFilter], s = {}, d = G.iColByName;
                            if (e) for (r = 0; r < w.length; r++) !1 !== (o = w[r]).search && (l = o.searchoptions || {}, s[o.name] = {
                            ...
                            for (r = 0; r < i.length; r++) for (a = i[r], o = w[d[a.field]], t = 0; t < w.length; t++) if (((o = w[t]).index || o.name) === a.field && !1 !== o.search) {
                            ...
                            var u = {}, p = 0, f = {};
                            $.each(w, function () {
                                var e, t, i = this, r = i.index || i.name, a = i.searchoptions || {},
                                ...
                                if (t = N.searchOperators ? o.parent().prev().children("a").data("soper") || N.defaultSearch : a.sopt ? a.sopt[0] : "select" === i.stype || "checkbox" === i.stype ? "eq" : N.defaultSearch, "custom" === i.stype && $.isFunction(a.custom_value) && 0 < o.length && "SPAN" === o[0].nodeName.toUpperCase()) e = a.custom_value.call(_, o.children(".customelement").first(), "get"); else if ("select" === i.stype) e = o.prop("multiple") ? null == (e = o.val()) || 0 === e.length ? "" : e.join(G.inFilterSeparator || ",") : o.val(); else if ("checkbox" === i.stype) {
                                    var s = m(a);
                                    switch (o.data("state")) {
                                        case-1:
                                            e = "";
                                ...
                                if (e || "nu" === t || "nn" === t || 0 <= $.inArray(t, G.customUnaryOperations)) u[r] = e, f[r] = t, p++; else if (u.hasOwnProperty(r) && delete u[r], !N.stringResult && !N.searchOperators && "local" !== G.datatype) try {
                            ...
                            if (N.stringResult || N.searchOperators || "local" === G.datatype) {
                                var r = '{"groupOp":"' + N.groupOp + '","rules":[', i = 0;
                                $.each(u, function (e, t) {
                            ...
                            G.searchurl && (e = G.url, I.jqGrid("setGridParam", {url: G.searchurl}));
                            var a = "stop" === I.triggerHandler("jqGridToolbarBeforeSearch");
                            !a && $.isFunction(N.beforeSearch) && (a = N.beforeSearch.call(_)), a || I.jqGrid("setGridParam", {search: t}).trigger("reloadGrid", [$.extend({page: 1}, N.reloadGridSearchOptions || {})]), e && I.jqGrid("setGridParam", {url: e}), I.triggerHandler("jqGridToolbarAfterSearch"), $.isFunction(N.afterSearch) && N.afterSearch.call(_)
                        }, W = E("search.odata") || [], U = G.customSortOperations, Y = [],
                        X = $("<tr></tr>", {class: "ui-search-toolbar", role: "row form"});
                    N.loadFilterDefaults && (z = c() || {}), $.each(w, function (e) {
                        var c, t, r, i, a, o, l, n = this, u = "filter", s = n.searchoptions || {},
                            d = n.editoptions || {}, p = $("<th></th>", {
                            ...
                            h = $("<table class='ui-search-table'><tbody><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td><td class='ui-search-clear' style='width:1px'></td></tr></tbody></table>"),
                            g = h.children("tbody").children("tr").children("td"), m = g.eq(0), v = g.eq(1),
                            b = g.eq(2);
                        if (!0 === this.hidden && p.css("display", "none"), this.search = !1 !== this.search, void 0 === this.stype && (this.stype = "text"), c = $.extend({
                            ...
                            if (N.searchOperators) {
                                for (i = G.search && null != z[this.name] ? z[this.name].op : c.sopt ? c.sopt[0] : "select" === n.stype || "checkbox" === n.stype ? "eq" : N.defaultSearch, a = 0; a < W.length; a++) if (W[a].oper === i) {
                                    r = N.operands[i] || "";
                                    break
                                }
                                var w;
                                if (void 0 === r && null != U) for (w in U) if (U.hasOwnProperty(w) && w === i) {
                                    r = U[w].operand;
                                    break
                                }
                                void 0 === r && (r = "="), m.append("<a title='" + (null != c.searchtitle ? c.searchtitle : E("search.operandTitle")) + "' data-soper='" + i + "' class='" + getGuiStyles.call(_, "searchToolbar.operButton", "soptclass") + "' data-colname='" + this.name + "'>" + r + "</a>")
                            }
                            if (m.data("colindex", e), null != c.sopt && 1 !== c.sopt.length || m.hide(), G.search && null != z[this.name] && (c.defaultValue = z[this.name].data), void 0 === c.clearSearch && (c.clearSearch = "text" === this.stype), c.clearSearch) {
                                ...
                                b.append("<a title='" + y + "' aria-label='" + y + "' class='" + getGuiStyles.call(_, "searchToolbar.clearButton", "clearsearchclass") + "'><span>" + N.resetIcon + "</span></a>")
                            } else b.hide();
                            switch (f.append(h), this.stype) {
                                case"checkbox":
                                    var x = void 0 !== c.defaultValue ? c.defaultValue : "-1";
                                    l = $("<input role='search' type='checkbox' class='" + P + "' name='" + (n.index || n.name) + "' id='" + L(n.name) + "' aria-labelledby='jqgh_" + G.id + "_" + n.name + "' data-state='" + x + "'/>"), "-1" === x ? l.prop("indeterminate", !0) : "1" === x && l.prop("checked", !0), l.click(function () {
                                        var e = $(this);
                                        switch (e.data("state")) {
                                            case-1:
                                                V(e, 1);
                                        ...
                                        !0 === N.autosearch && H()
                                    }), v.append(l), c.attr && l.attr(c.attr), Y.push({elem: l[0], options: c});
                                    break;
                                case"select":
                                    var j, C, D;
                                    if (t = this.surl || c.dataUrl) $.ajax($.extend({
                                        url: t,
                                        context: {$tdInput: v, options: c, cm: n, iCol: e},
                                        dataType: "html",
                                        success: function (e, t, r) {
                                            var i, a, o, l = this.cm, n = this.iCol, s = this.options,
                                                d = this.$tdInput;
                                    ...
                                    break;
                                case"text":
                                    if (l = $("<input role='search' type='text' class='" + P + "' name='" + (n.index || n.name) + "' id='" + L(n.name) + "' aria-labelledby='jqgh_" + G.id + "_" + n.name + "' value='" + (void 0 !== c.defaultValue ? c.defaultValue : "") + "'/>"), v.append(l), n.createColumnIndex && c.generateDatalist) {
                                        var q = "dl_" + L(n.name),
                                    ...
                                    break;
                                case"custom":
                                    v.append("<span style='width:100%;padding:0;box-sizing:border-box;' name='" + (n.index || n.name) + "' id='" + L(n.name) + "'/>");
                                    try {
                    ...
                    }), $(h.hDiv).find(">div>.ui-jqgrid-htable>thead").append(X), $.each(Y, function () {
                        ...
                        !function (i, e, t) {
                            ...
                            var r, a, o = 0, l = [], n = $(i).data("soper"), s = $(i).data("colname"),
                                d = $(".ui-jqgrid-view").css("font-size") || "11px",
                                c = "<ul id='sopt_menu' class='" + getGuiStyles.call(_, "searchToolbar.menu", "ui-search-menu") + "' role='menu' tabindex='0' style='z-index:9999;display:block;font-size:" + d + ";left:" + e + "px;top:" + t + "px;'>";
                            if (void 0 !== (o = G.iColByName[s])) {
                                var u, p, f, h, g, m = w[o], v = $.extend({}, m.searchoptions);
                                for (v.sopt || (v.sopt = [], v.sopt[0] = "select" === m.stype || "checkbox" === m.stype ? "eq" : N.defaultSearch), $.each(W, function () {
                                    l.push(this.oper)
                                }), null != U && $.each(U, function (e) {
                                    l.push(e)
                                }), o = 0; o < v.sopt.length; o++) f = v.sopt[o], -1 !== (a = $.inArray(f, l)) && (void 0 !== (u = W[a]) ? (h = N.operands[f], g = u.text) : null != U && (h = (p = U[f]).operand, g = p.text), r = n === f ? y : "", c += '<li class="' + getGuiStyles.call(_, "searchToolbar.menuItem", "ui-jqgrid-menu-item " + r) + '" role="presentation"><a class="' + getGuiStyles.call(_, "searchToolbar.menuItemButton", "g-menu-item") + '" tabindex="0" role="menuitem" value="' + b(f) + '" data-oper="' + b(h) + '"><table><tr><td style="width:25px">' + b(h) + "</td><td>" + b(g) + "</td></tr></table></a></li>");
                                c += "</ul>", $("body").append(c), $("#sopt_menu > li > a").hover(function () {
                                    $(this).addClass(B)
                                }, function () {
                                    $(this).removeClass(B)
                                }).click(function () {
                                    var e = $(this).attr("value"), t = $(this).data("oper");
                        ...
                        var e, t, r = $(this).closest(".ui-search-clear"), i = r.siblings(".ui-search-oper"),
                            a = i.children("a"), o = a.data("soper"), l = parseInt(i.data("colindex"), 10),
                            n = r.siblings(".ui-search-input"), s = w[l], d = $.extend({}, s.searchoptions || {}),
                            c = d.defaultValue || "";
                        switch (s.stype) {
                            case"select":
                        ...
                        e = "boolean" != typeof e || e, $.each(w, function () {
                            ...
                            switch (void 0 !== a.defaultValue && (t = a.defaultValue), o = e.index || e.name, e.stype) {
                                ...
                                case"select":
                                    ...
                                    }), void 0 !== t) l[o] = t, n++; else try {
                                        delete G.postData[o]
                                    } catch (e) {
                                    }
                                    break;
                                case"text":
                                    if (i.val(t || ""), void 0 !== t) l[o] = t, n++; else try {
                                        delete G.postData[o]
                                    } catch (e) {
                                    }
                                    break;
                        ...
                        if (G.resetsearch = !0, N.stringResult || N.searchOperators || "local" === G.datatype) {
                            var i = '{"groupOp":"' + N.groupOp + '","rules":[', a = 0;
                            $.each(l, function (e, t) {
                        ...
                        G.searchurl && (t = G.url, I.jqGrid("setGridParam", {url: G.searchurl}));
                        var s = "stop" === I.triggerHandler("jqGridToolbarBeforeClear");
                        !s && $.isFunction(N.beforeClear) && (s = N.beforeClear.call(_)), s || e && I.jqGrid("setGridParam", {search: r}).trigger("reloadGrid", [$.extend({page: 1}, N.reloadGridResetOptions || {})]), t && I.jqGrid("setGridParam", {url: t}), I.triggerHandler("jqGridToolbarAfterClear"), $.isFunction(N.afterClear) && N.afterClear.call(_)
                        ...
                        if (N.stringResult || N.searchOperators || "local" === G.datatype || !G.search) {
                            for (e in n) if (n.hasOwnProperty(e) && (t = n[e], o = (r = $(g(e))).closest("th.ui-th-column"), 0 < r.length && 0 < o.length)) {
                                if (l = (G.colModel[o[0].cellIndex] || {}).searchoptions || {}, "SELECT" === r[0].tagName.toUpperCase() && r[0].multiple) r.val(t.data.split(G.inFilterSeparator || ",")); else if (r.is("input[type=checkbox]")) {
                                    var s = m(l);
            ...
            return void 0 === c && (c = !0), this.each(function () {
                var e, t, r, i, a, o = this.grid, l = this.p.colModel, n = $("table.ui-jqgrid-htable thead", o.hDiv);
                if (o) {
                    $(this).off(".setGroupHeaders");
                    var s = $("<tr>", {role: "row"}).addClass("ui-jqgrid-labels"), d = o.headers;
                    for (e = 0, t = d.length; e < t; e++) {
                        ...
                        s.append(r), 0 < (i = r.children("span.ui-jqgrid-resize")).length && (i[0].style.height = ""), r.children("div")[0].style.top = ""
                    }
                    $(n).children("tr.ui-jqgrid-labels").remove(), $(n).prepend(s), !0 === c && $(this).jqGrid("setGridParam", {groupHeader: null})
                }
            })
            ...
            return F = $.extend({
                ...
                var e, t, r, i, a, o, l, n, s, d, c, u, p, f, h = this, g = 0, m = h.p, v = m.colModel, b = v.length,
                    w = h.grid.headers, y = $("table.ui-jqgrid-htable", h.grid.hDiv), x = jgrid.isCellClassHidden,
                    j = y.children("thead").children("tr.ui-jqgrid-labels"),
                    C = j.last().addClass("jqg-second-row-header"), D = y.children("thead"),
                ...
                for ($(h).prepend(D), r = $("<tr>", {role: "row"}).addClass("ui-jqgrid-labels jqg-third-row-header"), e = 0; e < b; e++) if (a = w[e].el, o = $(a), t = v[e], l = {
                    height: "0",
                    width: w[e].width + "px",
                    display: t.hidden ? "none" : ""
                }, $("<th>", {role: "gridcell"}).css(l).addClass("ui-first-th-" + m.direction + (F.applyLabelClasses ? " " + (t.labelClasses || "") : "")).appendTo(S), a.style.width = "", f = getGuiStyles.call(h, "colHeaders", "ui-th-column-header ui-th-" + m.direction + " " + (F.applyLabelClasses && t.labelClasses || "")), s = q(t.name, F.groupHeaders)) {
                    for (d = s.numberOfColumns, c = s.titleText, n = u = 0; n < d && e + n < b; n++) v[e + n].hidden || x(v[e + n].classes) || u++;
                    i = $("<th>").addClass(f).html(c || "&nbsp;"), 0 < u && i.attr("colspan", String(u)), m.headertitles && i.attr("title", i.text()), 0 === u && i.hide(), o.before(i), r.append(a), g = d - 1
                } else 0 === g ? F.useColSpanStyle ? o.attr("rowspan", j.length + 1) : ($("<th>").addClass(f).css({
                    display: t.hidden ? "none" : "",
                    "border-top": "0 none"
            ...
            return R = R || {}, this.each(function () {
                var r = this, a = $(r), v = r.p, o = r.grid;
                if (o && null != v && !0 !== v.frozenColumns) {
                    var b, e, t = v.colModel, i = t.length, l = -1, n = !1, s = [], d = jqID(v.id),
                    ...
                    if (!0 !== v.subGrid && !0 !== v.treeGrid && !v.scroll) {
                        ...
                        if (v.sortable) {
                            e = $(o.hDiv).find(".ui-jqgrid-htable .ui-jqgrid-labels");
                            try {
                                e.sortable("destroy")
                            } catch (e) {
                            }
                            a.jqGrid("setGridParam", {sortable: {options: {items: 0 < s.length ? ">th:not(:has(" + s.join(",") + "),:hidden)" : ">th:not(:hidden)"}}}), a.jqGrid("sortableColumns", e)
                        }
                        if (0 <= l && n) {
                            var u = v.caption ? $(o.cDiv).outerHeight() : 0,
                                p = $(".ui-jqgrid-htable", v.gView).height();
                            v.toppager && (u += $(o.topDiv).outerHeight()), !0 === v.toolbar[0] && "bottom" !== v.toolbar[1] && (u += $(o.uDiv).outerHeight()), o.fhDiv = $("<div style='position:absolute;overflow:hidden;" + ("rtl" === v.direction ? "right:0;border-top-left-radius:0;" : "left:0;border-top-right-radius:0;") + "top:" + u + "px;height:" + p + "px;' class='" + getGuiStyles.call(r, "hDiv", "frozen-div ui-jqgrid-hdiv") + "'></div>"), o.fbDiv = $("<div style='position:absolute;overflow:hidden;" + ("rtl" === v.direction ? "right:0;" : "left:0;") + "top:" + (parseInt(u, 10) + parseInt(p, 10) + 1) + "px;overflow:hidden;' class='frozen-bdiv ui-jqgrid-bdiv'></div>"), $(v.gView).append(o.fhDiv);
                            var f = $(".ui-jqgrid-htable", v.gView).clone(!0), h = f[0].tHead.rows;
                            if (v.groupHeader) {
                            ...
                            if ($(f).width(1), $(o.fhDiv).append(f).scroll(function () {
                                ...
                                var y = $(".ui-jqgrid-bdiv", v.gView).height();
                                o.fsDiv = $("<div style='position:absolute;" + ("rtl" === v.direction ? "right:0;" : "left:0;") + "top:" + (parseInt(u, 10) + parseInt(p, 10) + parseInt(y, 10) + 1) + "px;' class='frozen-sdiv ui-jqgrid-sdiv'></div>"), $(v.gView).append(o.fsDiv);
                                var x = $(".ui-jqgrid-ftable", v.gView).clone(!0);
                                $("tr", x).each(function () {
                                    $("td:gt(" + l + ")", this).remove()
                            ...
                            var j = function (e, t) {
                                    ...
                                    if (null != e && 0 < e.length) {
                                        if (e[0].scrollTop = t.scrollTop, e.css("rtl" === v.direction ? {
                                            ...
                                            top: m,
                                            left: 0
                                        }), l = e.children("table").children("thead").children("tr"), 0 === (n = $(t).children("div").children("table").children("thead").children("tr")).length && 0 < e.children("table").length && (l = $(e.children("table")[0].rows), n = $($(t).children("div").children("table")[0].rows)), f = 0 < (o = Math.min(l.length, n.length)) ? $(l[0]).position().top : 0, h = 0 < o ? $(n[0]).position().top : 0, 0 <= r) for (0 <= i && (o = Math.min(i + 1, o)), a = r; a < o; a++) if ("none" !== (s = $(n[a])).css("display") && s.is(":visible")) {
                                            if (m = s.position().top, c = (d = $(l[a])).position().top, u = s.height(), null != v.groupHeader && v.groupHeader.useColSpanStyle) for (g = s[0].cells, b = 0; b < g.length; b++) null != (p = g[b]) && "TH" === p.nodeName.toUpperCase() && (u = Math.max(u, $(p).height()));
                                            j(d, u + (m - h) + (f - c))
                                        }
                                        j(e, t.clientHeight)
                                    }
                                }, S = {resizeDiv: !0, resizedRows: {iRowStart: 0, iRowEnd: -1}},
                                q = {header: S, resizeFooter: !0, body: S};
                            a.on("jqGridAfterGridComplete.setFrozenColumns", function () {
                                $(v.idSel + "_frozen").remove(), $(o.fbDiv).height(o.hDiv.clientHeight);
                                var e = $(this).clone(!0), t = e[0].rows, r = a[0].rows;
                            ...
                            $(v.gBox).on("resizestop.setFrozenColumns", function () {
                                ...
                                F({
                                    ...
                                    resizeFooter: !0,
                                    body: {resizeDiv: !0, resizedRows: {iRowStart: r, iRowEnd: r}}
                                })
            ...
            return this.each(function () {
                var e = $(this), t = this.grid, r = this.p, i = jqID(r.id);
                if (t && !0 === r.frozenColumns) {
                    ...
                    if (r.frozenColumns = !1, r.sortable) {
                        var l = $(t.hDiv).find(".ui-jqgrid-htable .ui-jqgrid-labels");
                        l.sortable("destroy"), e.jqGrid("setGridParam", {sortable: {options: {items: ">th:not(:has(#jqgh_" + i + "_cb,#jqgh_" + i + "_rn,#jqgh_" + i + "_subgrid),:hidden)"}}}), e.jqGrid("sortableColumns", l)
                    }
                }
            })
        }
        ...
        return this.each(function () {
            if (!this.filter) {
                ...
                var e, t, r = E.columns.length, _ = /msie/i.test(navigator.userAgent) && !window.opera,
                    I = $.isFunction,
                    ...
                    }, b = O("states.error"), a = O("dialog.content");
                if (E.initFilter = $.extend(!0, {}, E.filter), r) {
                    ...
                    E.showQuery && $(this).append("<table class='queryresult " + a + "' style='display:block;max-width:440px;border:0px none;' dir='" + E.direction + "'><tbody><tr><td class='query'></td></tr></tbody></table>");
                    var n = function (e, t) {
                        var r = [!0, ""], i = G();
                        if (I(t.searchrules)) r = t.searchrules.call(i, e, t); else if (jgrid && jgrid.checkValues) try {
                    ...
                    this.onchange = function () {
                        ...
                        var a, o = this,
                            t = $("<table class='" + O("searchDialog.operationGroup", "group") + "' style='border:0px none;'><tbody></tbody></table>"),
                            r = "left";
                        "rtl" === E.direction && (r = "right", t.attr("dir", "rtl")), null === e && t.append("<tr class='error' style='display:none;'><th colspan='5' class='" + b + "' align='" + r + "'></th></tr>");
                        var l = $("<tr></tr>");
                        t.append(l);
                        var n = $("<th colspan='5' align='" + r + "'></th>");
                        if (l.append(n), !0 === E.ruleButtons) {
                            var s = $("<select class='" + O("searchDialog.operationSelect", "opsel") + "'></select>");
                            n.append(s);
                            var d, c = "";
                            for (a = 0; a < E.groupOps.length; a++) d = i.groupOp === o.p.groupOps[a].op ? " selected='selected'" : "", c += "<option value='" + o.p.groupOps[a].op + "'" + d + ">" + o.p.groupOps[a].text + "</option>";
                            s.append(c).on("change", function () {
                                i.groupOp = $(s).val(), o.onchange()
                            })
                        }
                        var u, p, f, h = "<span></span>";
                        if (E.groupButton && (h = $("<input type='button' value='+ {}' title='" + k("addGroupTitle") + "' class='" + O("searchDialog.addGroupButton", "add-group") + "'/>")).on("click", function () {
                            ...
                            var g,
                                m = $("<input type='button' value='+' title='" + k("addRuleTitle") + "' class='" + O("searchDialog.addRuleButton", "add-rule ui-add") + "'/>");
                            m.on("click", function () {
                                var e, t, r;
                                for (void 0 === i.rules && (i.rules = []), a = 0; a < o.p.columns.length; a++) if (e = void 0 === o.p.columns[a].search || o.p.columns[a].search, t = !0 === o.p.columns[a].hidden, !0 === o.p.columns[a].searchoptions.searchhidden && e || e && !t) {
                                    g = o.p.columns[a];
                                    break
                                }
                        ...
                        if (null !== e) {
                            var v = $("<input type='button' value='-' title='" + k("deleteGroupTitle") + "' class='" + O("searchDialog.deleteGroupButton", "delete-group") + "'/>");
                            n.append(v), v.on("click", function () {
                                for (a = 0; a < e.groups.length; a++) if (e.groups[a] === i) {
                                    e.groups.splice(a, 1);
                                    break
                                }
                        ...
                        if (void 0 !== i.groups) for (a = 0; a < i.groups.length; a++) u = $("<tr></tr>"), t.append(u), p = $("<td class='first'></td>"), u.append(p), (f = $("<td colspan='4'></td>")).append(this.createTableForGroup(i.groups[a], i)), u.append(f);
                        if (void 0 === i.groupOp && (i.groupOp = o.p.groupOps[0].op), void 0 !== i.rules) for (a = 0; a < i.rules.length; a++) t.append(this.createTableRowForRule(i.rules[a], i));
                        return t
                    }, this.createTableRowForRule = function (h, e) {
                        var t, g, r, i, m = this, v = G(), a = $("<tr></tr>"), o = "";
                        a.append("<td class='first'></td>");
                        var l = $("<td class='columns'></td>");
                        a.append(l);
                        var b, w = $("<select class='" + O("searchDialog.label", "selectLabel") + "'></select>"),
                            y = [];
                        l.append(w), w.on("change", function () {
                            h.field = $(w).val();
                            var e, t, r = $(this).parents("tr:first");
                            for (t = 0; t < m.p.columns.length; t++) if (m.p.columns[t].name === h.field) {
                                e = m.p.columns[t];
                                break
                            }
                            if (e) {
                                ...
                                for (y = [], $.each(m.p.ops, function () {
                                    ...
                                    y.push(e)
                                }), t = 0; t < g.length; t++) n = g[t], -1 !== (b = $.inArray(g[t], y)) && (s = void 0 !== (l = m.p.ops[b]) ? l.text : m.p.cops[n].text, 0 === c && (h.op = n), d += "<option value='" + n + "'>" + s + "</option>", c++);
                        ...
                        var n, s, d = 0;
                        for (t = 0; t < m.p.columns.length; t++) n = void 0 === m.p.columns[t].search || m.p.columns[t].search, s = !0 === m.p.columns[t].hidden, (!0 === m.p.columns[t].searchoptions.searchhidden && n || n && !s) && (i = "", h.field === m.p.columns[t].name && (i = " selected='selected'", d = t), o += "<option value='" + m.p.columns[t].name + "'" + i + ">" + m.p.columns[t].label + "</option>");
                        w.append(o);
                        var c = $("<td class='operators'></td>");
                        ...
                        var x, j, C = $("<select class='" + O("searchDialog.operator", "selectopts") + "'></select>");
                        for (c.append(C), C.on("change", function () {
                            h.op = $(C).val();
                            var e = $(this).parents("tr:first"), t = $(".input-elm", e)[0];
                            ...
                            y.push(e)
                        }), t = 0; t < g.length; t++) j = g[t], -1 !== (b = $.inArray(g[t], y)) && (x = m.p.ops[b], o += "<option value='" + j + "'" + (i = h.op === j ? " selected='selected'" : "") + ">" + (void 0 !== x ? x.text : m.p.cops[j].text) + "</option>");
                        C.append(o);
                        var D = $("<td class='data'></td>");
                        if (a.append(D), D.append(f), r.createColumnIndex && r.searchoptions.generateDatalist) {
                            var S = "dl_" + f.id, q = $(v).jqGrid("generateDatalistFromColumnIndex", r.name);
                        ...
                        if (a.append(F), !0 === E.ruleButtons) {
                            var R = $("<input type='button' value='-' title='" + k("deleteRuleTitle") + "' class='" + O("searchDialog.deleteRuleButton", "delete-rule ui-del") + "'/>");
                            F.append(R), R.on("click", function () {
                                for (t = 0; t < e.rules.length; t++) if (e.rules[t] === h) {
                                    e.rules.splice(t, 1);
                                    break
                                }
                        ...
                        var t, r, i, a = "", o = "", l = e.data;
                        for (t = 0; t < E.ops.length; t++) if (E.ops[t].oper === e.op) {
                            a = E.operands.hasOwnProperty(e.op) ? E.operands[e.op] : "", o = E.ops[t].oper;
                            break
                        }
                        if ("" === o && null != E.cops) for (i in E.cops) if (E.cops.hasOwnProperty(i) && (o = i, a = E.cops[i].operand, I(E.cops[i].buildQueryValue))) return E.cops[i].buildQueryValue.call(E, {
                            cmName: e.field,
                            searchValue: l,
                            operand: a
                        });
                        for (t = 0; t < E.columns.length; t++) if (E.columns[t].name === e.field) {
                            r = E.columns[t];
                            break
                        }
                        ...
                        function a(e) {
                            if (i.p.errorcheck) {
                                var t, r;
                                for (t = 0; t < i.p.columns.length; t++) if (i.p.columns[t].name === e.field) {
                                    r = i.p.columns[t];
                                    break
                                }
                                r && n(e.data, r)
                        ...
                        return function e(t) {
                            var r, i = "(";
                            if (void 0 !== t.groups) for (r = 0; r < t.groups.length; r++) 1 < i.length && ("OR" === t.groupOp ? i += " || " : i += " && "), i += e(t.groups[r]);
                            if (void 0 !== t.rules) for (r = 0; r < t.rules.length; r++) 1 < i.length && ("OR" === t.groupOp ? i += " || " : i += " && "), i += a(t.rules[r]);
                            return "()" == (i += ")") ? "" : i
                        }(E.filter)
    ...
    var xmlJsonClass = {
        xml2json: function (e, t) {
            ...
            var r, s = function (e, t, r) {
                var i, a, o, l, n = "";
                if (e instanceof Array) if (0 === e.length) n += r + "<" + t + ">__EMPTY_ARRAY_</" + t + ">\n"; else for (i = 0, a = e.length; i < a; i += 1) n += r + s(e[i], t, r + "\t") + "\n"; else if ("object" == typeof e) {
                    for (l in o = !1, n += r + "<" + t, e) e.hasOwnProperty(l) && ("@" === l.charAt(0) ? n += " " + l.substr(1) + '="' + e[l].toString() + '"' : o = !0);
                    if (n += o ? ">" : "/>", o) {
                        for (l in e) e.hasOwnProperty(l) && ("#text" === l ? n += e[l] : "#cdata" === l ? n += "<![CDATA[" + e[l] + "]]>" : "@" !== l.charAt(0) && (n += s(e[l], l, r + "\t")));
                        n += ("\n" === n.charAt(n.length - 1) ? r : "") + "</" + t + ">"
                    }
                } else "function" == typeof e ? n += r + "<" + t + "><![CDATA[" + e + "]]></" + t + ">" : (void 0 === e && (e = ""), '""' === e.toString() || 0 === e.toString().length ? n += r + "<" + t + ">__EMPTY_STRING_</" + t + ">" : n += r + "<" + t + ">" + e.toString() + "</" + t + ">");
                return n
            }, i = "";
            ...
            if (1 === e.nodeType) {
                ...
                if (e.firstChild) {
                    ...
                    if (n) if (o < 2 && l < 2) for (this.removeWhite(e), r = e.firstChild; r; r = r.nextSibling) 3 === r.nodeType ? i["#text"] = this.escape(r.nodeValue) : 4 === r.nodeType ? a.test(r.nodeValue) ? i[r.nodeName] = [i[r.nodeName], r.nodeValue] : i["#cdata"] = this.escape(r.nodeValue) : i[r.nodeName] ? i[r.nodeName] instanceof Array ? i[r.nodeName][i[r.nodeName].length] = this.toObj(r) : i[r.nodeName] = [i[r.nodeName], this.toObj(r)] : i[r.nodeName] = this.toObj(r); else e.attributes.length ? i["#text"] = this.escape(this.innerXml(e)) : i = this.escape(this.innerXml(e)); else if (o) e.attributes.length ? i["#text"] = this.escape(this.innerXml(e)) : "__EMPTY_ARRAY_" === (i = this.escape(this.innerXml(e))) ? i = "[]" : "__EMPTY_STRING_" === i && (i = ""); else if (l) if (1 < l) i = this.escape(this.innerXml(e)); else for (r = e.firstChild; r; r = r.nextSibling) {
            ...
            void 0 === i && (i = !0);
            var a, o, l, n = t ? '"' + t + '"' : "", s = "\t", d = "\n", c = [], u = [];
            if (i || (d = s = ""), "[]" === e) n += t ? ":[]" : "[]"; else if (e instanceof Array) {
            ...
            if (e.hasOwnProperty("innerHTML")) r = e.innerHTML; else for (t = e.firstChild; t; t = t.nextSibling) r += a(t);
            return r
        }, escape: function (e) {
    ...
    jgrid.extend({
        searchGrid: function (F) {
            return this.each(function () {
                ...
                if (o.grid && null != n) {
                    var s = $.extend(!0, {
                        ...
                        d = "fbox_" + n.id, e = s.commonIconClass, r = {
                            themodal: "searchmod" + d,
                            modalhead: "searchhd" + d,
                            modalcontent: "searchcnt" + d,
                            resizeAlso: d
                        }, t = "#" + jqID(r.themodal), i = n.gBox, a = n.gView, c = $.each, u = n.postData[s.sFilter],
                        p = function () {
                            var e = $.makeArray(arguments);
                            return e.unshift("Search"), e.unshift("Filter"), e.unshift(s), jgridFeedback.apply(o, e)
                        }, f = function () {
                            jgrid.hideModal(t, {gb: i, jqm: s.jqModal, onClose: s.onClose, removemodal: s.removemodal})
                        };
                    if ("string" == typeof u && (u = "" !== $.trim(u) ? $.parseJSON(u) : void 0), $(t).remove(), void 0 !== $(t)[0]) q($("#fbox_" + jqID(n.id))); else {
                        var h = $("<div><div id='" + d + "' class='" + getGuiStyles.call(o, "dialog.body", "searchFilter") + "' style='overflow:auto'></div></div>").insertBefore(a);
                        "rtl" === n.direction && h.attr("dir", "rtl");
                        var g, m, v = "", b = "", w = !1, y = -1, x = $.extend([], n.colModel),
                        ...
                        if (s.showQuery && (v = builderFmButon.call(o, d + "_query", "Query", mergeCssClasses(e, s.queryDialogIcon), "left") + "&#160;"), s.searchForAdditionalProperties && c(n.additionalProperties, function () {
                            ...
                            0 <= y && x[y].searchoptions && x[y].searchoptions.sopt ? D = x[y].searchoptions.sopt[0] : s.sopt && s.sopt.length && (D = s.sopt[0]), u = {
                                groupOp: "AND",
                                rules: [{field: g, op: D, data: ""}]
                            }
                        }
                        w = !1, s.tmplNames && s.tmplNames.length && (w = !0, b = s.tmplLabel, b += "<select class='ui-template'>", b += "<option value='default'>Default</option>", c(s.tmplNames, function (e, t) {
                            b += "<option value='" + e + "'>" + t + "</option>"
                        }), b += "</select>"), m = "<div class='" + getGuiStyles.call(o, "dialog.footer") + "'><table class='EditTable' style='border:0px none;margin-top:5px' id='" + d + "_2'><tbody><tr><td colspan='2'><hr class='" + getGuiStyles.call(o, "dialog.hr") + "' style='margin:1px'/></td></tr><tr><td class='EditButton EditButton-" + n.direction + "'  style='float:" + ("rtl" === n.direction ? "right" : "left") + ";'>" + C + b + "</td><td class='EditButton EditButton-" + n.direction + "'>" + v + j + "</td></tr></tbody></table></div>", d = jqID(d), s.gbox = i, s.height = "auto", $(d = "#" + d).jqFilter({
                            columns: x,
                        ...
                        }), !0 === s.multipleGroup && (s.multipleSearch = !0), p("onInitialize", $(d)), s.layer ? jgrid.createModal.call(o, r, h, s, a, $(i)[0], "#" + jqID(s.layer), {position: "relative"}) : jgrid.createModal.call(o, r, h, s, a, $(i)[0]), (s.searchOnEnter || s.closeOnEscape) && $(t).keydown(function (e) {
                            var t = $(e.target);
                            ...
                            var e, t = {}, r = "", i = $(d), a = i.find(".input-elm");
                            ...
                            return $.extend(n.postData, t), fullBoolFeedback.call(o, s.onSearch, "jqGridFilterSearch", n.filters) && (n.search = !0, l.trigger("reloadGrid", [$.extend({page: 1}, s.reloadGridSearchOptions || {})])), s.closeAfterSearch && f(), !1
                        }), $(d + "_reset").on("click", function () {
                            var e = {}, t = $(d);
                            return n.search = !1, !(n.resetsearch = !0) === s.multipleSearch ? e[s.sField] = e[s.sValue] = e[s.sOper] = "" : e[s.sFilter] = "", t[0].resetFilter(), w && $(".ui-template", h).val("default"), $.extend(n.postData, e), fullBoolFeedback.call(o, s.onReset, "jqGridFilterReset") && l.trigger("reloadGrid", [$.extend({page: 1}, s.reloadGridResetOptions || {})]), s.closeAfterReset && f(), !1
                        }), q($(d));
            ...
            return this.each(function () {
                var R = this, _ = $(R), I = R.p;
                if (R.grid && null != I && ie) {
                    var w, y, G = I.id, d = base.getGridRes, x = base.setSelection, O = $.extend(!0, {
                            top: 0,
                            left: 0,
                            width: 300,
                            datawidth: "auto",
                        ...
                        }, d.call(_, "edit"), jgrid.edit, I.formEditing || {}, ae || {}), k = "FrmGrid_" + G, e = k,
                        t = "TblGrid_" + G, j = "#" + jqID(t), C = j + "_2", r = {
                            themodal: "editmod" + G,
                            modalhead: "edithd" + G,
                            modalcontent: "editcnt" + G,
                            resizeAlso: k
                        }, i = "#" + jqID(r.themodal), a = I.gBox, N = I.colModel, c = I.iColByName, o = 1, l = 0,
                        n = O.commonIconClass, D = function () {
                            jgrid.hideModal(i, {gb: a, jqm: O.jqModal, onClose: O.onClose, removemodal: O.removemodal})
                        }, u = d.call(_, "errors.errcap"), s = function () {
                            var e = $.makeArray(arguments);
                            return e.unshift(""), e.unshift("AddEdit"), e.unshift(O), jgridFeedback.apply(R, e)
                        }, p = getGuiStateStyles.call(R, "hover"), E = getGuiStateStyles.call(R, "disabled"),
                        f = getGuiStateStyles.call(R, "select"), S = getGuiStateStyles.call(R, "active"),
                    ...
                    var m = isNaN(O.dataheight) ? O.dataheight : O.dataheight + "px",
                        ...
                        b = $("<form name='FormPost' id='" + e + "' class='FormGrid' onSubmit='return false;' style='width:" + v + ";overflow:auto;position:relative;height:" + m + ";'></form>").data("disabled", !1),
                        q = $("<table id='" + t + "' class='EditTable'><tbody></tbody></table>");
                    $(N).each(function () {
                        var e = this.formoptions;
                        o = Math.max(o, e && e.colpos || 0), l = Math.max(l, e && e.rowpos || 0)
                    }), $(b).append(q);
                    var F = $("<tr id='FormError' style='display:none'><td class='" + h + "' colspan='" + 2 * o + "'>&#160;</td></tr>");
                    if (F[0].rp = 0, $(q).append(F), (F = $("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='" + 2 * o + "'>" + (O.topinfo || "&#160;") + "</td></tr>"))[0].rp = 0, $(q).append(F), s("beforeInitData", b, y)) {
                        !function () {
                            var e = jgrid.detectRowEditing.call(R, ie);
                            if (null != e) if ("inlineEditing" === e.mode) base.restoreRow.call(_, ie); else {
                                var t = e.savedRow, r = R.rows[t.id];
                        ...
                        var A = "rtl" === I.direction, T = A ? "nData" : "pData", M = A ? "pData" : "nData";
                        !function (x, e, j) {
                            var t, C = 0, D = [], S = !1, q = $(e),
                                r = String(O.labelswidth) + (!O.labelswidth || isNaN(O.labelswidth) ? "" : "px"),
                                i = "<td class='CaptionTD" + (r ? "' style='width:" + r + ";" : "") + "'>&#160;</td><td class='DataTD'>&#160;</td>",
                                F = "";
                            for (t = 1; t <= j; t++) F += i;
                            if ("_empty" !== x && (S = base.getInd.call(_, x)), $(N).each(function (e) {
                                var t, r, i, a, o, l = this, n = l.name, s = l.editable, d = !1, c = !1,
                                ...
                                if ("cb" !== n && "subgrid" !== n && !0 === s && "rn" !== n) {
                                    if (!1 === S) a = ""; else {
                                        t = $(R.rows[S].cells[e]);
                                        try {
                                            a = $.unformat.call(R, t, {rowId: x, colModel: l}, e)
                                        } catch (e) {
                                    ...
                                    var p = $.extend({}, l.editoptions || {}, {
                                            ...
                                            rowabove: !1,
                                            rowcontent: ""
                                        }, l.formoptions || {}), h = parseInt(f.rowpos, 10) || C + 1,
                                    ...
                                    if ("_empty" === x && p.defaultValue && (a = $.isFunction(p.defaultValue) ? p.defaultValue.call(R) : p.defaultValue), l.edittype || (l.edittype = "text"), I.autoEncodeOnEdit && (a = jgrid.oldDecodePostedData(a)), o = jgrid.createEl.call(R, l.edittype, p, a, !1, $.extend({}, jgrid.ajaxOptions, I.ajaxSelectOptions || {})), (O.checkOnSubmit || O.checkOnUpdate) && (O._savedData[n] = a), $(o).addClass("FormElement"), -1 < $.inArray(l.edittype, ["text", "textarea", "checkbox", "password", "select"]) && $(o).addClass(getGuiStyles.call(R, "dialog.dataField")), i = q.find("tr[data-rowpos=" + h + "]"), f.rowabove) {
                                        var m = $("<tr><td class='contentinfo' colspan='" + 2 * j + "'>" + f.rowcontent + "</td></tr>");
                                        q.append(m), m[0].rp = h
                                    }
                                    0 === i.length && (i = $("<tr data-rowpos='" + h + "'></tr>").addClass("FormData").attr("id", "tr_" + n), $(i).append(F), q.append(i), i[0].rp = h);
                                    var v = $("td:eq(" + (g - 2) + ")", i[0]), b = $("td:eq(" + (g - 1) + ")", i[0]);
                                ...
                                var a = $("<tr class='FormData' style='display:none'><td class='CaptionTD'>&#160;</td><td colspan='" + (2 * j - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" + G + "_id' value='" + x + "'/></td></tr>");
                        ...
                        var B = builderFmButon.call(R, T, "", mergeCssClasses(n, O.prevIcon), "", "left"),
                            ...
                            V = "<div class='" + getGuiStyles.call(R, "dialog.footer") + "'><table class='EditTable' id='" + t + "_2'><tbody><tr><td colspan='2'><hr class='" + getGuiStyles.call(R, "dialog.hr") + "' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton navButton-" + I.direction + "'>" + (A ? P + B : B + P) + "</td><td class='EditButton EditButton-" + I.direction + "'>" + z + "&#160;" + L + "</td></tr>";
                        if (V += "<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>" + (O.bottominfo || "&#160;") + "</td></tr>", V += "</tbody></table></div>", 0 < l) {
                            var H = [];
                        ...
                        var U = $("<div></div>").append($("<div class='" + getGuiStyles.call(R, "dialog.body") + "'></div>").append(b)).append(V);
                        if (jgrid.createModal.call(R, r, U, O, I.gView, $(a)[0]), O.topinfo && $(".tinfo", j).show(), O.bottominfo && $(".binfo", C).show(), V = U = null, $(i).keydown(function (e) {
                            ...
                            var Y = O.zIndex || 999;
                            Y++, $("<div class='" + O.overlayClass + " jqgrid-overlay confirm' style='z-index:" + Y + ";display:none;'>&#160;</div><div class='" + getGuiStyles.call(R, "dialog.content", "confirm ui-jqconfirm") + "' style='z-index:" + (Y + 1) + "'>" + O.saveData + "<br/><br/>" + z + P + L + "</div>").insertAfter(k), $("#sNew", i).click(function () {
                ...
                function Q() {
                    return $(j + " > tbody > tr > td .FormElement").each(function () {
                        var e, t, r = $(".customelement", this), i = r.length ? r.attr("name") : this.name, a = c[i],
                            o = void 0 !== a && N[a] || {}, l = o.editoptions || {};
                ...
                function J(e, t) {
                    ...
                    d && ($(d.cells).filter("td[role=gridcell]").each(function (a) {
                        ...
                        if ("cb" !== (r = s[a].name) && "subgrid" !== r && "rn" !== r && !0 === s[a].editable) {
                            try {
                                i = $.unformat.call(R, $(this), {rowId: e, colModel: s[a]}, a)
                            } catch (e) {
                ...
                function Z() {
                    var o, l, e, n, t, r, i, a, s, d = [!0, "", ""], c = d, u = {}, p = I.prmNames,
                        f = base.getInd.call(_, ie), h = !1 === f ? null : R.rows[f],
                        g = _.triggerHandler("jqGridAddEditBeforeCheckValues", [w, $(k), y]);
                    for (e in g && "object" == typeof g && (w = g), f = !1 === f ? -1 : f, $.isFunction(O.beforeCheckValues) && (g = O.beforeCheckValues.call(R, w, $(k), y)) && "object" == typeof g && (w = g), w) if (w.hasOwnProperty(e) && (a = I.iColByName[e], null != (c = jgrid.checkValues.call(R, w[e], e, void 0, void 0, {
                    ...
                    if (s = O.url || I.editurl, $.each(N, function (e, t) {
                        ...
                        if (O.processing = !0, $("#sData", C).addClass(S), r = O.url || I.editurl, l = p.oper, o = "clientArray" === r && !1 !== I.keyName ? I.keyName : p.id, w[l] = "_empty" === $.trim(w[G + "_id"]) ? p.addoper : p.editoper, w[l] !== p.addoper ? w[o] = w[G + "_id"] : void 0 === w[o] && (w[o] = w[G + "_id"]), delete w[G + "_id"], w = $.extend(w, O.editData, u), !0 === I.treeGrid) {
                            ...
                            for (t in I.treeReader) if (I.treeReader.hasOwnProperty(t) && (i = I.treeReader[t], w.hasOwnProperty(i))) {
                        ...
                        var v = $.extend({
                            ...
                            complete: function (e, t) {
                                if (_.jqGrid("progressBar", {
                                    ...
                                    if (O.checkOnSubmit || O.checkOnUpdate) if ($(k).data("disabled", !1), "_empty" !== O._savedData[G + "_id"]) for (r in O._savedData) O._savedData.hasOwnProperty(r) && w[r] && (O._savedData[r] = w[r])
                                }
                                O.processing = !1;
                                try {
                                    $(k).find("input,textarea,select,button,object,*[tabindex]").filter(":input:visible:not(:disabled)").first().focus()
                        ...
                        if (v.url || O.useDataProxy || ($.isFunction(I.dataProxy) ? O.useDataProxy = !0 : (c[0] = !1, c[1] += " " + jgrid.errors.nourl)), c[0]) if (_.jqGrid("progressBar", {
                            method: "show",
                            loadtype: O.saveui,
                ...
                function re() {
                    var e = base.getDataIDs.call(_), t = $("#id_g", j).val();
                    return [$.inArray(t, e), e]
                }
            })
        }, viewGridRow: function (B, P) {
            return this.each(function () {
                var D = this, S = $(D), q = D.p;
                if (D.grid && null != q && B) {
                    var e = q.id, F = $.extend(!0, {
                            top: 0,
                            left: 0,
                            width: 0,
                            datawidth: "auto",
                        ...
                        i = "#ViewGrid_" + jqID(e), o = "#ViewTbl_" + jqID(e), a = o + "_2", t = "ViewGrid_" + e,
                        r = "ViewTbl_" + e, l = F.commonIconClass, n = {
                            themodal: "viewmod" + e,
                            modalhead: "viewhd" + e,
                            modalcontent: "viewcnt" + e,
                            resizeAlso: t
                        }, s = "#" + jqID(n.themodal), d = q.gBox, R = q.colModel, c = 1, u = 0, p = function () {
                            var e = $.makeArray(arguments);
                            return e.unshift(""), e.unshift("View"), e.unshift(F), jgridFeedback.apply(D, e)
                        }, f = function () {
                            jgrid.hideModal(s, {gb: d, jqm: F.jqModal, onClose: F.onClose, removemodal: F.removemodal})
                        }, h = getGuiStateStyles.call(D, "hover"), g = getGuiStateStyles.call(D, "disabled"),
                        m = isNaN(F.dataheight) ? F.dataheight : F.dataheight + "px",
                        v = isNaN(F.datawidth) ? F.datawidth : F.datawidth + "px",
                        b = $("<div class='" + getGuiStyles.call(D, "dialog.body") + "'><form name='FormPost' id='" + t + "' class='FormGrid' style='width:" + v + ";overflow:auto;position:relative;height:" + m + ";'></form></div>"),
                        w = b.children("form.FormGrid"),
                        y = $("<table id='" + r + "' class='EditTable'><tbody></tbody></table>");
                    if ($(s).remove(), $(R).each(function () {
                        var e = this.formoptions;
                        c = Math.max(c, e && e.colpos || 0), u = Math.max(u, e && e.rowpos || 0)
                    }), w.append(y), p("beforeInitData", w)) {
                        !function (e, t, d) {
                            var c, u, p, f, r, h, g, m, v = 0, b = [], w = base.getInd.call(S, e),
                                y = getGuiStyles.call(D, "dialog.viewData"), x = $(t),
                                j = getGuiStyles.call(D, "dialog.viewLabel"),
                                i = String(F.labelswidth) + (!F.labelswidth || isNaN(F.labelswidth) ? "" : "px"),
                                a = "<td class='" + getGuiStyles.call(D, "dialog.viewCellLabel", "CaptionTD form-view-label") + (i ? "' style='width:" + i + ";" : "") + "'>&#160;</td><td class='" + getGuiStyles.call(D, "dialog.viewCellData", "DataTD form-view-data") + "'>&#160;</td>",
                                C = "", o = ["integer", "number", "currency"], l = 0, n = 0;
                            for (r = 0; r < d; r++) C += a;
                            if ($(R).each(function () {
                                var e = this;
                                ...
                                if (c = t.name, g = !1, u = (!t.editrules || !0 !== t.editrules.edithidden) && !0 === t.hidden, m = "boolean" != typeof t.viewable || t.viewable, "cb" !== c && "subgrid" !== c && "rn" !== c && m) {
                                    ...
                                    var r = $.extend({}, {rowabove: !1, rowcontent: ""}, t.formoptions || {}),
                                        i = parseInt(r.rowpos, 10) || v + 1,
                                        a = parseInt(2 * (parseInt(r.colpos, 10) || 1), 10);
                                    if (r.rowabove) {
                                        var o = $("<tr><td class='contentinfo' colspan='" + 2 * d + "'>" + r.rowcontent + "</td></tr>");
                                        x.append(o), o[0].rp = i
                                    }
                                    0 === (p = x.find("tr[data-rowpos=" + i + "]")).length && ((p = $("<tr data-rowpos='" + i + "'></tr>").addClass("FormData").attr("id", "trv_" + c)).append(C), x.append(p), p[0].rp = i);
                                    var l = void 0 === r.label ? q.colNames[e] : r.label,
                                        n = $("td:eq(" + (a - 1) + ")", p[0]), s = $("td:eq(" + (a - 2) + ")", p[0]);
                                    s.html("<label for='" + c + "'" + (j ? " class='" + j + "'>" : ">") + (l || "&nbsp;") + "</label>"), n[isEmptyString(n.html()) ? "html" : "append"]("<span id='" + c + "'" + (y ? " class='" + y + "'>" : ">") + (f || "&nbsp;") + "</span>").attr("id", "v_" + c), g && $("td:eq(" + (a - 1) + ") span", p[0]).css({
                                        "text-align": "right",
                                        width: h + "px"
                                    }), u && s.add(n).css("visibility", "hidden"), b[v] = e, v++
                                }
                            }), hideRowsWithoutVissibleCells(x), 0 < v) {
                                var s = $("<tr class='FormData' style='display:none'><td class='CaptionTD'>&#160;</td><td colspan='" + (2 * d - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='" + e + "'/></td></tr>");
                                s[0].rp = v + 99, x.append(s)
                            }
                        }(B, y, c);
                        var x = "rtl" === q.direction, j = x ? "nData" : "pData", C = x ? "pData" : "nData",
                        ...
                        F.gbox = d;
                        var k = $("<div></div>").append(b).append("<div class='" + getGuiStyles.call(D, "dialog.footer") + "'><table border='0' class='EditTable' id='" + r + "_2'><tbody><tr id='Act_Buttons'><td class='navButton navButton-" + q.direction + "' width='" + (F.labelswidth || "auto") + "'>" + (x ? I + _ : _ + I) + "</td><td class='EditButton EditButton-" + q.direction + "'>" + G + "</td></tr></tbody></table></div>");
                ...
                function A(e) {
                    var t, r, i = 0, a = base.getInd.call(S, e, !0);
                ...
                function M() {
                    var e = base.getDataIDs.call(S), t = $("#id_g", o).val();
                    return [$.inArray(t, e), e]
                }
            })
        }, delGridRow: function (D, S) {
            return this.each(function () {
                var d = this, c = d.p, u = $(d);
                if (d.grid && null != c && D) {
                    var p, f, h, g, m = c.id, v = $.extend(!0, {
                            top: 0,
                            left: 0,
                            width: 240,
                            removemodal: !0,
                        ...
                        e = "DelTbl_" + m, b = "#DelTbl_" + jqID(m),
                        t = {themodal: "delmod" + m, modalhead: "delhd" + m, modalcontent: "delcnt" + m, resizeAlso: e},
                        w = "#" + jqID(t.themodal), y = c.gBox, r = v.commonIconClass, x = function () {
                            var e = $.makeArray(arguments);
                            return e.unshift(""), e.unshift("Delete"), e.unshift(v), jgridFeedback.apply(d, e)
                        }, i = getGuiStateStyles.call(d, "hover"), j = getGuiStateStyles.call(d, "active"),
                    ...
                    if ($.isArray(D) || (D = [String(D)]), void 0 !== $(w)[0]) {
                        ...
                        var o = isNaN(v.dataheight) ? v.dataheight : v.dataheight + "px",
                            ...
                            n = "<div class='" + getGuiStyles.call(d, "dialog.body") + "'><div id='" + e + "' class='formdata' style='width:" + l + ";overflow:auto;position:relative;height:" + o + ";'>";
                        n += "<table class='DelTable'><tbody>", n += "<tr id='DelError' style='display:none'><td class='" + a + "'></td></tr>", n += "<tr id='DelData' style='display:none'><td >" + D.join(v.idSeparator) + "</td></tr>", n += "<tr><td class='delmsg'>" + v.msg + "</td></tr>", n += "</tbody></table></div></div>";
                        var s = builderFmButon.call(d, "dData", v.bSubmit),
                            C = builderFmButon.call(d, "eData", v.bCancel);
                        if (n += "<div class='" + getGuiStyles.call(d, "dialog.footer") + "'><table class='EditTable' id='" + e + "_2'><tbody><tr><td><hr class='" + getGuiStyles.call(d, "dialog.hr") + "' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton EditButton-" + c.direction + "'>" + s + "&#160;" + C + "</td></tr></tbody></table></div>", v.gbox = y, jgrid.createModal.call(d, t, n, v, c.gView, $(c.gView)[0]), $("#DelData>td", b).data("rowids", D), !x("beforeInitData", $(n))) return;
                        $(".fm-button", b + "_2").hover(function () {
                            ...
                            var e, i = [!0, ""], t = $("#DelData>td", b), a = t.text(), o = t.data("rowids"), r = {};
                            if ($.isFunction(v.onclickSubmit) && (r = v.onclickSubmit.call(d, v, a, o) || {}), $.isFunction(v.beforeSubmit) && (i = v.beforeSubmit.call(d, a, o) || i), i[0] && !v.processing) {
                                ...
                                var l = v.url || c.editurl, n = $.extend({
                                    ...
                                    complete: function (e, t) {
                                        ...
                                        if (u.jqGrid("progressBar", {
                                            method: "hide",
                                            loadtype: v.delui
                                        }), $("#dData", b + "_2").removeClass(j), 300 <= e.status && 304 !== e.status || 0 === e.status && 4 === e.readyState ? (i[0] = !1, $.isFunction(v.errorTextFormat) ? i[1] = v.errorTextFormat.call(d, e) : i[1] = t + " Status: '" + e.statusText + "'. Error code: " + e.status) : $.isFunction(v.afterSubmit) && (i = v.afterSubmit.call(d, e, p, o) || [!0]), !1 === i[0]) $("#DelError>td", b).html(i[1]), $("#DelError", b).show(); else {
                                            if ("local" === c.datatype || !0 === c.treeGrid || !v.reloadAfterSubmit) if (!0 === c.treeGrid) try {
                                                base.delTreeNode.call(u, o[0])
                                            } catch (e) {
                                            } else for (o = o.slice(), r = 0; r < o.length; r++) base.delRowData.call(u, o[r]);
                                ...
                                if (n.url || v.useDataProxy || ($.isFunction(c.dataProxy) ? v.useDataProxy = !0 : (i[0] = !1, i[1] += " " + jgrid.errors.nourl)), i[0]) if (u.jqGrid("progressBar", {
                                    method: "show",
                                    loadtype: v.delui,
            ...
            return "object" == typeof T && (V = L, L = z, z = P, P = B, B = M, M = T, T = void 0), P = P || {}, B = B || {}, V = V || {}, z = z || {}, L = L || {}, this.each(function () {
                ...
                if (l.grid && null != n && !(l.nav && 0 < $(T).find(".navtable").length)) {
                    ...
                    var e, t, c, r = n.idSel, u = n.gBox, p = d.commonIconClass,
                        f = {themodal: "alertmod_" + o, modalhead: "alerthd_" + o, modalcontent: "alertcnt_" + o},
                        a = function () {
                            var e = document.documentElement, t = window, r = 1024, i = 768,
                                a = s.closest(".ui-jqgrid").offset();
                            void 0 === $("#" + jqID(f.themodal))[0] && (d.alerttop || d.alertleft || (void 0 !== t.innerWidth ? (r = t.innerWidth, i = t.innerHeight) : null != e && void 0 !== e.clientWidth && 0 !== e.clientWidth && (r = e.clientWidth, i = e.clientHeight), r = r / 2 - parseInt(d.alertwidth, 10) / 2 - a.left + (void 0 !== t.pageXOffset ? t.pageXOffset : (e || document.body.parentNode || document.body).scrollLeft), i = i / 2 - 25 - a.top + (void 0 !== t.pageYOffset ? t.pageYOffset : (e || document.body.parentNode || document.body).scrollTop)), jgrid.createModal.call(l, f, "<div class='" + getGuiStyles.call(l, "dialog.body") + "'><div>" + d.alerttext + "</div></div>", {
                                gbox: u,
                                jqModal: d.jqModal,
                                drag: !0,
                                resize: !0,
                            ...
                            if (13 === e.which && 0 < (t = $(this).find(".ui-pg-button").filter(":focus")).length) {
                                var r = t[0].id,
                                    i = r.substr(0, 0 < $(this).closest(".ui-jqgrid-toppager").length ? r.length - o.length - 5 : r.length - o.length - 1) + "mod" + n.id,
                                    a = $(".ui-jqdialog").filter(":visible").map(function () {
                                        return this.id
                                    });
                                if ($.inArray(i, a) < 0) return t.trigger("click"), !1
                            }
                        }, h = getGuiStateStyles.call(l, "hover"), g = getGuiStateStyles.call(l, "disabled"),
                    ...
                    if (l.grid) {
                        ...
                        var v, b, w, y, x, j, C, D = 1, S = ["left", "center", "right"],
                            q = "<div class='" + getGuiStyles.call(l, "navButton", "ui-pg-button " + getGuiStateStyles.call(l, "disabled")) + "'><span class='ui-separator'></span></div>",
                            F = function () {
                                ...
                                if (!hasOneFromClasses(this, g)) {
                                    ...
                                    switch (d.refreshstate) {
                                        case"firstpage":
                                            s.trigger("reloadGrid", [$.extend({}, d.reloadGridOptions || {}, {page: 1})]);
                                            break;
                                        case"current":
                                        case"currentfilter":
                                            s.trigger("reloadGrid", [$.extend({}, d.reloadGridOptions || {}, {current: !0})])
                                    }
                                    $.isFunction(d.afterRefresh) && d.afterRefresh.call(l)
                                }
                                return !1
                            }, A = function (e, t, r) {
                                var i = $("<div class='" + m + "' tabindex='0' role='button'></div>"), a = d[e + "icon"],
                                    o = $.trim(d[e + "text"]);
                                return i.append("<div class='ui-pg-div'><span class='" + (d.iconsOverText ? mergeCssClasses("ui-pg-button-icon-over-text", p, a) : mergeCssClasses(p, a)) + "'></span>" + (o ? "<span class='ui-pg-button-text" + (d.iconsOverText ? " ui-pg-button-icon-over-text" : "") + "'>" + o + "</span>" : "") + "</div>"), $(c).append(i), i.attr({
                                    title: d[e + "title"] || "",
                                    id: t || e + "_" + y
                                }).click(r).hover(F, R), i
                            };
                        for (d.cloneToTop && n.toppager && (D = 2), v = 0; v < D; v++) {
                            if (c = $("<div class='ui-pg-table navtable' role='toolbar' style='float:" + ("rtl" === n.direction ? "right" : "left") + ";table-layout:auto;'></div>"), 0 === v ? (y = o, (w = T) === n.toppager && (y += "_top", D = 1)) : (w = n.toppager, y = o + "_top"), d.add && A("add", P.id, _), d.edit && A("edit", B.id, G), d.view && A("view", V.id, O), d.del && A("del", z.id, k), (d.add || d.edit || d.del || d.view) && $(c).append(q), d.search && (b = A("search", L.id, N), L.showOnLoad && !0 === L.showOnLoad && $(b, c).click()), d.refresh && A("refresh", "", E), t = $(".ui-jqgrid>.ui-jqgrid-view").css("font-size") || "11px", $("body").append("<div id='testpg2' class='" + getGuiStyles.call(l, "gBox", "ui-jqgrid") + "' style='font-size:" + t + ";visibility:hidden;' ></div>"), e = $(c).clone().appendTo("#testpg2").width(), $("#testpg2").remove(), $(w + "_" + d.position, w).append(c), d.hideEmptyPagerParts) for (x = 0; x < S.length; x++) S[x] !== d.position && (0 === (C = $(w + "_" + S[x], w)).length || 0 === C[0].childNodes.length ? C.hide() : 1 === C[0].childNodes.length && (j = C[0].firstChild, !$(j).is("table.ui-pg-table") || 0 !== j.rows && 0 !== j.rows[0].cells.length || C.hide()));
            ...
            return "object" == typeof c && (u = c, c = void 0), this.each(function () {
                ...
                if (t.grid) {
                    var r = $.extend({
                            ...
                            position: "last",
                            iconsOverText: !1
                        }, base.getGridRes.call($(t), "nav"), jgrid.nav || {}, e.navOptions || {}, u || {}), i = r.id,
                        a = getGuiStateStyles.call(t, "hover"), o = getGuiStateStyles.call(t, "disabled"),
                        l = getGuiStyles.call(t, "navButton", "ui-pg-button");
                    if (void 0 === c) if (e.pager) {
                    ...
                    var n = $(".navtable", c), s = r.commonIconClass;
                    if (0 < n.length) {
                        if (i && 0 < n.find("#" + jqID(i)).length) return;
                        var d = $("<div tabindex='0' role='button'></div>");
                        "NONE" === r.buttonicon.toString().toUpperCase() ? $(d).addClass(l).append("<div class='ui-pg-div'>" + (r.caption ? "<span class='ui-pg-button-text" + (r.iconsOverText ? " ui-pg-button-icon-over-text" : "") + "'>" + r.caption + "</span>" : "") + "</div>") : $(d).addClass(l).append("<div class='ui-pg-div'><span class='" + (r.iconsOverText ? mergeCssClasses("ui-pg-button-icon-over-text", s, r.buttonicon) : mergeCssClasses(s, r.buttonicon)) + "'></span>" + (r.caption ? "<span class='ui-pg-button-text" + (r.iconsOverText ? " ui-pg-button-icon-over-text" : "") + "'>" + r.caption + "</span>" : "") + "</div>"), i && $(d).attr("id", i), "first" === r.position && 0 < n.children("div.ui-pg-button").length ? n.children("div.ui-pg-button").first().before(d) : n.append(d), $(d, n).attr("title", r.title || "").click(function (e) {
            ...
            return o = $.extend({
                ...
                if (this.grid) {
                    ...
                    var r = $(".navtable", a);
                    if (0 < r.length) {
                        var i = "<div class='" + t + "'><span class='" + o.sepclass + "'></span>" + o.sepcontent + "</div>";
            ...
            return this.each(function () {
                ...
                if (this.grid) {
                    ...
                    if (a) for (e in a) if (a.hasOwnProperty(e)) if ((t = $("[name=" + jqID(e) + "]", l)).is("input:radio") || t.is("input:checkbox")) for (r = 0; r < t.length; r++) (i = $(t[r])).prop("checked", i.val() === String(a[e])); else t.val(isEmptyString(a[e]) ? "" : a[e])
                }
            })
        ...
        groupingSetup: function () {
            return this.each(function () {
                var e, t, r, i, a, o = this.p, l = o.colModel, n = o.groupingView, s = function () {
                    return ""
                };
                if (null === n || "object" != typeof n && !$.isFunction(n)) o.grouping = !1; else if (n.groupField.length) {
            ...
            return this.each(function () {
                var e, t, r, i, a, o, l, n, s, d = this, c = d.p, u = c.groupingView, p = u.groups, f = u.counters,
                    h = u.lastvalues, g = u.isInTheSameGroup, m = u.groupField.length, v = !1,
                    b = base.groupingCalculations.handler, w = function () {
                        var e, t, r;
                        ...
                        if (null == e && u.useDefaultValuesOnGrouping) {
                            var r,
                                i = void 0 !== c.iColByName[t] ? c.colModel[c.iColByName[t]] : c.additionalProperties[c.iPropByName[t]];
                ...
                for (e = 0; e < m; e++) if (o = u.groupField[e], l = y(x[o], o), null == (s = null == (n = u.displayField[e]) ? null : y(x[n], n)) && (s = l), void 0 !== l) {
                    ...
                    }, 0 === j ? (p.push(i), h[e] = l, f[e] = a) : "object" == typeof l || ($.isArray(g) && $.isFunction(g[e]) ? g[e].call(d, h[e], l, e, u) : h[e] === l) ? v ? (p.push(i), h[e] = l, f[e] = a) : ((a = f[e]).cnt += 1, p[a.pos].cnt = a.cnt) : (p.push(i), h[e] = l, v = !0, f[e] = a), p[a.pos].summary = w(), t = a.pos - 1; 0 <= t; t--) if (p[t].idx < p[a.pos].idx) {
            ...
            return this.each(function () {
                var e, t, r, i = this, a = i.p, o = a.groupingView, l = o.minusicon, n = o.plusicon,
                    s = m ? $(m).closest("tr.jqgroup") : $("#" + jgrid.jqID(g)), d = function (e) {
                        return e.find(">td>span.tree-wrap")
                    }, c = !0, u = !1, p = [], f = function (e) {
                        var t, r = e.length;
                        for (t = 0; t < r; t++) p.push(e[t])
                    }, h = parseInt(s.data("jqgrouplevel"), 10);
                for (a.frozenColumns && 0 < s.length && (t = s[0].rowIndex, s = (s = $(i.rows[t])).add(i.grid.fbRows[t])), r = d(s), jgrid.hasAllClasses(r, l) ? (r.removeClass(l).addClass(n), u = !0) : r.removeClass(n).addClass(l), s = s.next(); s.length; s = s.next()) if (s.hasClass("jqfoot")) {
                ...
                } else if (s.hasClass("jqgroup")) if (e = parseInt(s.data("jqgrouplevel"), 10), u) {
                    if (e <= h) break;
                    f(s)
                } else {
                    if (e <= h) break;
                ...
                $(p).css("display", u ? "none" : ""), a.frozenColumns && $(i).triggerHandler("jqGridResetFrozenHeights", [{
                    ...
                    resizeFooter: !1,
                    body: {resizeDiv: !0, resizedRows: {iRowStart: t, iRowEnd: s.length ? s[0].rowIndex - 1 : -1}}
            ...
            var y = "", j = this[0], C = j.p, x = 0, D = [], S = C.groupingView, q = $.makeArray(S.groupSummary),
                F = S.groupField.length, R = S.groups, _ = C.colModel, I = _.length, G = C.page,
                e = "jqGridShowHideCol.groupingRender", t = function (e) {
                    return base.getGuiStyles.call(j, "gridRow", e)
                }, O = t("jqgroup ui-row-" + C.direction), k = t("jqfoot ui-row-" + C.direction);

            function N(e, t, r, i, a) {
                var o, l, n, s, d, c, u, p, f, h, g, m, v, b = R[e], w = "", y = 0, x = !0;
                if (0 !== t && 0 !== R[e].idx) for (o = e; 0 <= o; o--) if (R[o].idx === R[e].idx - t) {
                    b = R[o];
                    break
                }
                for (l = b.cnt, g = void 0 === a ? i : 0; g < I; g++) {
                    for (n = "&#160;", h = _[g], p = 0; p < b.summary.length; p++) if (f = b.summary[p], m = $.isArray(f.st) ? f.st[r.idx] : f.st, v = $.isArray(h.summaryTpl) ? h.summaryTpl[r.idx] : h.summaryTpl || "{0}", f.nm === h.name) {
                    ...
                    d = s = !1, void 0 !== a && x && (h.hidden || (n = a, x = !1, 1 < i && (s = !0, y = i - 1), d = h.align, h.align = "rtl" === C.direction ? "right" : "left", S.iconColumnName = h.name)), u = !1, 0 < y && !h.hidden && "&#160;" === n ? (u = !0, d && (h.align = d), y--) : (w += "<td role='gridcell' " + j.formatCol(g, 1, "") + (s ? "colspan='" + i + "'" : "") + ">" + n + "</td>", s = !1, d && (h.align = d), u && (h.hidden = !1, y--))
                }
                return w
            }
            ...
            return $.each(_, function (e, t) {
                var r;
                for (r = 0; r < F; r++) if (S.groupField[r] === t.name) {
                    D[r] = e;
                    break
                }
            }), q.reverse(), $.each(R, function (e, t) {
                var r, i, a, o, l, n, s, d, c = C.id + "ghead_" + t.idx, u = c + "_" + e,
                    p = $.isFunction(S.groupCollapse) ? S.groupCollapse.call(j, {group: t, rowid: u}) : S.groupCollapse,
                    f = 1, h = 0, g = F - 1 === t.idx, m = null != t.parentGroup && t.parentGroup.collapsed,
                    v = "<span style='cursor:pointer;margin-" + ("rtl" === C.direction ? "right:" : "left:") + 12 * t.idx + "px;' class='" + S.commonIconClass + " " + (p ? S.plusicon : S.minusicon) + " tree-wrap'></span>";
                ...
                if (y += "<tr id='" + u + "' data-jqgrouplevel='" + t.idx + "' " + (p && m ? "style='display:none;' " : "") + "role='row' class='" + O + " " + c + "'>", "string" != typeof (d = $.isFunction(S.groupText[t.idx]) ? S.groupText[t.idx].call(j, r, t.cnt, t.summary) : jgrid.template(S.groupText[t.idx], r, t.cnt, t.summary)) && "number" != typeof d && (d = r), "header" === S.groupSummaryPos[t.idx] ? (f = 1, "cb" !== _[0].name && "cb" !== _[1].name || f++, "subgrid" !== _[0].name && "subgrid" !== _[1].name || f++, y += N(e, 0, t, f, v + "<span class='cell-wrapper'>" + d + "</span>")) : y += "<td role='gridcell' style='padding-left:" + 12 * t.idx + "px;' colspan='" + I + "'>" + v + d + "</td>", y += "</tr>", g) {
                    ...
                    if ("header" !== S.groupSummaryPos[t.idx]) {
                        ...
                        for (o = 0; o < x; o++) q[o] && (y += "<tr data-jqfootlevel='" + (t.idx - o) + (p && (0 < t.idx - o || !S.showSummaryOnHide) ? "' style='display:none;'" : "'") + " role='row' class='" + k + "'>", y += N(e, o, R[t.idx - o], 0), y += "</tr>");
                        x = i
                    }
                }
                ...
                if (0 <= $.inArray("header", S.groupSummaryPos)) {
                    for (i = 0; i < _.length; i++) if (!_[i].hidden) {
                        r = i;
                        break
                    }
            ...
            return this.each(function () {
                var e, t, r = this.p, i = r.groupingView;
            ...
            return this.each(function () {
                var e, t = this.p, r = this.tBodies[0], i = t.groupingView;
        ...
        jqGridImport: function (i) {
            return i = $.extend({
                ...
                var e, s = this, t = function (e, t) {
                    var r, i, a, o, l = $(t.xmlGrid.config, e)[0], n = $(t.xmlGrid.data, e)[0];
                    if (xmlJsonClass.xml2json) {
                        for (a in r = xmlJsonClass.xml2json(l, " "), r = $.parseJSON(r)) r.hasOwnProperty(a) && (i = r[a]);
                        void 0 !== i && (n ? (o = r.grid.datatype, r.grid.datatype = "xmlstring", r.grid.datastr = e, $(s).jqGrid(i).jqGrid("setGridParam", {datatype: o})) : $(s).jqGrid(i))
                    ...
                    if (e && "string" == typeof e) {
                        var r, i = $.parseJSON(e), a = i[t.jsonGrid.config], o = i[t.jsonGrid.data];
                        o ? (r = a.datatype, a.datatype = "jsonstring", a.datastr = o, $(s).jqGrid(a).jqGrid("setGridParam", {datatype: r})) : $(s).jqGrid(a)
                    }
                };
                switch (i.imptype) {
                    case"xml":
    ...
    jgrid.inlineEdit = jgrid.inlineEdit || {}, jgrid.extend({
        editRow: function (b, e, t, r, i, a, o, l, n, s) {
            var w = {}, d = $.makeArray(arguments).slice(1);
            return "object" === $.type(d[0]) ? w = d[0] : (void 0 !== e && (w.keys = e), $.isFunction(t) && (w.oneditfunc = t), $.isFunction(r) && (w.successfunc = r), void 0 !== i && (w.url = i), null != a && (w.extraparam = a), $.isFunction(o) && (w.aftersavefunc = o), $.isFunction(l) && (w.errorfunc = l), $.isFunction(n) && (w.afterrestorefunc = n), $.isFunction(s) && (w.beforeEditRow = s)), this.each(function () {
                var u = this, o = $(u), p = u.p, f = 0, h = null, g = {}, m = {}, e = p.colModel, t = p.prmNames;
                if (u.grid) {
                    var l = $.extend(!0, {
                            keys: !1,
                            oneditfunc: null,
                            ...
                            beforeEditRow: null,
                            focusField: !0
                        }, jgrid.inlineEdit, p.inlineEditing || {}, w), n = o.jqGrid("getInd", b, !0), r = l.focusField,
                    ...
                    if (!1 !== n && (l.extraparam[t.oper] === t.addoper || editFeedback.call(u, l, "beforeEditRow", l, b)) && "0" === ($(n).attr("editable") || "0") && !$(n).hasClass("not-editable-row")) {
                        ...
                        if (null != a && "cellEditing" === a.mode) {
                            var s = a.savedRow, d = u.rows[s.id], c = getGuiStateStyles.call(u, "select");
                        ...
                        if (jgrid.enumEditableCells.call(u, n, $(n).hasClass("jqgrid-new-row") ? "add" : "edit", function (e) {
                            var t, r, i, a = e.cm, o = $(e.dataElement), l = e.dataWidth, n = a.name, s = a.edittype,
                                d = e.iCol, c = a.editoptions || {};
                            if (m[n] = e.editable, "hidden" !== e.editable) {
                                try {
                                    t = $.unformat.call(this, e.td, {rowId: b, colModel: a}, d)
                                } catch (e) {
                            ...
                            if (g.id = b, p.savedRow.push(g), p.editingInfo[b] = {
                                ...
                                var t = o.jqGrid("getNumberOfFrozenColumns"), e = function (e) {
            ...
            if (u.grid && null != f) {
                ...
                var b, w, y, x, j, C, D, S, q = {}, F = {}, R = {}, _ = p.jqGrid("getInd", o, !0), I = $(_),
                    G = f.prmNames, O = v("errors.errcap"), k = v("edit.bClose"), N = function (t, e) {
                        try {
                            var r = jgrid.getRelativeRect.call(u, e);
                            h.call(u, O, t, k, {top: r.top, left: r.left + $(u).closest(".ui-jqgrid").offset().left})
                        } catch (e) {
                            m(t)
                        }
                    };
                if (!1 !== _ && (s = c.extraparam[G.oper] === G.addoper ? "add" : "edit", editFeedback.call(u, c, "beforeSaveRow", c, o, s) && (b = I.attr("editable"), c.url = c.url || f.editurl, D = "clientArray" !== c.url, "1" === b))) {
                    ...
                    var A = {options: c, rowid: o, tr: _, iRow: _.rowIndex, savedRow: C.savedRow, newData: q, mode: s};
                    ...
                    if (D) p.jqGrid("progressBar", {
                        ...
                        complete: function (e, t) {
                            ...
                            if (p.jqGrid("progressBar", {
                                method: "hide",
                                loadtype: c.saveui
                            }), (e.status < 300 || 304 === e.status) && (0 !== e.status || 4 !== e.readyState)) if (null != (i = p.triggerHandler("jqGridInlineSuccessSaveRow", [e, o, c, s, R])) && !0 !== i || (i = [!0, q]), i[0] && g(c.successfunc) && (i = c.successfunc.call(u, e, o, c, s, R)), $.isArray(i) ? (r = i[0], q = i[1] || q) : r = i, !0 === r) {
                                for (f.autoEncodeOnEdit && $.each(q, function (e, t) {
                                    q[e] = jgrid.oldDecodePostedData(t)
                                }), q = $.extend({}, q, F), p.jqGrid("setRowData", o, q), I.attr("editable", "0"), a = 0; a < f.savedRow.length; a++) if (String(f.savedRow[a].id) === String(o)) {
                                    y = a;
                                    break
                                }
                        ...
                        error: function (e, t, r) {
                            if (p.triggerHandler("jqGridInlineErrorSaveRow", [o, e, t, r, c]), g(c.errorfunc)) c.errorfunc.call(u, o, e, t, r); else {
                                var i = e.responseText || e.statusText;
                                try {
                                    h.call(u, O, '<div class="' + getGuiStateStyles.call(u, "error") + '">' + i + "</div>", k, {buttonalign: "right"})
                                } catch (e) {
                                    m(i)
                                }
                            }
                        ...
                        for (q = $.extend({}, q, F), x = p.jqGrid("setRowData", o, q), I.attr("editable", "0"), w = 0; w < f.savedRow.length; w++) if (String(f.savedRow[w].id) === String(o)) {
                            y = w;
                            break
                        }
            ...
            var t = $.makeArray(arguments).slice(1), d = {};
            return "object" === $.type(t[0]) ? d = t[0] : $.isFunction(e) && (d.afterrestorefunc = e), this.each(function () {
                var e, t = this, r = $(t), i = t.p, a = -1, o = {};
                if (t.grid) {
                    var l = $.extend(!0, {}, jgrid.inlineEdit, i.inlineEditing || {}, d), n = r.jqGrid("getInd", s, !0);
                    if (!1 !== n && editFeedback.call(t, l, "beforeCancelRow", l, s)) {
                        for (e = 0; e < i.savedRow.length; e++) if (String(i.savedRow[e].id) === String(s)) {
                            a = e;
                            break
                        }
                        if (0 <= a) {
            ...
            return this.each(function () {
                if (this.grid) {
                    var t = this, e = $(t), r = t.p, i = $.extend(!0, {
                        rowID: null,
                        initdata: {},
                        position: "first",
                        useDefValues: !0,
                    ...
                    if (editFeedback.call(t, i, "beforeAddRow", i.addRowParams)) if (i.rowID = $.isFunction(i.rowID) ? i.rowID.call(t, i) : null != i.rowID ? i.rowID : jgrid.randId(), !0 === i.useDefValues && $(r.colModel).each(function () {
                        if (this.editoptions && this.editoptions.defaultValue) {
                            var e = this.editoptions.defaultValue;
                            i.initdata[this.name] = $.isFunction(e) ? e.call(t, i) : e
                        }
                    }), i.rowID = r.idPrefix + i.rowID, e.jqGrid("addRowData", i.rowID, i.initdata, i.position), $("#" + jgrid.jqID(i.rowID), t).addClass("jqgrid-new-row"), i.useFormatter) $("#" + jgrid.jqID(i.rowID) + " .ui-inline-edit", t).click(); else {
                        var a = r.prmNames, o = a.oper;
            ...
            return "object" == typeof f && (h = f, f = void 0), this.each(function () {
                var a = this, o = $(a), l = a.p;
                if (this.grid && null != l) {
                    var e, t = f === l.toppager ? l.idSel + "_top" : l.idSel,
                        r = f === l.toppager ? l.id + "_top" : l.id, n = getGuiStateStyles.call(a, "disabled"),
                        s = $.extend(!0, {
                            edit: !0,
                    ...
                    if (void 0 !== f && !((e = $(f)).length <= 0)) {
                        if (e.find(".navtable").length <= 0 && o.jqGrid("navGrid", f, {
                            ...
                            for (i = 0; i < p.length; i++) if (p[i].formatter && "actions" === p[i].formatter) {
                                p[i].formatoptions && (c = {
                                    keys: !1,
                                    onEdit: null,
                                    onSuccess: null,
                        ...
                        s.add && o.jqGrid("navButtonAdd", f, {
                            ...
                            onClickButton: function () {
                                if (!hasOneFromClasses(this, n) && 0 < l.savedRow.length) {
                                    ...
                                    if (e) {
                                        var t = l.prmNames, r = t.oper, i = s.editParams;
                            ...
                            onClickButton: function () {
                                if (!hasOneFromClasses(this, n) && 0 < l.savedRow.length) {
                                    var e = l.savedRow[0].id, t = s.editParams;
            ...
            return this.each(function () {
                if (this.grid) {
                    var e = this.p, t = e.idSel, r = getGuiStateStyles.call(this, "disabled"),
    ...
    var $UiMultiselect = null != $.ui ? $.ui.multiselect : null, reorderSelectedColumns = function (r) {
        if (null != this.grid && null != this.grid.p) {
            var i, e, t, a, o, l = this, n = this.grid.p, s = this.gh, d = this.selectedList, c = this.inGroup,
                u = d.find("li"), p = u.length - 1, f = function (e, t, r) {
                    var i, a, o = d.find("li");
                    for (void 0 === t && (t = r ? o.length - 1 : 0), i = t; r ? 0 <= i : i < o.length; r ? i-- : i++) if ((a = $(o[i]).data("optionLink")) && e.call(o[i], parseInt(a.val(), 10), i)) return i
                }, h = function () {
            ...
            if (h(), s && void 0 !== s[c[r]]) {
                for (a = s[c[r]], e = 0; e < a.numberOfColumns; e++) if (i = n.iColByName[a.startColumnName] + e, !n.colModel[i].hidden && !n.colModel[i].hidedlg) {
    ...
    jgrid.extend({
        sortableColumns: function (s) {
            return this.each(function () {
                ...
                if (l && l.sortable && $.isFunction($.fn.sortable)) {
                    var t = {
                        ...
                        update: function (e, t) {
                            var r = $(">th", $(t.item).parent()), i = l.id + "_", a = [];
                            r.each(function () {
                    ...
                    if (l.sortable.options ? $.extend(t, l.sortable.options) : $.isFunction(l.sortable) && (l.sortable = {update: l.sortable}), t.start) {
                        var r = t.start;
                    ...
                    var i = s.sortable(t), a = i.data("sortable") || i.data("uiSortable") || i.data("ui-sortable");
                    null != a && (a.floating = !0)
                }
            ...
            var t, l, e, r, i, n, a, s = this, d = s[0], c = d.p, u = c.colModel, p = u.length, f = c.colNames,
                h = function (e) {
            ...
            if (!$("#colchooser_" + jqID(c.id)).length) {
                if (t = $('<div id="colchooser_' + c.id + '" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>'), l = $("select", t), o = $.extend({
                    width: 400,
                    height: 240,
                    classname: null,
                    done: function (e) {
                    ...
                    dlog_opts: function (e) {
                        ...
                        return t[e.bSubmit] = function () {
                            ...
                            width: e.width + 70,
                            resize: function () {
                                var e = h(l), t = e.container.closest(".ui-dialog-content");
                    ...
                    apply_perm: function () {
                        var e, t, r = new Array(c.colModel.length), i = {
                        ...
                        }), o.done && o.done.call(s, r), c.groupHeader && ("object" == typeof c.groupHeader || $.isFunction(c.groupHeader))) if (s.jqGrid("destroyGroupHeader", !1), c.groupHeader.groupHeaders = n.gh, null != c.pivotOptions && null != c.pivotOptions.colHeaders && 1 < c.pivotOptions.colHeaders.length) for (t = c.pivotOptions.colHeaders, e = 0; e < t.length; e++) t[e] && t[e].groupHeaders.length && s.jqGrid("setGroupHeaders", t[e]); else s.jqGrid("setGroupHeaders", c.groupHeader);
                ...
                var g, m, v, b, w = null != c.groupHeader ? c.groupHeader.groupHeaders : 0, y = {};
                if (w) for (g = 0; g < w.length; g++) for (b = w[g], m = 0; m < b.numberOfColumns; m++) v = c.iColByName[b.startColumnName] + m, y[v] = $.isFunction(o.buildItemText) ? o.buildItemText.call(s[0], {
                    iCol: v,
                    cm: u[v],
                    cmName: u[v].name,
                    colName: f[v],
                ...
                if ($.each(u, function (e) {
                    this.hidedlg || l.append("<option value='" + e + "'" + (c.headertitles || this.headerTitle ? " title='" + jgrid.stripHtml("string" == typeof this.headerTitle ? this.headerTitle : y[e]) + "'" : "") + (this.hidden ? "" : " selected='selected'") + ">" + y[e] + "</option>")
                }), e = $.isFunction(o.dlog_opts) ? o.dlog_opts.call(s, o) : o.dlog_opts, C(o.dlog, t, e), r = $.isFunction(o.msel_opts) ? o.msel_opts.call(s, o) : o.msel_opts, C(o.msel, l, r), (i = $("#colchooser_" + jqID(c.id))).css({margin: "auto"}), i.find(">div").css({
                    width: "100%",
                    height: "100%",
                    margin: "auto"
                }), n = h(l)) {
                    var x, j;
                    if (n.grid = d, w) for (n.gh = $.extend(!0, [], w), n.inGroup = new Array(c.colModel.length), x = 0; x < w.length; x++) for (j = w[x], v = 0; v < j.numberOfColumns; v++) n.inGroup[c.iColByName[j.startColumnName] + v] = x;
            ...
            return this.each(function () {
                ...
                if (g.grid && !g.p.treeGrid && $.fn.draggable && $.fn.droppable) {
                    if (void 0 === $("#jqgrid_dnd")[0] && $("body").append("<table id='jqgrid_dnd' class='ui-jqgrid-dnd'></table>"), "string" != typeof i || "updateDnD" !== i || !0 !== g.p.jqgdnd) {
                        if ((i = $.extend({
                            drag: function (a) {
                                return $.extend({
                                    start: function (e, t) {
                                ...
                                return $.extend({
                                    accept: function (e) {
                                        ...
                                        if ($(t.draggable).hasClass("jqgrow")) {
                                            var r, i = $(t.draggable).attr("id"), a = t.draggable.parent().parent(),
                                                o = a.jqGrid("getRowData", i);
                                            if (!h.dropbyname) {
                                                var l, n, s, d, c = {}, u = a.jqGrid("getGridParam", "colModel"),
                                                    p = $("#" + jqID(this.id)).jqGrid("getGridParam", "colModel");
                                                try {
                                                    for (n = l = 0; l < u.length && n < p.length; l++) if ("cb" !== (s = u[l].name) && "rn" !== s && "subgrid" !== s) {
                                                        for (; n < p.length; n++) if ("cb" !== (d = p[n].name) && "rn" !== d && "subgrid" !== d) {
                                                            c[d] = o[s];
                                                            break
                                                        }
                                                        n++
                            ...
                            autoid: !0,
                            autoidprefix: "dnd_"
                        }, i || {})).connectWith) for (i.connectWith = i.connectWith.split(","), i.connectWith = $.map(i.connectWith, function (e) {
                            return $.trim(e)
            ...
            return this.each(function () {
                var r, i = this, a = i.grid, o = i.p, l = o.gView + ">.ui-jqgrid-bdiv", n = !1, s = o.height;
                if (a && $.fn.resizable) {
                    if ((d = $.extend({}, d || {})).alsoResize ? (d._alsoResize_ = d.alsoResize, delete d.alsoResize) : d._alsoResize_ = !1, d.stop && $.isFunction(d.stop) ? (d._stop_ = d.stop, delete d.stop) : d._stop_ = !1, d.stop = function (e, t) {
                        $(i).jqGrid("setGridWidth", t.size.width, d.shrinkToFit), $(o.gView + ">.ui-jqgrid-titlebar").css("width", ""), n ? ($(r).each(function () {
                            $(this).css("height", "")
                        }), "auto" !== s && "100%" !== s || $(a.bDiv).css("height", s)) : $(i).jqGrid("setGridParam", {height: $(l).height()}), i.fixScrollOffsetAndhBoxPadding && i.fixScrollOffsetAndhBoxPadding(), d._stop_ && d._stop_.call(i, e, t)
        ...
        for (r = 0; r < a; r++) if (0 !== (i = this.fieldCompare[r](e[r], t[r]))) return {index: r, result: i};
        ...
        var t, r, i, a, o, l, n, s, d, c = e.length, u = this.fieldLength, p = this.fieldNames,
            f = this.indexesOfSourceData, h = this.items;
        for (t = 0; t < c; t++) {
            for (n = e[t], r = new Array(u), a = 0; a < u; a++) void 0 !== (i = n[p[a]]) && ("string" == typeof i && this.trimByCollect && (i = $.trim(i)), r[a] = i);
            if (s = 0, (d = h.length - 1) < 0) h.push(r), f.push([t]); else if (0 !== (o = this.compareVectors(r, h[d]))) if (1 === o || this.skipSort) h.push(r), f.push([t]); else if (1 !== (o = this.compareVectors(h[0], r))) if (0 !== o) for (; ;) {
                if (d - s < 2) {
                ...
                1 === o ? d = l : s = l
            } else f[0].push(t); else h.unshift(r), f.unshift([t]); else f[d].push(t)
        }
    }, jgrid.extend({
        pivotSetup: function (c, r) {
            var e, t, i, a, n, o, l, s, d, u, p, f, h, g, m, v, b, w, y, x, j, C, D, S, q, F, R, _, I, G = this[0],
                ...
                E = {grouping: !0, groupingView: N}, A = $.extend({
                    ...
                    defaultFormatting: !0,
                    data: c
                }, r || {}), T = c.length, M = A.xDimension, B = A.yDimension, P = A.aggregates,
                z = A.totalText || A.totals || A.rowTotals || A.totalHeader, L = O(M) ? M.length : 0,
                V = O(B) ? B.length : 0, H = O(P) ? P.length : 0, W = V - (1 === H ? 1 : 0), U = [], Y = [], X = [],
                Q = [], J = ["pivotInfos"], Z = new Array(H), K = new Array(V), ee = function (e, t, r) {
                    ...
                    return t.groupInfo = {iRows: [], rows: [], ys: [], iYs: []}, t
                }, oe = function () {
                    var e, t;
                    for (e = W - 1; 0 <= e; e--) if (Y[e]) for (null == K[e] && (K[e] = new Array(H)), t = 0; t < H; t++) K[e][t] = ae(t)
                }, le = function (e, t, r, i) {
                    var a, o, l, n = _.getIndexOfDifferences(t, r);
                    if (null !== r) for (n = Math.max(n, 0), a = W - 1; n <= a; a--) o = "y" + e + "t" + a + (1 < H ? "a" + i : ""), Y[a] && void 0 === D[o] && ((l = K[a][i]).getResult(D, o), D.pivotInfos[o] = {
                        colType: 1,
                        iA: i,
                        a: P[i],
                        level: a,
                    ...
                    var n, s, d;
                    if (e !== t) for (n = W - 1; 0 <= n; n--) Y[n] && ((s = K[n][i]).calc(a[r.member], r.member, a, o, c), d = s.groupInfo, $.inArray(l, d.iYs) < 0 && (d.iYs.push(l), d.ys.push(e)), $.inArray(o, d.iRows) < 0 && (d.iRows.push(o), d.rows.push(a)))
                };
            ...
            for (z && re(2), S = _.getItem(0), i = 0; i < W; i++) U.push({
                ...
                groupHeaders: [{
                    titleText: $.isFunction(B[i].label) ? B[i].label.call(G, {
                        ...
                        yLevel: i,
                        pivotOptions: A
                    }) : S[i], startColumnName: 1 === H ? "y0" : "y0a0", numberOfColumns: H
                }]
            });
            for (w = 1; w < I; w++) {
                for (y = _.getItem(w), ie(w, t = _.getIndexOfDifferences(y, S), S), i = W - 1; t <= i; i--) U[i].groupHeaders.push({
                    titleText: $.isFunction(B[i].label) ? B[i].label.call(G, {
                        ...
                        yLevel: i,
                        pivotOptions: A
                    }) : y[i], startColumnName: "y" + w + (1 === H ? "" : "a0"), numberOfColumns: H
                });
                for (i = 0; i < t; i++) (q = U[i].groupHeaders)[q.length - 1].numberOfColumns += H;
                S = y
            }
            if (ie(I, 0, S), z) for (t = 0; t < W; t++) U[t].groupHeaders.push({
                titleText: t < W - 1 ? "" : A.totalHeader || "",
                startColumnName: "t" + (1 === H ? "" : "a0"),
                numberOfColumns: H
            });
            for (v = R.getIndexLength(), d = 0; d < v; d++) {
                for (u = R.getItem(d), D = {pivotInfos: p = {iX: d, x: u}}, t = 0; t < L; t++) D["x" + t] = u[t];
                if (b = R.getIndexesOfSourceData(d), z) for (i = 0; i < H; i++) Z[i] = ae(i);
                ...
                if (null !== S) for (i = 0; i < H; i++) le(I - 1, S, S, i);
                if (z) for (i = 0; i < H; i++) s = "t" + (1 === H ? "" : "a" + i), (g = Z[i]).getResult(D, s), m = g.groupInfo, p[s] = {
                    colType: 2,
                    iA: i,
                    a: P[i],
                    iRows: m.iRows,
            ...
            return this.each(function () {
                var l = this, n = $(l), s = $.fn.jqGrid;

                function t() {
                    var e, t = s.pivotSetup.call(n, d, c), r = t.groupHeaders, i = 0 < function (e) {
                        var t, r = 0;
                        for (t in e) e.hasOwnProperty(t) && r++;
                        return r
                    }(t.summary), a = t.groupOptions.groupingView, o = jgrid.from.call(l, t.rows);
                    if (!c.skipSortByX) for (e = 0; e < a.groupField.length; e++) o.orderBy(a.groupField[e], null != u && u.groupingView && null != u.groupingView.groupOrder && "desc" === u.groupingView.groupOrder[e] ? "d" : "a", "text", "");
                    if (c.data = d, s.call(n, $.extend(!0, {
                        datastr: $.extend(o.select(), i ? {userdata: t.summary} : {}),
                        datatype: "jsonstring",
                        footerrow: i,
                        userDataOnFooter: i,
                        colModel: t.colModel,
                    ...
                    }, t.groupOptions, u || {})), r.length) for (e = 0; e < r.length; e++) r[e] && r[e].groupHeaders.length && s.setGroupHeaders.call(n, r[e]);
                    c.frozenStaticCols && s.setFrozenColumns.call(n)
                }

                "string" == typeof d ? $.ajax($.extend({
                    url: d, dataType: "json", success: function (e) {
    ...
    jgrid.extend({
        setSubGrid: function () {
            ...
            return this.each(function () {
                var e, t, r, s = this, d = s.p, c = d.subGridModel[0], u = function (e, t) {
                        return base.getGuiStyles.call(s, "subgrid." + e, t || "")
                    }, p = u("thSubgrid", "ui-th-subgrid ui-th-column ui-th-" + d.direction),
                    f = u("rowSubTable", "ui-subtblcell"), n = u("row", "ui-subgrid ui-row-" + d.direction),
                    h = u("tdWithIcon", "subgrid-cell"), g = u("tdData", "subgrid-data"), m = function (e, t, r) {
                        var i = c.align[r], a = $("<td" + (i ? " style='text-align:" + i + ";'" : "") + "></td>").html(t);
                        e.append(a)
                    }, v = function (e, i) {
                        var a = d.xmlReader.subgrid;
                        $(a.root + " " + a.row, e).each(function () {
                            var e, t, r = $("<tr class='" + f + "'></tr>");
                            if (!0 === a.repeatitems) $(a.cell, this).each(function (e) {
                                m(r, $(this).text() || "&#160;", e)
                            }); else if (e = c.mapping || c.name) for (t = 0; t < e.length; t++) m(r, jgrid.getXmlData(this, e[t]) || "&#160;", t);
                            i.append(r)
                        })
                    }, b = function (e, t) {
                        var r, i, a, o, l, n = d.jsonReader.subgrid, s = jgrid.getAccessor(e, n.root);
                        if (null != s) for (i = 0; i < s.length; i++) {
                            if (l = s[i], r = $("<tr class='" + f + "'></tr>"), !0 === n.repeatitems) for (n.cell && (l = l[n.cell]), a = 0; a < l.length; a++) m(r, l[a] || "&#160;", a); else if ((o = c.mapping || c.name).length) for (a = 0; a < o.length; a++) m(r, jgrid.getAccessor(l, o[a]) || "&#160;", a);
                            t.append(r)
                        }
                    }, w = function (e, t, r) {
                        var i, a,
                            o = u("legacyTable", "ui-jqgrid-legacy-subgrid" + (!0 === d.altRows && $(s).jqGrid("isBootstrapGuiStyle") ? " table-striped" : "")),
                            l = $("<table" + (o ? " style='width:1px' role='presentation' class='" + o + "'" : "") + "><thead></thead><tbody></tbody></table>"),
                            n = $("<tr></tr>");
                        for (s.grid.endReq.call(s), a = 0; a < c.name.length; a++) i = $("<th class='" + p + "'></th>").html(c.name[a]).width(c.width[a]), n.append(i);
                        return n.appendTo(l[0].tHead), r(e, $(l[0].tBodies[0])), $("#" + jqID(d.id + "_" + t)).append(l), !1
                    }, i = function () {
                        var e, t = $(this).parent("tr")[0], r = t.nextSibling, i = t.id, a = d.id + "_" + i,
                            o = function (e) {
                        ...
                        if ($.each(d.colModel, function () {
                            ...
                            if (!0 === d.subGridOptions.reloadOnExpand || !1 === d.subGridOptions.reloadOnExpand && !$(r).hasClass("ui-subgrid")) {
                                if (e = 1 <= y ? "<td colspan='" + y + "'>&#160;</td>" : "", !subGridFeedback.call(s, "beforeExpand", a, i)) return;
                                $(t).after("<tr role='row' class='" + n + "'>" + e + "<td class='" + h + "'><span class='" + o("openicon") + "'></span></td><td colspan='" + parseInt(d.colNames.length - l, 10) + "' class='" + g + "'><div id='" + a + "' class='tablediv'></div></td></tr>"), $(s).triggerHandler("jqGridSubGridRowExpanded", [a, i]), $.isFunction(d.subGridRowExpanded) ? d.subGridRowExpanded.call(s, a, i) : function (e) {
                                    var t, r, i = $(e).attr("id"), a = {nd_: (new Date).getTime()};
                                    if (a[d.prmNames.subgridid] = i, !c) return;
                                    if (c.params) for (r = 0; r < c.params.length; r++) void 0 !== (t = d.iColByName[c.params[r]]) && (a[d.colModel[t].name] = $(e.cells[t]).text().replace(/\&#160\;/gi, ""));
                            ...
                            $(this).html("<div class='" + base.getGuiStyles.call(s, "subgrid.buttonDiv", "sgbutton-div") + "'><a role='button' class='" + base.getGuiStyles.call(s, "subgrid.button", "sgbutton") + "'><span class='" + o("minusicon") + "'></span></a></div>").removeClass("sgcollapsed").addClass("sgexpanded"), d.subGridOptions.selectOnExpand && $(s).jqGrid("setSelection", i)
                        } else if ($(this).hasClass("sgexpanded")) {
                            if (!subGridFeedback.call(s, "beforeCollapse", a, i)) return;
                            !0 === d.subGridOptions.reloadOnExpand ? $(r).remove(".ui-subgrid") : $(r).hasClass("ui-subgrid") && $(r).hide(), $(this).html("<div class='" + base.getGuiStyles.call(s, "subgrid.buttonDiv", "sgbutton-div") + "'><a role='button' class='" + base.getGuiStyles.call(s, "subgrid.button", "sgbutton") + "'><span class='" + o("plusicon") + "'></span></a></div>").removeClass("sgexpanded").addClass("sgcollapsed"), d.subGridOptions.selectOnCollapse && $(s).jqGrid("setSelection", i)
                        }
                        return !1
                    }, a = 1;
                if (s.grid) {
        ...
        $(e).each(function () {
            var e, t, r, i, a, o, l, n, s = $(this), d = [], c = [], u = [], p = [], f = [];
            if (!this.grid) {
                for (s.width("99%"), e = s.width(), t = $("tr td:first-child input[type=checkbox]:first", s), r = $("tr td:first-child input[type=radio]:first", s), a = !(i = 0 < t.length) && 0 < r.length, o = i || a, $("th", s).each(function () {
                    ...
                    $("td", $(this)).each(function () {
                        if (0 === i && o) {
                            var e = $("input", $(this)), t = e.attr("value");
        ...
        setTreeNode: function () {
            return this.each(function () {
                ...
                if (this.grid && s.treeGrid) {
                    var d = s.treeReader.expanded_field, c = s.treeReader.leaf_field;
                    n.off("jqGridBeforeSelectRow.setTreeNode"), n.on("jqGridBeforeSelectRow.setTreeNode", function (e, r, t) {
                        if (null != t) {
                            var i = $(t.target), a = i.closest("tr.jqgrow>td"), o = a.parent(), l = function () {
                                var e = s.data[s._index[stripPref(s.idPrefix, r)]], t = e[d] ? "collapse" : "expand";
            ...
            return this.each(function () {
                var e, t, r, i = this.p, a = [], o = ["leaf_field", "expanded_field", "loaded"];
                if (i.treeGrid) {
                    for (t in i.treedatatype || $.extend(this.p, {treedatatype: i.datatype}), i.subGrid = !1, i.altRows = !1, i.pgbuttons = !1, i.pginput = !1, i.gridview = !0, null === i.rowTotal && (i.rowNum = i.maxRowNum), i.rowList = [], i.treeIcons.plus = "rtl" === i.direction ? i.treeIcons.plusRtl : i.treeIcons.plusLtr, "nested" === i.treeGridModel ? i.treeReader = $.extend({
                        level_field: "level",
                        left_field: "lft",
                        right_field: "rgt",
                        leaf_field: "isLeaf",
                        ...
                        loaded: "loaded",
                        icon_field: "icon"
                    }, i.treeReader)), i.colModel) if (i.colModel.hasOwnProperty(t)) for (r in e = i.colModel[t].name, i.treeReader) i.treeReader.hasOwnProperty(r) && i.treeReader[r] === e && a.push(e);
            ...
            this.each(function () {
                ...
                if (this.grid && r.treeGrid) {
                    var i = r.treeReader.expanded_field, e = o[r.localReader.id];
                    if (treeGridFeedback.call(this, "beforeExpandRow", {rowid: e, item: o})) {
                        ...
                        }), treeGridFeedback.call(this, "afterExpandRow", {rowid: e, item: o})
                    }
                }
            })
            ...
            this.each(function () {
                ...
                if (this.grid && r.treeGrid) {
                    var i = r.treeReader.expanded_field, e = o[r.localReader.id];
                    if (treeGridFeedback.call(this, "beforeCollapseRow", {rowid: e, item: o})) {
                        var a = base.getNodeChildren.call(t, o);
                        $(a).each(function () {
                            var e = r.idPrefix + getAccessor(this, r.localReader.id);
                            $(base.getGridRowById.call(t, e)).css("display", "none"), this[i] && base.collapseRow.call(t, this)
                        }), treeGridFeedback.call(this, "afterCollapseRow", {rowid: e, item: o})
                    }
                }
            })
            ...
            return this.each(function () {
                ...
                if (this.grid && e.treeGrid) switch (e.treeGridModel) {
                    case"nested":
                        var t = e.treeReader.left_field, r = e.treeReader.right_field, i = e.treeReader.level_field,
                            a = parseInt(d[t], 10), o = parseInt(d[r], 10), l = parseInt(d[i], 10);
                        $(e.data).each(function () {
                            parseInt(this[i], 10) === l + 1 && parseInt(this[t], 10) > a && parseInt(this[r], 10) < o && c.push(this)
                        });
                        break;
                    case"adjacency":
                        var n = e.treeReader.parent_id_field, s = e.localReader.id;
                        $(e.data).each(function () {
            ...
            return this.each(function () {
                ...
                if (this.grid && e.treeGrid) switch (e.treeGridModel) {
                    case"nested":
                        var r = e.treeReader.left_field, i = e.treeReader.right_field, a = e.treeReader.level_field,
                            o = parseInt(c[r], 10), l = parseInt(c[i], 10), n = parseInt(c[a], 10);
                        $(e.data).each(function () {
                    ...
                    case"adjacency":
                        if (c) {
                            u.push(c);
                            var s = e.treeReader.parent_id_field, d = e.localReader.id;
                            $(e.data).each(function () {
                                var e;
                                for (t = u.length, e = 0; e < t; e++) if (String(u[e][d]) === String(this[s])) {
                                    u.push(this);
                                    break
                                }
                            })
            ...
            var a = [];
            return this.each(function () {
                var e = $(this), t = base.getNodeParent;
                if (this.grid && this.p.treeGrid) for (var r = t.call(e, i); r;) a.push(r), r = t.call(e, r)
            }), a
            ...
            return this.each(function () {
                ...
                if (this.grid && e.treeGrid) {
                    var t = base.getNodeAncestors.call($(this), i), r = e.treeReader.expanded_field;
                    $(t).each(function () {
                ...
                if (i.grid && a.treeGrid) {
                    ...
                    if (!l[o.expanded_field]) {
                        ...
                        t = $("#" + a.idPrefix + jqID(e), i.grid.bDiv)[0], l[o.expanded_field] = !0, r = getNodeIcons(a, l), $("div.treeclick", t).removeClass(r.collapsed).addClass(r.common).addClass(r.expanded), "local" === a.treedatatype || base.isNodeLoaded.call($(i), a.data[a._index[e]]) || i.grid.hDiv.loading || (a.treeANode = t.rowIndex, a.datatype = a.treedatatype, base.setGridParam.call($(i), {
                            ...
                            } : {nodeid: e, n_level: l[o.level_field], parentid: l[o.parent_id_field]}
                        ...
                        })), treeGridFeedback.call(i, "afterExpandNode", {rowid: e, item: l})
                    }
                }
            })
            ...
            return this.each(function () {
                ...
                if (this.grid && t.treeGrid) {
                    ...
                    if (a[r]) {
                        ...
                        if (!treeGridFeedback.call(this, "beforeCollapseNode", {rowid: i, item: a})) return;
            ...
            return this.each(function () {
                ...
                if (r.grid && i.treeGrid) {
                    var e, t, o, l = [], n = base.getRootNodes.call(a), s = jgrid.from.call(r, n);
                    s.orderBy(c, u, p, f);
                    var d = s.select();
            ...
            return this.each(function () {
                ...
                if (this.grid && this.p.treeGrid) {
                    var t, r, i, a = base.getNodeChildren.call(e, s), o = jgrid.from.call(this, a);
                    o.orderBy(d, c, u, p);
                    var l = o.select();
            ...
            return this.each(function () {
                var e, t, r, i, a, o = this.p, l = o.localReader.id, n = $(this), s = o.treeReader.left_field,
                ...
                if (this.grid && o.treeGrid) {
                    ...
                    if (void 0 !== c) {
                        ...
                        if (0 < u.length) for (a = 0; a < u.length; a++) f && p === u[a][l] || base.delRowData.call(n, u[a][l]);
                        if ("nested" === o.treeGridModel) {
                            if ((r = jgrid.from.call(this, o.data).greater(s, e, {stype: "integer"}).select()).length) for (i in r) r.hasOwnProperty(i) && (r[i][s] = parseInt(r[i][s], 10) - t);
                            if ((r = jgrid.from.call(this, o.data).greater(d, e, {stype: "integer"}).select()).length) for (i in r) r.hasOwnProperty(i) && (r[i][d] = parseInt(r[i][d], 10) - t)
                        }
                    }
                }
            })
            ...
            return this.each(function () {
                if (R) {
                    var e, t, r, i, a, o, l, n = this.p, s = $(this), d = base.getInd,
                        c = n.treeIcons.minus + " tree-minus", u = F, p = n.treeReader.expanded_field,
                        f = n.treeReader.leaf_field, h = n.treeReader.level_field, g = n.treeReader.parent_id_field,
                        m = n.treeReader.left_field, v = n.treeReader.right_field, b = n.treeReader.loaded;
                    void 0 === _ && (_ = !1), null == q && (q = jgrid.randId());
                    var w, y, x = d.call(s, F);
                    if (o = !1, null == F || "" === F) u = F = null, e = "last", i = n.tree_root_level; else {
                        ...
                        if (S.length) for (j = 0; j < S.length; j++) D = S[j][n.localReader.id], a < (C = d.call(s, D)) && (a = C, u = D);
                    ...
                    if (void 0 === R[p] && (R[p] = !1), void 0 === R[b] && (R[b] = !1), R[h] = i, void 0 === R[f] && (R[f] = !0), "adjacency" === n.treeGridModel && (R[g] = F), "nested" === n.treeGridModel) if (null !== F) {
                        if (l = parseInt(r[v], 10), (w = jgrid.from.call(this, n.data).greaterOrEquals(v, l, {stype: "integer"}).select()).length) for (y in w) w.hasOwnProperty(y) && (w[y][m] = w[y][m] > l ? parseInt(w[y][m], 10) + 2 : w[y][m], w[y][v] = w[y][v] >= l ? parseInt(w[y][v], 10) + 2 : w[y][v]);
                        R[m] = l, R[v] = l + 1
                    } else {
                        if (l = parseInt(base.getCol.call(s, v, !1, "max"), 10), (w = jgrid.from.call(this, n.data).greater(m, l, {stype: "integer"}).select()).length) for (y in w) w.hasOwnProperty(y) && (w[y][m] = parseInt(w[y][m], 10) + 2);
                        if ((w = jgrid.from.call(this, n.data).greater(v, l, {stype: "integer"}).select()).length) for (y in w) w.hasOwnProperty(y) && (w[y][v] = parseInt(w[y][v], 10) + 2);
                        R[m] = l + 1, R[v] = l + 2
                    }
    ...
    var namespace = ".jqGrid", mouseDown = "mousedown", mouseMove = "mousemove", mouseUp = "mouseup",
        getMouseCoordinates = function (e) {
            ...
            return t ? {x: (t = t[0]).pageX, y: t.pageY} : {x: e.pageX, y: e.pageY}
        }, jqDnR = {
            drag: function (e) {
            ...
            return e.each(function () {
                (t = t ? $(t, e) : e).on(mouseDown, {e: e, k: r}, function (e) {
                    var t, r, i, a, o, l, n = e.data, s = {}, d = function (e, t) {
        ...
        return e.each(function () {
            ...
            $(t).each(function () {
                this[r] || (this[r] = [], $(this).click(function () {
                    ...
                    for (e = 0; e < i.length; e++) for (r in this[t = i[e]]) this[t].hasOwnProperty(r) && jqmHash[this[t][r]] && jqmHash[this[t][r]].w[t](this);
                    return !1
                })), this[r].push(e)
            })
        })
    ...
    $.fn.jqm = function (e) {
        ...
        hash: {}, open: function (e, t) {
            ...
            return u = 0 < u ? u : 3e3, r = $("<div></div>").css({
                height: "100%",
                width: "100%",
                position: "fixed",
                left: 0,
    ...
    var fmatter = $.fmatter, getOptionByName = function (e, t) {
        ...
        var t, r, i = e.colModel || e.cm, a = !1 !== i.title ? " title='" + encodeAttr(e.colName || i.name) + "'" : "",
            ...
            d = "string" == typeof s && s.split(":")[0] || "Yes", c = "string" == typeof s && s.split(":")[1] || "No",
            u = function (e) {
        ...
        return !0 === p && (l || n || f || g) ? (t = u(l || f), r = u(n || g), l = h || (l || f)) : (t = "<input type='checkbox' checked='checked'" + (a += !(l = "") === p ? " disabled='disabled'" : "") + " />", r = "<input type='checkbox'" + a + " />"), {
            checkedClasses: l,
            checked: t,
            unchecked: r,
            yes: d,
        ...
        isObject: function (e) {
            ...
            if (r(e) || (e *= 1), r(e)) {
                ...
                if (r(t.decimalPlaces)) {
                    ...
                    if (i = (o = String(Number(Math.round(e + "e" + n) + "e-" + n))).lastIndexOf("."), 0 < n) for (i < 0 ? i = (o += l).length - 1 : "." !== l && (o = o.replace(".", l)); o.length - 1 - i < n;) o += "0"
                }
                if (t.thousandsSeparator) {
                    var s = t.thousandsSeparator;
                    i = -1 < (i = o.lastIndexOf(l)) ? i : o.length;
                    var d, c = void 0 === t.decimalSeparator ? "" : o.substring(i), u = -1;
    ...
    $FnFmatter.email = function (e, t) {
        ...
        var e, a, o, l = this, n = r.colModel, s = {
            ...
            return $.isFunction(e) ? e.call(l, {cellValue: t, rowid: r.rowId, rowData: i, options: s}) : e || ""
        };
        return null != n && (s = $.extend({}, s, n.formatoptions || {})), s.target && (d = "target=" + c(s.target)), e = c(s.baseLinkUrl) + c(s.showAction), a = s.idName ? encodeURIComponent(c(s.idName)) + "=" + encodeURIComponent(c(s.rowId) || r.rowId) : "", "object" == typeof (o = c(s.addParam)) && null !== o && (o = ("" !== a ? "&" : "") + $.param(o)), "" === (e += a || o ? "?" + a + o : "") && (e = c(s.hrefDefaultValue)), "string" == typeof t || fmatter.isNumber(t) || $.isFunction(s.cellValue) ? "<a " + d + " href='" + encodeAttr(e) + "'>" + ($.isFunction(s.cellValue) ? c(s.cellValue) : t) + "</a>" : defaultFormat(t, s)
        ...
        return null != t && (c = $.extend({}, c, t.formatoptions || {})), function (t, e, r) {
            var i, a, o, l = this, n = e.rowId, s = "", d = function (e) {
                return $.isFunction(e) ? e.call(l, {cellValue: t, rowid: n, rowData: r, options: c}) : e || ""
            };
            return c.target && (s = "target=" + d(c.target)), i = d(c.baseLinkUrl) + d(c.showAction), a = c.idName ? encodeURIComponent(d(c.idName)) + "=" + encodeURIComponent(d(n) || e.rowId) : "", "object" == typeof (o = d(c.addParam)) && null !== o && (o = ("" !== a ? "&" : "") + $.param(o)), "" === (i += a || o ? "?" + a + o : "") && (i = d(c.hrefDefaultValue)), "string" == typeof t || fmatter.isNumber(t) || $.isFunction(c.cellValue) ? "<a " + s + " href='" + encodeAttr(i) + "'>" + ($.isFunction(c.cellValue) ? d(c.cellValue) : t) + "</a>" : defaultFormat(t, c)
        }
    }, $FnFmatter.showlink.pageFinalization = function (e) {
        var t, r, i, o = $(this), l = this.p, a = l.colModel[e], n = l.autoResizing.wrapperClassName, s = this.rows,
            d = s.length, c = function (e) {
                var t = $(this).closest("tr.jqgrow>td"), r = t.parent(), i = t[0].cellIndex, a = l.colModel[i];
        ...
        if (null != a.formatoptions && $.isFunction(a.formatoptions.onClick)) for (t = 0; t < d; t++) r = s[t], $(r).hasClass("jqgrow") && (i = r.cells[e], a.autoResizable && null != i && $(i.firstChild).hasClass(n) && (i = i.firstChild), null != i && $(i.firstChild).on("click", c))
    };
    ...
    $FnFmatter.integer.getCellBuilder = function (e) {
        ...
        var r, i = [], a = t.colModel, o = $.extend({}, a.editoptions || {}, a.formatoptions || {}),
            l = "function" == typeof o.value ? o.value() : o.value, n = o.separator || ":", s = o.delimiter || ";";
        if (l) {
            ...
            if (c && (u = $.map(String(e).split(","), function (e) {
                ...
                var f, h, g = l.split(s);
                for (f = 0; f < g.length; f++) if (2 < (d = g[f].split(n)).length && (d[1] = $.map(d, p).join(n)), h = $.trim(d[0]), o.defaultValue === h && (r = d[1]), c) -1 < $.inArray(h, u) && i.push(d[1]); else if (h === $.trim(e)) {
                    i = [d[1]];
                    break
                }
        ...
        var a, t, r, i, o = e.colModel, l = $FnFmatter.defaultFormat,
            n = $.extend({}, o.editoptions || {}, o.formatoptions || {}),
            s = "function" == typeof n.value ? n.value() : n.value, d = n.separator || ":", c = n.delimiter || ";",
            u = void 0 !== n.defaultValue, p = !0 === n.multiple, f = {}, h = function (e, t) {
                if (0 < t) return e
            };
        if ("string" == typeof s) for (i = (r = s.split(c)).length - 1; 0 <= i; i--) 2 < (t = r[i].split(d)).length && (t[1] = $.map(t, h).join(d)), f[$.trim(t[0])] = t[1]; else {
        ...
        return u && (a = f[n.defaultValue]), p ? function (e) {
            var t, r = [], i = $.map(String(e).split(","), function (e) {
                return $.trim(e)
            });
        ...
        var r, i, a, o, l = $(this).closest("tr.jqgrow>td"), n = l.parent(), s = n.attr("id"),
            d = $(this).closest("table.ui-jqgrid-btable").attr("id").replace(/_frozen([^_]*)$/, "$1"),
            c = $("#" + jgrid.jqID(d)), u = c[0], p = u.p, f = jgrid.getRelativeRect.call(u, n).top,
            h = p.colModel[l[0].cellIndex],
            g = $.extend(!0, {extraparam: {}}, jgrid.actionsNav || {}, p.actionsNavOptions || {}, h.formatoptions || {});
        switch (void 0 !== p.editOptions && (g.editOptions = $.extend(!0, g.editOptions || {}, p.editOptions)), void 0 !== p.delOptions && (g.delOptions = p.delOptions), n.hasClass("jqgrid-new-row") && (g.extraparam[p.prmNames.oper] = p.prmNames.addoper), o = {
            ...
            case"formedit":
                ...
                break;
            default:
                if (null != g.custom && 0 < g.custom.length) for (i = g.custom.length, r = 0; r < i; r++) (a = g.custom[r]).action === t && $.isFunction(a.onClick) && a.onClick.call(u, {
                    rowid: s,
                    event: e,
                    action: t,
                    options: a
        ...
        var a, o, l, n = t.rowId, s = "", d = $(this), c = {}, u = getGridRes.call(d, "edit") || {}, p = $.extend({
                editbutton: !0,
                delbutton: !0,
                editformbutton: !1,
                commonIconClass: "ui-icon",
            ...
            f = [{action: "edit", actionName: "formedit", display: p.editformbutton}, {
                action: "edit",
                display: !p.editformbutton && p.editbutton
            }, {action: "del", idPrefix: "Delete", display: p.delbutton}, {
                action: "save",
                display: p.editformbutton || p.editbutton,
                hidden: !0
            }, {action: "cancel", display: p.editformbutton || p.editbutton, hidden: !0}], h = function (e) {
                var t, r = e.action, i = e.actionName || r,
        ...
        return "<div class='" + encodeAttr(d.jqGrid("getGuiStyles", "actionsDiv", "ui-jqgrid-actions")) + "'>" + s + "</div>"
    }, $FnFmatter.actions.pageFinalization = function (e) {
        var t, r, i, s, d = $(this), c = this.p, a = c.colModel[e], o = c.autoResizing.wrapperClassName,
            l = d.jqGrid("getGuiStyles", "states.hover"), n = this.rows, u = this.grid.fbRows, p = n.length,
            f = (s = a.name, function (e, t) {
                var r, i, a = 0, o = c.colModel, l = o.length, n = c.iColByName[s];
                for (i = 0; i < l && !0 === o[i].frozen; i++) a = i;
                null != t && null != t.cells && (r = $(t.cells[n]).children(".ui-jqgrid-actions"), o[n].frozen && c.frozenColumns && n <= a && (r = r.add($(d[0].grid.fbRows[t.rowIndex].cells[n]).children(".ui-jqgrid-actions"))), e ? (r.find(">.ui-inline-edit,>.ui-inline-del").show(), r.find(">.ui-inline-save,>.ui-inline-cancel").hide()) : (r.find(">.ui-inline-edit,>.ui-inline-del").hide(), r.find(">.ui-inline-save,>.ui-inline-cancel").show()))
            }), h = function (e, t) {
        ...
        if (n.value) {
            var c, u = "function" == typeof n.value ? n.value() : n.value, p = !0 === n.multiple, f = [],
                h = function (e, t) {
                    if (0 < t) return e
                };
            if (p && (f = o.split(","), f = $.map(f, function (e) {
                ...
                for (g = 0; g < m.length; g++) if (2 < (c = m[g].split(s)).length && (c[1] = $.map(c, h).join(s)), p) -1 < $.inArray($.trim(c[1]), f) && (a[v] = c[0], v++); else if ($.trim(c[1]) === $.trim(o)) {
                    a[0] = c[0];
                    break
                }
